 ...
 */
@Service
public class SysQueryFieldServiceImpl extends ServiceImpl<SysQueryFieldMapper, SysQueryField> implements
        ISysQueryFieldService {
    ...
    @CacheEvict(value = {"VersionField"}, allEntries = true)
    public SysQueryUserVersion updateUserVersion(UserInfo user, SysQueryUserVersion version,
