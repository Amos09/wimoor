...
public interface VueAddUpdTemplate {
    ...
    /**
     * 时间-小时选择器 {label}  {prop} {required} 09:00 | 09:30 | 10:00
     */
    String TIME = "                        {\n" +
            "                            label: \"{label}\",\n" +
            "                            prop: \"{prop}\",\n" +
            ...
            "                        },\n";
    /**
     * 数组框 ， 多内容添加，如标签 {label}  {prop} {required}
     */
    String ARRAY = "                        {\n" +
            "                            label: '{label}',\n" +
            "                            prop: '{prop}',\n" +
    ...
    /**
     * 文件上传 {label} {prop} {listType} ==> 单图/视频-[picture-img] |  多图/视频-[picture-card] |  缩略图-[picture] | 任意文件空 {limit}
     * ==> 上传数量 {accept} ==> 文件上传格式 -> 图片默认: image/png, image/jpeg, image/jpg, image/gif  | 视频默认: video/mp4 | 任意文件不限制
     * {tip} ==> 文件上传提示  -> 【图片: 只能上传 jpg/png/gif 格式的图片】 【视频：只能上传mp4格式的视频】【任意文件：无】 {fileType} ==> 文件类型,
     * 分类图片/视频/任意文件的存储路径 {required}
     */
    String UPLOAD = "                        {\n" +
            "                            label: '{label}',\n" +
            "                            prop: '{prop}',\n" +
