...
public class SysTagsGroupsController {
    ...
    public Result<List<SysTagsGroups>> list(Integer page, Integer limit, String name) {
        ...
        Page<SysTagsGroups> result = iSysTagsGroupsService.page(new Page<>(page, limit),
                new LambdaQueryWrapper<SysTagsGroups>()
    ...
    public Result<Boolean> patch(@PathVariable String id, @RequestBody SysTagsGroups dict) {
        LambdaUpdateWrapper<SysTagsGroups> updateWrapper = new LambdaUpdateWrapper<SysTagsGroups>().eq(
                SysTagsGroups::getId, id);
