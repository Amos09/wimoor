...
public interface AdminClientOneFeign {
    ...
    public Result<UserInfo> bindUserByOpenid(@RequestParam("openid") String openid,
            @RequestParam("appType") String appType, @RequestParam("account") String account,
    ...
    public Result<UserInfo> verifyAccountAction(@RequestParam("account") String account,
            @RequestParam("password") String password);
