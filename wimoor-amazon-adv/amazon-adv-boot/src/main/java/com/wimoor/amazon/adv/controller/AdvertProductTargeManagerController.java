...
public class AdvertProductTargeManagerController {
    ...
    public Result<List<Map<String, Object>>> getBrandRecommendations(String profileid, String categoryId,
            String keyword, String adtype) {
        UserInfo user = UserInfoContext.get();
        List<Map<String, Object>> list = null;
        if (profileid != null) {
            if ("sb".equals(adtype) || "hsa".equals(adtype)) {
                list = amzAdvRecommendationsTargetService.amzRecommendationsBrand_HSA(user, new BigInteger(profileid),
                        categoryId, keyword);
            } else if ("sp".equals(adtype)) {
                list = amzAdvRecommendationsTargetService.amzGetBrandRecommendations(user, new BigInteger(profileid),
                        categoryId, keyword);
            }
        }
    ...
    public Result<?> getRecommendationsProductCount(@RequestBody JSONObject param) {
        ...
        if (campaignType != null && campaignType.toLowerCase().equals("sp")) {
            ...
            return Result.success(
                    this.amzAdvRecommendationsService.amzAdvRecommendationsProductCount(user, new BigInteger(profileid),
                            param));
        } else {
            return Result.success(this.amzAdvRecommendationsHsaService.amzAdvRecommendationsProductCount(user,
                    new BigInteger(profileid), param));
        }
    }


    @PostMapping("/getTargetsCategoriesRecommendations/{profileid}/{campaignType}")
    public Result<?> getSuggestedTargets(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (campaignType != null && campaignType.toLowerCase().equals("sp")) {
            return Result.success(this.amzAdvRecommendationsService.amzAdvRecommendationsTargetsCategories(user,
                    new BigInteger(profileid), param));
        } else {
            return Result.success(this.amzAdvRecommendationsHsaService.amzAdvRecommendationsTargetsCategories(user,
                    new BigInteger(profileid), param));
        }
    }

    @PostMapping("/getTargetsCategoriesAllRecommendations/{profileid}/{campaignType}")
    public Result<?> getRecommendationsTargetsCategoriesAll(@PathVariable String profileid,
            @PathVariable String campaignType, @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (campaignType != null && campaignType.toLowerCase().equals("sp")) {
            return Result.success(this.amzAdvRecommendationsService.amzAdvRecommendationsTargetsCategoriesAll(user,
                    new BigInteger(profileid), param));
        } else {
            return Result.success(this.amzAdvRecommendationsHsaService.amzAdvRecommendationsTargetsCategoriesAll(user,
                    new BigInteger(profileid), param));
        }
    ...
    public Result<?> getRecommendationsTargetsRefine(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (campaignType != null && campaignType.toLowerCase().equals("sp")) {
            return Result.success(this.amzAdvRecommendationsService.amzAdvRecommendationsTargetsRefine(user,
                    new BigInteger(profileid), param));
        } else {
            return Result.success(this.amzAdvRecommendationsHsaService.amzAdvRecommendationsTargetsRefine(user,
                    new BigInteger(profileid), param));
        }
    }
    ...
    public Result<?> getTargetsProducts(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            return Result.success(this.amzAdvRecommendationsService.amzAdvRecommendationsTargetsProducts(user,
                    new BigInteger(profileid), param));
        } else if (campaignType.toLowerCase().equals("sd")) {
            return Result.success(this.amzAdvRecommendationsSDService.amzTargetRecommendationsProductList(user,
                    new BigInteger(profileid), param));
        } else {
            return Result.success(this.amzAdvRecommendationsHsaService.amzTargetRecommendationsProductList(user,
                    new BigInteger(profileid), param));
        }
    ...
    public Result<?> getTargetsBidRecommendations(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            return Result.success(
                    this.amzAdvRecommendationsService.amzAdvRecommendationsTargetsBid(user, new BigInteger(profileid),
                            param));
        } else if (campaignType.toLowerCase().equals("sd")) {
            return Result.success(
                    this.amzAdvRecommendationsSDService.amzAdvRecommendationsTargetsBid(user, new BigInteger(profileid),
                            param));
        } else {
            return Result.success(
                    this.amzAdvRecommendationsHsaService.amzAdvRecommendationsBid(user, new BigInteger(profileid),
                            param));
        }
    }

    @PostMapping("/getHeadlineRecommendations/{profileid}/{campaignType}")
    public Result<?> getHeadlineRecommendations(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        return Result.success(
                this.amzAdvRecommendationsSDService.amzTargetRecommendationsHeadline(user, new BigInteger(profileid),
                        param));
    }

    @GetMapping("/getNegativeTargetsBrandsRecommendations/{profileid}/{campaignType}")
    public Result<?> getNegativaTargetBrandRecommendations(@PathVariable String profileid,
            @PathVariable String campaignType, String keyword) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            if (StrUtil.isBlank(keyword)) {
                return Result.success(this.amzAdvRecommendationsService.amzAdvRecommendationsNegativeTargetsBrands(user,
                        new BigInteger(profileid), null));
            } else {
                JSONObject param = new JSONObject();
                param.put("keyword", keyword);
                return Result.success(
                        this.amzAdvRecommendationsService.amzAdvRecommendationsNegativeTargetsBrandsSearch(user,
                                new BigInteger(profileid), param));
            }
        } else {
            JSONObject param = new JSONObject();
            param.put("nextToken", keyword);
            return Result.success(this.amzAdvRecommendationsHsaService.amzAdvRecommendationsNegativeTargetsBrands(user,
                    new BigInteger(profileid), param));
        }
    ...
    public Result<?> getAdGroupBidRecommendations(@RequestBody JSONObject params) {
        ...
        if ("sb".equals(adtype.toLowerCase()) || "hsa".equals(adtype.toLowerCase())) {
            ...
            return Result.success(
                    amzAdvBidReCommendService.amzRecommendationsBidsForTarget_HSA(user, new BigInteger(profileid),
                            campaignIdInt, expressionArray));
        } else {
            return Result.success(
                    amzAdvBidReCommendService.amzGetTargetBidRecommendations(user, new BigInteger(profileid), adGroupid,
                            expressionArray));
        }
    }
    ...
    public Result<PageList<Map<String, Object>>> getProductTargeListAction(
            @ApiParam("查询广告") @RequestBody QueryForList query) {
        UserInfo user = UserInfoContext.get();
        ...
        if (list != null && list.size() > 0) {
            for (Map<String, Object> item : list) {
                ...
                if (expression != null && (expression.toString().contains("asinCategorySameAs") || expression.toString()
                        .contains("ASIN_CATEGORY_SAME_AS"))) {
                    ...
                    if (campaignType != null && "sd".equals(campaignType.toString().toLowerCase())) {
                        ...
                        if (jsonarr.size() > 0) {
                            AmzAdvBrowseNode category = amzAdvBrowseNodeService.selectByKey(
                                    jsonarr.getJSONObject(0).get("value"));
                            if (category != null) {
                                item.put("expressionname", "ASIN_CATEGORY_SAME_AS=" + category.getName());
                            }
                        }
    ...
    public Result<?> archiveCampNegativaTargetsAction(@PathVariable String profileid, @PathVariable String campaignType,
        ...
        if (campaignType != null && "sp".equals(campaignType.toLowerCase())) {
            ...
            for (String id : ids) {
                AmzAdvCampProductTargeNegativa sd = amzAdvCampProductTargeNegativaService.amzArchiveNegativeTargetingClause(
                        user, new BigInteger(profileid), id);
                if (sd != null) {
                    result.add(sd);
                }
            }
    ...
    public Result<?> archiveNegativaTargetsAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> ids) {
        UserInfo user = UserInfoContext.get();
        if (campaignType != null && "sd".equals(campaignType.toLowerCase())) {
            ...
            for (String id : ids) {
                AmzAdvProductTargeNegativaSD sd = amzAdvProductTargeNegativaSDService.amzArchiveNegativeTargetingClause(
                        user, new BigInteger(profileid), id);
                if (sd != null) {
                    result.add(sd);
                }
            ...
            for (String id : ids) {
                AmzAdvProductTargeNegativaHsa sb = amzAdvProductTargeNegativaHsaService.amzArchiveNegativeTargetingClause(
                        user, new BigInteger(profileid), id);
                if (sb != null) {
                    result.add(sb);
                }
        ...
        if (campaignType != null && "sp".equals(campaignType.toLowerCase())) {
            ...
            List<AmzAdvProductTargeNegativa> result = amzAdvProductTargeNegativaService.amzArchiveNegativeTargetingClause(
                    user, new BigInteger(profileid), param);
            return Result.success(result);
        }
        return Result.success();
    }
    ...
    public Result<Map<String, Object>> getProductTargeChartAction(
            @ApiParam("查询广告") @RequestBody QueryForList query) {
        UserInfo user = UserInfoContext.get();
        String state = query.getState();
    ...
    public Result<PageList<Map<String, Object>>> getNegativaTargeListAction(
            @ApiParam("查询广告") @RequestBody QueryForList query) {
        UserInfo user = UserInfoContext.get();
        String state = query.getState();
        String search = query.getSearch();
        ...
        if (campaignType != null && "sd".equals(campaignType.toLowerCase())) {
            ...
            if (query.getAdGroupid() != null) {
                ...
                pageList = amzAdvCampProductTargeNegativaService.getProductNegativaTargeList(map,
                        query.getPageBounds());
            }
        } else {
    ...
    public Result<String> createNegativaTargeListAction(@PathVariable String profileid,
            @PathVariable String campaignType, @RequestBody Map<String, Object> params) {
        UserInfo user = UserInfoContext.get();
        ...
        if (campaignType != null && "sd".equals(campaignType.toLowerCase())) {
            if (amzAdvProductTargeNegativaSDService.amzCreateNegativeTargetingClauses(user, profileid, keywords)
                    == null) {
                throw new BaseException("亚马逊连接异常，修改失败！");
            }
        } else if (campaignType != null && ("sb".equals(campaignType.toLowerCase()) || "hsa".equals(
                campaignType.toLowerCase()))) {
            if (amzAdvProductTargeNegativaHsaService.amzCreateNegativeTargetingClauses(user, profileid, keywords)
                    == null) {
                throw new BaseException("亚马逊连接异常，修改失败！");
            }
        } else {
            if (amzAdvProductTargeNegativaService.amzCreateNegativeTargetingClauses(user, profileid, keywords)
                    == null) {
                throw new BaseException("亚马逊连接异常，修改失败！");
            }
        }
    ...
    public Result<String> updateNegativaTargeListAction(@PathVariable String profileid,
            @PathVariable String campaignType, @RequestBody Map<String, Object> param) {
        UserInfo user = UserInfoContext.get();
        String json = param.get("jsonstr").toString();
        JSONObject jsonobject = GeneralUtil.getJsonObject(json);
        JSONArray keywords = jsonobject.getJSONArray("ntargets");
        if (campaignType != null && "sd".equals(campaignType.toLowerCase())) {
            if (amzAdvProductTargeNegativaSDService.amzUpdateNegativeTargetingClauses(user, profileid, keywords)
                    == null) {
                throw new BaseException("亚马逊连接异常，修改失败！");
            }
                ...
                campaignType.toLowerCase()))) {
            if (amzAdvProductTargeNegativaHsaService.amzUpdateNegativeTargetingClauses(user, profileid, keywords)
                    == null) {
                throw new BaseException("亚马逊连接异常，修改失败！");
            }
        } else {
            if (amzAdvProductTargeNegativaService.amzUpdateNegativeTargetingClauses(user, profileid, keywords)
                    == null) {
                throw new BaseException("亚马逊连接异常，修改失败！");
            }
    ...
    public Result<?> negativaTargetsAction(@PathVariable String profileid, @PathVariable String campaignType,
        ...
        if (campaignType.toLowerCase().equals("sp")) {
            ...
            return Result.success(
                    amzAdvProductTargeNegativaService.amzListNegativeTargetingClauses(user, new BigInteger(profileid),
                            param));
        } else if (campaignType.toLowerCase().equals("sd")) {
            List<AmzAdvProductTargeNegativaSD> list = new LinkedList<AmzAdvProductTargeNegativaSD>();
            for (String item : idlist) {
                AmzAdvProductTargeNegativaSD sd = amzAdvProductTargeNegativaSDService.amzNegativeTargetingClauses(user,
                        new BigInteger(profileid), item);
                list.add(sd);
            }
            return Result.success(list);
        } else {
            ...
            for (String item : idlist) {
                AmzAdvProductTargeNegativaHsa sd = amzAdvProductTargeNegativaHsaService.amzNegativeTargetingClauses(
                        user, new BigInteger(profileid), item);
                list.add(sd);
            }
            return Result.success(list);
        }
    ...
    public Result<?> getNegativaTargetsListAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            JSONObject param = new JSONObject();
    ...
    public Result<?> getCampNegativaTargetsAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        JSONObject param = new JSONObject();
        JSONObject keywordIdFilter = new JSONObject();
        ...
        param.put("includeExtendedDataFields", false);
        return Result.success(
                amzAdvCampProductTargeNegativaService.amzListNegativeTargetingClauses(user, new BigInteger(profileid),
                        param));
    }

    @PostMapping("/campNegativaTargetsExt/{profileid}/{campaignType}")
    public Result<?> getCampNegativaTargetsExtAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        JSONObject param = new JSONObject();
        JSONObject adGroupIdFilter = new JSONObject();
    ...
    public Result<List<AmzAdvCampProductTargeNegativa>> amzCreateCampNegativaTargetsAction(
            @PathVariable String profileid, @PathVariable String campaignType,
        ...
        return Result.success(
                amzAdvCampProductTargeNegativaService.amzCreateNegativeTargetingClauses(user, profileid, nkeywords));
    }


    @PostMapping("/updateCampNegativaTargets/{profileid}/{campaignType}")
    public Result<?> updateCampNegativaTargetsAction(@PathVariable String profileid, @PathVariable String campaignType,
        ...
        return Result.success(
                amzAdvCampProductTargeNegativaService.amzUpdateNegativeTargetingClauses(user, profileid, keywordArray));
    }


    @ApiOperation("查询广告投放Query")
    @PostMapping("/getProductTargeQueryList")
    public Result<PageList<Map<String, Object>>> getTargeQueryListAction(
            @ApiParam("查询广告") @RequestBody QueryForList query) {
        UserInfo user = UserInfoContext.get();
        String state = query.getState();
        ...
        PageList<Map<String, Object>> list = amzAdvReportTargetQueryService.getProductTargeQueryList(map,
                query.getPageBounds());
        if (list != null) {
            for (Map<String, Object> item : list) {
                if ("paused".equals(item.get("campaignStatus")) || "paused".equals(item.get("adGroupStatus"))) {
    ...
    public Result<Map<String, Object>> getProductTargeQueryChartAction(
            @ApiParam("查询广告") @RequestBody QueryForList query) {
        UserInfo user = UserInfoContext.get();
        String state = query.getState();
        String bytime = query.getBytime();
    ...
    public Result<String> createTargetListAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody Map<String, Object> params) {
        UserInfo user = UserInfoContext.get();
        String json = params.get("jsonstr").toString();
        JSONObject jsonobject = GeneralUtil.getJsonObject(json);
    ...
    public Result<String> updateTargetListListAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody Map<String, Object> param) {
        UserInfo user = UserInfoContext.get();
        String json = param.get("jsonstr").toString();
        JSONObject jsonobject = GeneralUtil.getJsonObject(json);
    ...
    public Result<?> deleteTargetsAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        if ("sd".equals(campaignType.toLowerCase())) {
            AmzAdvProductTargeSD amzAdvProductTarge = null;
            amzAdvProductTarge = amzAdvProductTargeSDService.amzArchiveTargetingClause(user, new BigInteger(profileid),
                    idlist.get(0));
            ...
            amzAdvProductTarge = amzAdvProductTargeHsaService.amzDeleteTargets(user, new BigInteger(profileid),
                    idlist.get(0));
            return Result.success(Arrays.asList(amzAdvProductTarge));
        } else {
            JSONObject param = new JSONObject();
    ...
    public Result<?> getTargetsAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            JSONObject param = new JSONObject();
            ...
            for (String item : idlist) {
                AmzAdvProductTargeSD target = amzAdvProductTargeSDService.amzGetTargetsExt(user,
                        new BigInteger(profileid), item);
                result.add(target);
            }
            return Result.success(result);
            ...
            for (String item : idlist) {
                AmzAdvProductTargeHsa target = amzAdvProductTargeHsaService.amzGetTargets(user,
                        new BigInteger(profileid), item);
                result.add(target);
            }
            return Result.success(result);
    ...
    public Result<?> targetsByParamAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            return Result.success(amzAdvProductTargeService.amzGetTargets(user, new BigInteger(profileid), param));
            ...
            return Result.success(
                    amzAdvProductTargeSDService.amzListTargetingClausesEx(user, new BigInteger(profileid), paramobj));
        } else {
            return Result.success();
        }
    }
    ...
    public Result<?> getTargetsExtListAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            JSONObject param = new JSONObject();
