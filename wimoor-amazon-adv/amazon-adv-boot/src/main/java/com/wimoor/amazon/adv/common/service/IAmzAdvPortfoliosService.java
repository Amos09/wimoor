...
public interface IAmzAdvPortfoliosService extends IService<AmzAdvPortfolios> {
    ...
    List<AmzAdvPortfolios> amzGetListPortfolios(UserInfo user, BigInteger profileId,
            Map<String, Object> portfoliosParam);

    List<AmzAdvPortfolios> amzGetListPortfoliosEx(UserInfo user, BigInteger profileId,
            Map<String, Object> portfoliosParam);
    ...
    List<AmzAdvPortfolios> amzCreatePortfolios(UserInfo user, BigInteger profileId,
            List<AmzAdvPortfolios> portfoliosList);

    List<AmzAdvPortfolios> amzUpdatePortfolios(UserInfo user, BigInteger profileId,
            List<AmzAdvPortfolios> portfoliosList);
}
