...
public class AmzAdvProductTargeServiceImpl extends BaseService<AmzAdvProductTarge> implements
        IAmzAdvProductTargeService {
    ...
    public List<AmzAdvProductTarge> amzCreateTargetingClauses(UserInfo user, BigInteger profileId,
            List<AmzAdvProductTarge> productTargeList) {
    ...
    public List<AmzAdvProductTarge> amzUpdateTargetingClauses(UserInfo user, BigInteger profileId,
            List<AmzAdvProductTarge> productTargeList) {
        if (productTargeList == null || productTargeList.size() <= 0) {
            return null;
        }
    ...
    public List<AmzAdvProductTarge> amzDeleteTargets(UserInfo user, BigInteger profileId, JSONObject param) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < a.size(); i++) {
                ...
                AmzAdvProductTarge oldamzAdvProductads = amzAdvProductTargeMapper.selectByPrimaryKey(
                        amzAdvProductTarge);
