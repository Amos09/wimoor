...
public class AdvertCreativeController {
    ...
    public Result<?> getCreativePreviewHTMLAction(@PathVariable String profileid, @PathVariable String CampaignType,
        ...
        if (CampaignType.toLowerCase().equals("sd")) {
            return Result.success(
                    amzAdvCreativesSDService.getCreativePreviewHTML(user, new BigInteger(profileid), param));
        }
    ...
    public Result<?> getListCreativeModerationsAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        List<Object> result = null;
        if (StringUtil.isEmpty(CampaignType)) {
        ...
        if (CampaignType.toLowerCase().equals("sd")) {
            return Result.success(
                    amzAdvCreativesSDService.getListCreativeModerations(user, new BigInteger(profileid), param));
        }
        if (CampaignType.toLowerCase().equals("sb")) {
    ...
    public Result<?> getListOfCreativesAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (StringUtil.isEmpty(CampaignType)) {
            throw new BizException("广告类型不能为空");
    ...
    public Result<?> requestCreativesAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (StringUtil.isEmpty(CampaignType)) {
            throw new BizException("广告类型不能为空");
    ...
    public Result<?> updatesCreativesAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (StringUtil.isEmpty(CampaignType)) {
            throw new BizException("广告类型不能为空");
    ...
    public Result<?> createBrandVideoAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (StringUtil.isEmpty(CampaignType)) {
            throw new BizException("广告类型不能为空");
    ...
    public Result<?> createVideoAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (StringUtil.isEmpty(CampaignType)) {
            throw new BizException("广告类型不能为空");
    ...
    public Result<?> createProductCollectionAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (StringUtil.isEmpty(CampaignType)) {
            throw new BizException("广告类型不能为空");
        ...
        if (CampaignType.toLowerCase().equals("sd")) {
            return Result.success(
                    amzAdvCreativesHsaService.createProductCollection(user, new BigInteger(profileid), param));
        }
        if (CampaignType.toLowerCase().equals("sb")) {
    ...
    public Result<?> createStoreSpotlightAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (StringUtil.isEmpty(CampaignType)) {
            throw new BizException("广告类型不能为空");
        ...
        if (CampaignType.toLowerCase().equals("sd")) {
            return Result.success(
                    amzAdvCreativesHsaService.createStoreSpotlight(user, new BigInteger(profileid), param));
        }
        if (CampaignType.toLowerCase().equals("sb")) {
