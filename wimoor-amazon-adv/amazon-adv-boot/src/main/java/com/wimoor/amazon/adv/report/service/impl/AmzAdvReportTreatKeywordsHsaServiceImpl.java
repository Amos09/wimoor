...
public class AmzAdvReportTreatKeywordsHsaServiceImpl extends AmzAdvReportTreatServiceImpl implements
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (request.getLog() != null && request.getLog().equals("hasName")) {
                    AmzAdvKeywordsHsa keyword = amzAdvKeywordsHsaMapper.selectByPrimaryKey(
                            amzAdvReportHasKeyword.getKeywordid());
                    if (keyword == null) {
                ...
                if ((amzAdvReportHasKeyword.getClicks() == null || amzAdvReportHasKeyword.getClicks() == 0)
                        && (amzAdvReportHasKeyword.getImpressions() == null
                        || amzAdvReportHasKeyword.getImpressions() == 0)
                        && (amzAdvReportHasKeyword.getCost() == null
                        || amzAdvReportHasKeyword.getCost().compareTo(new BigDecimal("0")) == 0)
                ) {
                    continue;
                }
                ...
                amzAdvReportKeywordsHsaAttributed.setAttributedsales14dsamesku(
                        item.getBigDecimal("attributedSales14dSameSKU"));
                amzAdvReportKeywordsHsaAttributed.setAttributedconversions14d(
                        item.getInteger("attributedConversions14d"));
                amzAdvReportKeywordsHsaAttributed.setAttributedconversions14dsamesku(
                ...
                if (request.getCreativeType() != null && "video".equals(request.getCreativeType())) {
                    ...
                    amzAdvReportHasKeywordBrand.setAttributedDetailPageViewsClicks14d(
                            item.getInteger("attributedDetailPageViewsClicks14d"));
                    amzAdvReportHasKeywordBrand.setAttributedOrdersNewToBrand14d(
                            item.getInteger("attributedOrdersNewToBrand14d"));
                    amzAdvReportHasKeywordBrand.setAttributedOrdersNewToBrandPercentage14d(
                            item.getBigDecimal("attributedOrdersNewToBrandPercentage14d"));
                    amzAdvReportHasKeywordBrand.setAttributedOrderRateNewToBrand14d(
                            item.getInteger("attributedOrderRateNewToBrand14d"));
                    amzAdvReportHasKeywordBrand.setAttributedSalesNewToBrand14d(
                            item.getInteger("attributedSalesNewToBrand14d"));
                    amzAdvReportHasKeywordBrand.setAttributedSalesNewToBrandPercentage14d(
                            item.getBigDecimal("attributedSalesNewToBrandPercentage14d"));
                    amzAdvReportHasKeywordBrand.setAttributedUnitsOrderedNewToBrand14d(
                            item.getInteger("attributedUnitsOrderedNewToBrand14d"));
                    amzAdvReportHasKeywordBrand.setAttributedUnitsOrderedNewToBrandPercentage14d(
