...
public class AmzAdvReportAdGroupsSDAttributedView {
    ...
    public boolean isZero() {
        if (viewImpressions != null && viewImpressions != 0) {
            return false;
        }
        if (viewAttributedConversions14d != null && viewAttributedConversions14d != 0) {
            return false;
        }
        if (viewAttributedUnitsOrdered14d != null && viewAttributedUnitsOrdered14d != 0) {
            return false;
        }
        if (viewAttributedSales14d != null && viewAttributedSales14d.floatValue() > 0.001) {
            return false;
        }
        return true;
