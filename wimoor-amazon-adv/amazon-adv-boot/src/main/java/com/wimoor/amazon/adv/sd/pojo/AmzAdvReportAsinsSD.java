...
public class AmzAdvReportAsinsSD {
    ...
    public boolean isZero() {
        if (attributedSales30dOtherSKU != null && attributedSales30dOtherSKU.floatValue() > 0.001) {
            return false;
        }
        if (attributedSales14dOtherSKU != null && attributedSales14dOtherSKU.floatValue() > 0.001) {
            return false;
        }
        if (attributedSales7dOtherSKU != null && attributedSales7dOtherSKU.floatValue() > 0.001) {
            return false;
        }
        if (attributedSales1dOtherSKU != null && attributedSales1dOtherSKU.floatValue() > 0.001) {
            return false;
        }

        if (attributedUnitsOrdered30dOtherSKU != null && attributedUnitsOrdered30dOtherSKU != 0) {
            return false;
        }
        if (attributedUnitsOrdered14dOtherSKU != null && attributedUnitsOrdered14dOtherSKU != 0) {
            return false;
        }
        if (attributedUnitsOrdered7dOtherSKU != null && attributedUnitsOrdered7dOtherSKU != 0) {
            return false;
        }
        if (attributedUnitsOrdered1dOtherSKU != null && attributedUnitsOrdered1dOtherSKU != 0) {
            return false;
        }
