...
public class AmzAdvReportTreatProductTargetHsaServiceImpl extends AmzAdvReportTreatServiceImpl implements
    ...
    public void runRequestReportV2(AmzAdvProfile profile, JSONObject param, String url, Date startDate, Date endDate,
            AmzAdvReportRequestType type, List<AmzAdvRequest> list) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            String recordType =
                    item.getString("recordType") != null ? item.getString("recordType") : type.getReponsetype();
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (request.getLog() != null && request.getLog().equals("hasName")) {
                    AmzAdvProductTargeHsa target = amzAdvProductTargeHsaMapper.selectByPrimaryKey(
                            amzAdvReportProductTargeHsa.getTargetid());
                    if (target == null) {
                ...
                amzAdvReportProductTargeHsaAttributed.setAttributedsales14dsamesku(
                        item.getBigDecimal("attributedSales14dSameSKU"));
                amzAdvReportProductTargeHsaAttributed.setAttributedconversions14d(
                        item.getInteger("attributedConversions14d"));
                amzAdvReportProductTargeHsaAttributed.setAttributedconversions14dsamesku(
                ...
                if (request.getCreativeType() != null && "video".equals(request.getCreativeType())) {
                    ...
                    amzAdvReportProductTargetsHsaVideo.setVideoFirstQuartileViews(
                            item.getInteger("videoFirstQuartileViews"));
                    amzAdvReportProductTargetsHsaVideo.setVideoMidpointViews(item.getInteger("videoMidpointViews"));
                    amzAdvReportProductTargetsHsaVideo.setVideoThirdQuartileViews(
                            item.getInteger("videoThirdQuartileViews"));
                    ...
                    amzAdvReportProductTargetsHsaVideo.setVideo5SecondViewRate(
                            item.getBigDecimal("video5SecondViewRate"));
                    ...
                    amzAdvReportProductTargetsHsaBrand.setAttributedDetailPageViewsClicks14d(
                            item.getInteger("attributedDetailPageViewsClicks14d"));
                    amzAdvReportProductTargetsHsaBrand.setAttributedOrdersNewToBrand14d(
                            item.getInteger("attributedOrdersNewToBrand14d"));
                    amzAdvReportProductTargetsHsaBrand.setAttributedOrdersNewToBrandPercentage14d(
                            item.getBigDecimal("attributedOrdersNewToBrandPercentage14d"));
                    amzAdvReportProductTargetsHsaBrand.setAttributedOrderRateNewToBrand14d(
                            item.getInteger("attributedOrderRateNewToBrand14d"));
                    amzAdvReportProductTargetsHsaBrand.setAttributedSalesNewToBrand14d(
                            item.getInteger("attributedSalesNewToBrand14d"));
                    amzAdvReportProductTargetsHsaBrand.setAttributedSalesNewToBrandPercentage14d(
                            item.getBigDecimal("attributedSalesNewToBrandPercentage14d"));
                    amzAdvReportProductTargetsHsaBrand.setAttributedUnitsOrderedNewToBrand14d(
                            item.getInteger("attributedUnitsOrderedNewToBrand14d"));
                    amzAdvReportProductTargetsHsaBrand.setAttributedUnitsOrderedNewToBrandPercentage14d(
                            item.getBigDecimal("attributedUnitsOrderedNewToBrandPercentage14d"));
                ...
                if ((amzAdvReportProductTargeHsa.getImpressions() == null
                        || amzAdvReportProductTargeHsa.getImpressions() == 0)) {
                    continue;
                }
