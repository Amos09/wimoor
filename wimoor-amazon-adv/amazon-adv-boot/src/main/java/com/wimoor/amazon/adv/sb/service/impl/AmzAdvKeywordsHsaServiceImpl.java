...
public class AmzAdvKeywordsHsaServiceImpl extends BaseService<AmzAdvKeywordsHsa> implements IAmzAdvKeywordsHsaService {
     ...
     */
    public List<AmzAdvKeywordsHsa> amzUpdateKeywords(UserInfo user, BigInteger profileId,
            List<AmzAdvKeywordsHsa> biddableKeywordList) {
    ...
    public List<AmzAdvKeywordsHsa> amzCreateKeywords(UserInfo user, BigInteger profileId,
            List<AmzAdvKeywordsHsa> list) {
    ...
    public AmzAdvKeywordsHsa amzDeleteKeywords(UserInfo user, BigInteger profileId, JSONObject param) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            if ("SUCCESS".equals(a.getString("code"))) {
                ...
                amzAdvKeywords.setOpttime(new Date());
                this.updateAll(amzAdvKeywords);
                amzAdvOperateLogService.saveOperateLog("AmzAdvKeywords", user.getId(), profileId, amzAdvKeywords,
                        oldamzAdvKeywords);
    ...
    public List<AmzAdvKeywordsHsa> amzCreateKeywords(UserInfo user, String profileid, JSONArray keywords) {
        ...
        return this.amzCreateKeywords(user, new BigInteger(profileid),
    ...
    public List<AmzAdvKeywordsHsa> amzUpdateKeywords(UserInfo user, String profileid, JSONArray keywords) {
        // TODO Auto-generated method stub
        return this.amzUpdateKeywords(user, new BigInteger(profileid),
                this.convertJsonToBean(user, profileid, keywords));
    }
