...
public class AmzAdvProductTargeHsaServiceImpl extends BaseService<AmzAdvProductTargeHsa> implements
        IAmzAdvProductTargeHsaService {
    ...
    public List<AmzAdvProductTargeHsa> amzCreateTargetingClauses(UserInfo user, BigInteger profileId,
            List<AmzAdvProductTargeHsa> productTargeList) {
    ...
    public List<AmzAdvProductTargeHsa> amzUpdateTargetingClauses(UserInfo user, BigInteger profileId,
            List<AmzAdvProductTargeHsa> productTargeList) {
        if (productTargeList == null || productTargeList.size() <= 0) {
            return null;
        }
    ...
    public AmzAdvProductTargeHsa amzDeleteTargets(UserInfo user, BigInteger profileId, String targetId) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            if ("SUCCESS".equals(a.getString("code"))) {
                ...
                amzAdvOperateLogService.saveOperateLog("AmzAdvProductTarge", user.getId(), profileId, productTarge,
                        oldproductTarge);
                return productTarge;
            } else {
                String errormsg = "";
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            if (a != null) {
                for (int i = 0; i < a.size(); i++) {
                    ...
                    amzAdvProductTarge.setOpttime(new Date());
                    AmzAdvProductTargeHsa oldamzAdvProductads = amzAdvProductTargeHsaMapper.selectByPrimaryKey(
                            amzAdvProductTarge);
    ...
    public List<AmzAdvProductTargeHsa> amzUpdateTargets(UserInfo user, String profileid, JSONArray targets) {
        ...
        return this.amzUpdateTargetingClauses(user, new BigInteger(profileid),
                convertJsonToBean(user, profileid, targets));
