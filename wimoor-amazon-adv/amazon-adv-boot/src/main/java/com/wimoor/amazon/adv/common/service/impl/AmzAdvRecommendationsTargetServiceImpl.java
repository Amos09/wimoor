...
public class AmzAdvRecommendationsTargetServiceImpl implements IAmzAdvRecommendationsTargetService {
    ...
    public Map<String, Object> amzCreateTargetRecommendations(UserInfo user, BigInteger profileId,
            List<String> asinsList, int pageSize, int pageNumber) {
        if (asinsList == null) {
            return null;
        }
    ...
    public List<Map<String, Object>> amzGetBrandRecommendations(UserInfo user, BigInteger profileId, String categoryId,
            String keyword) {
        String urltype = "";
        if (keyword == null) {
    ...
    public List<Map<String, Object>> amzGetRefinementsForCategory(UserInfo user, BigInteger profileId,
            String categoryId) {
    ...
    public List<Map<String, Object>> amzTargetRecommendationsProductList_HSA(UserInfo user, BigInteger profileId,
            List<String> paramList, int maxResults, String nextToken) {
    ...
    public List<Map<String, Object>> amzRecommendationsCategories_HSA(UserInfo user, BigInteger profileId,
            List<String> asinsList) {
    ...
    public List<Map<String, Object>> amzRecommendationsBrand_HSA(UserInfo user, BigInteger profileId, String categoryId,
            String keyword) {
