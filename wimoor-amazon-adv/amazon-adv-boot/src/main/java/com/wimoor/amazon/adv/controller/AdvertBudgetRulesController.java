...
public class AdvertBudgetRulesController {
    ...
    public Result<?> budgetRulesRecommendationAction(@PathVariable String profileid, @PathVariable String CampaignType,
    ...
    public Result<List<AmzAdvBudgetRules>> amzCreateBudgetRulesAction(@PathVariable String profileid,
    ...
    public Result<?> amzUpdateBudgetRulesAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody JSONObject param) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
    ...
    public Result<?> listAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody QueryForList param) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
        String type = "sp";
    ...
    public Result<?> amzGetBudgetRuleAction(@PathVariable String profileid, @PathVariable String CampaignType,
            String budgetRuleId) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
    ...
    public Result<?> amzGetBudgetRulesAction(@PathVariable String profileid, @PathVariable String CampaignType,
            @RequestBody JSONObject param) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
    ...
    public Result<?> amzGetCampaignByBudgetRuleAction(@PathVariable String profileid, @PathVariable String CampaignType,
            String budgetRuleId) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
    ...
    public Result<?> amzGetBudgetRulesByCampaignAction(@PathVariable String profileid,
            @PathVariable String CampaignType, String campaignId) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
    ...
    public Result<?> amzDeleteCampaignBudgetRuleAction(@PathVariable String profileid,
            @PathVariable String CampaignType, String campaignId, String budgetRuleId) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
    ...
    public Result<?> amzPostBudgetRulesByCampaignAction(@PathVariable String profileid,
            @PathVariable String CampaignType, @RequestBody JSONObject param) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
        String campaignId = param.getString("campaignId");
        String ruleid = param.getString("ruleid");
        return Result.success(
                amzAdvBudgetRulesService.amzPostBudgetRulesByCampaign(profile, campaignId, ruleid, CampaignType));
    }

    @GetMapping("/getAdvBudgetRuleByProfileid/{profileid}/{CampaignType}")
    public Result<List<AmzAdvBudgetRules>> getAdvBudgetRuleByProfileidAction(@PathVariable String profileid,
