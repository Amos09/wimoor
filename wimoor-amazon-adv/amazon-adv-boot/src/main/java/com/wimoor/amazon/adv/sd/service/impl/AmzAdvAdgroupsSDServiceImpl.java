...
public class AmzAdvAdgroupsSDServiceImpl extends BaseService<AmzAdvAdgroupsSD> implements IAmzAdvAdgroupsSDService {
    ...
    public List<AmzAdvAdgroupsSD> amzCreateAdGroups(UserInfo user, BigInteger profileId,
            List<AmzAdvAdgroupsSD> adgroups) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < adgroups.size(); i++) {
                ...
                if ("SUCCESS".equals(item.getString("code"))) {
                    ...
                    if (Dbadgroup == null) {
                        this.save(adgroup);
                        amzAdvOperateLogService.saveOperateLog("AmzAdvAdgroupsSD", user.getId(), profileId, adgroup,
                                null);
                    }
                } else {
    ...
    public List<AmzAdvAdgroupsSD> amzUpdateAdGroups(UserInfo user, BigInteger profileId,
            List<AmzAdvAdgroupsSD> adgroupList) {
