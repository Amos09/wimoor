...
public class AdvertAdsController {
    ...
    public Result<?> createAdsAction(@PathVariable String profileid, @PathVariable String adsType,
    ...
    public Result<?> getAdsAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody JSONObject params) {
    ...
    public Result<?> deleteAdsAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody JSONObject params) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
        UserInfo user = UserInfoContext.get();
    ...
    public Result<PageList<Map<String, Object>>> getAdsListAction(
