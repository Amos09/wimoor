...
public class AmzAdvReportTreatAdgroupsHsaServiceImpl extends AmzAdvReportTreatServiceImpl implements
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (request.getLog() != null && request.getLog().equals("hasName")) {
                    AmzAdvAdgroupsHsa adgroup = amzAdvAdgroupsHsaMapper.selectByPrimaryKey(
                            amzAdvReportHas.getAdgroupid());
                    if (adgroup == null) {
                ...
                amzAdvReportAdgroupsHsaAttributed.setAttributedsales14dsamesku(
                        item.getBigDecimal("attributedSales14dSameSKU"));
                amzAdvReportAdgroupsHsaAttributed.setAttributedconversions14d(
                        item.getInteger("attributedConversions14d"));
                amzAdvReportAdgroupsHsaAttributed.setAttributedconversions14dsamesku(
                ...
                if (request.getCreativeType() != null && "video".equals(request.getCreativeType())) {
                    ...
                    amzAdvReportHasBrand.setAttributedDetailPageViewsClicks14d(
                            item.getInteger("attributedDetailPageViewsClicks14d"));
                    amzAdvReportHasBrand.setAttributedOrdersNewToBrand14d(
                            item.getInteger("attributedOrdersNewToBrand14d"));
                    amzAdvReportHasBrand.setAttributedOrdersNewToBrandPercentage14d(
                            item.getBigDecimal("attributedOrdersNewToBrandPercentage14d"));
                    amzAdvReportHasBrand.setAttributedOrderRateNewToBrand14d(
                            item.getInteger("attributedOrderRateNewToBrand14d"));
                    amzAdvReportHasBrand.setAttributedSalesNewToBrand14d(
                            item.getInteger("attributedSalesNewToBrand14d"));
                    amzAdvReportHasBrand.setAttributedSalesNewToBrandPercentage14d(
                            item.getBigDecimal("attributedSalesNewToBrandPercentage14d"));
                    amzAdvReportHasBrand.setAttributedUnitsOrderedNewToBrand14d(
                            item.getInteger("attributedUnitsOrderedNewToBrand14d"));
                    amzAdvReportHasBrand.setAttributedUnitsOrderedNewToBrandPercentage14d(
                ...
                if (amzAdvReportAdgroupsHsaAttributed.getAttributedsales14d() != null) {
                    attributedunitsordered = attributedunitsordered +
                            (amzAdvReportAdgroupsHsaAttributed.getAttributedsales14d() != null
                                    ? amzAdvReportAdgroupsHsaAttributed.getAttributedsales14d().intValue() : 0);
                }
                if (amzAdvReportAdgroupsHsaAttributed.getAttributedconversions14d() != null) {
                    attributedConversions = attributedConversions +
                            (amzAdvReportAdgroupsHsaAttributed.getAttributedconversions14d() != null
                                    ? amzAdvReportAdgroupsHsaAttributed.getAttributedconversions14d().intValue() : 0);
                }
                if (list.size() >= 2000) {
