...
public class AmzAdvReportTreatAsinSDServiceImpl extends AmzAdvReportTreatServiceImpl implements
    ...
    public synchronized void treatReport(AmzAdvProfile profile, AmzAdvRequest request, JSONReader jsonReader) {
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                amzAdvReportAsins.setAttributedUnitsOrdered14dOtherSKU(
                        item.getInteger("attributedUnitsOrdered14dOtherSKU"));
                amzAdvReportAsins.setAttributedUnitsOrdered1dOtherSKU(
                        item.getInteger("attributedUnitsOrdered1dOtherSKU"));
                amzAdvReportAsins.setAttributedUnitsOrdered30dOtherSKU(
                        item.getInteger("attributedUnitsOrdered30dOtherSKU"));
                amzAdvReportAsins.setAttributedUnitsOrdered7dOtherSKU(
                        item.getInteger("attributedUnitsOrdered7dOtherSKU"));
