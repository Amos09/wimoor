...
public class AmzAdvSnapshotHandlerApiServiceImpl implements IAmzAdvSnapshotHandlerApiService {
    ...
    public void requestHsaCampaign(AmzAdvProfile profile) {
        ...
        try {
            ...
            if (page != null && page.getNexttoken() == null && page.getOpttime() != null
                    && GeneralUtil.distanceOfHour(page.getOpttime(), new Date()) < 20) {
                return;
    ...
    public void requestHsaKeyword(AmzAdvProfile profile) {
        ...
        try {
            ...
            if (page != null && (page.getPages() == null || page.getPages() == -1) && page.getOpttime() != null
                    && GeneralUtil.distanceOfHour(page.getOpttime(), new Date()) < 20) {
                return;
    ...
    public void requestSPCampProductTargeNegative(AmzAdvProfile profile) {
        ...
        try {
            if (page != null && (page.getPages() == null || page.getPages() == -1) && page.getOpttime() != null
                ...
                List<AmzAdvCampProductTargeNegativa> list = amzAdvCampProductTargeNegativaService.amzListNegativeTargetingClauses(
                        null, profile.getId(), param);
    ...
    public void requestSDProductTargeNegative(AmzAdvProfile profile) {
        ...
        try {
            ...
            if (page != null && (page.getPages() == null || page.getPages() == -1)
                    && GeneralUtil.distanceOfHour(page.getOpttime(), new Date()) < 20) {
                return;
            } else if (page == null || page.getPages() == null) {
                param.put("count", 10);
                param.put("startIndex", pageindex);
                List<AmzAdvProductTargeNegativaSD> list = amzAdvProductTargeNegativaSDService.amzListNegativeTargetingClauses(
                        null, profile.getId(), param);
                if (list == null || list.size() < 10) {
