...
public class AmzAdvReportCampaignsHsaBrand {
    ...
    public void setAttributedUnitsOrderedNewToBrandPercentage14d(
            BigDecimal attributedUnitsOrderedNewToBrandPercentage14d) {
    ...
    public boolean iszero() {
        if (dpv14d != null && dpv14d != 0) {
            return false;
        }
        if (unitsSold14d != null && unitsSold14d != 0) {
            return false;
        }
        if (attributedUnitsOrderedNewToBrand14d != null && attributedUnitsOrderedNewToBrand14d != 0) {
            return false;
        }
        if (attributedSalesNewToBrand14d != null && attributedSalesNewToBrand14d.floatValue() > 0.001) {
            return false;
        }
        if (attributedOrderRateNewToBrand14d != null && attributedOrderRateNewToBrand14d != 0) {
            return false;
        }
        if (attributedOrdersNewToBrand14d != null && attributedOrdersNewToBrand14d != 0) {
            return false;
        }
        if (attributedDetailPageViewsClicks14d != null && attributedDetailPageViewsClicks14d != 0) {
            return false;
        }
        if (attributedOrdersNewToBrandPercentage14d != null
                && attributedOrdersNewToBrandPercentage14d.floatValue() > 0.001) {
            return false;
        }
        if (attributedSalesNewToBrandPercentage14d != null
                && attributedSalesNewToBrandPercentage14d.floatValue() > 0.001) {
            return false;
        }
        if (attributedUnitsOrderedNewToBrandPercentage14d != null
                && attributedUnitsOrderedNewToBrandPercentage14d.floatValue() > 0.001) {
            return false;
        }
        return true;
    }
