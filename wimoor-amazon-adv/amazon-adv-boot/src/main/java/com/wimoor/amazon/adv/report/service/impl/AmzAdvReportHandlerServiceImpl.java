                ...
                public void run() {
                    ...
                    try {
                        ...
                        for (AmzAdvProfile profile : profilelist) {
                            if ("agency".equals(profile.getType()) || (profile.getErrorDay() != null
                                    && GeneralUtil.distanceOfMinutes(profile.getErrorDay(), new Date()) < 10)) {
                                continue;
                            }
                            if (apiBuildService.isBusy()) {
                                try {
                            ...
                            List<AmzAdvRequest> requestlist = amzAdvRequestMapper.getNeedTreatReport(
    ...
    public void readReport(AmzAdvProfile profile, AmzAdvRequest request) {
        ...
        try {
            ...
            if (StringUtil.isNotEmpty(response)) {
                ...
                String location =
                        item.getString("location") != null ? item.getString("location") : item.getString("url");
    ...
    public boolean checkReport(AmzAdvProfile profile, String segment) {
        if (segment != null) {
            ...
            if ("T00001".equals(segment)) {
                ...
                if ("ATVPDKIKX0DER".equals(profile.getMarketplaceid()) || "A2EUQ1WTGCTBG2".equals(
    ...
    public void requestReport() {
        ...
        for (AmzAdvReportRequestType type : typeList) {
            ...
            for (AmzAdvAuth advauth : authlist) {
                if (advauth.getDisable() || (advauth.getDisableTime() != null
