...
public class AdvertKeywordManagerController {
    ...
    public Result<String> createKeywordListAction(@PathVariable String profileid, @PathVariable String campaignType,
    ...
    public Result<String> updateKeywordListAction(@PathVariable String profileid, @PathVariable String campaignType,
    ...
    public Result<String> deleteKeywordListAction(@PathVariable String profileid, @PathVariable String campaignType,
    ...
    public Result<?> getSuggestedkeywordsByAdGroup(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            return Result.success(this.amzAdvRecommendationsService.amzAdvRecommendationsTargetsKeywords(user,
                    new BigInteger(profileid), param));
        } else {
            return Result.success(
                    this.amzAdvRecommendationsHsaService.amzKeywordRecommendations(user, new BigInteger(profileid),
                            param));
        }
    }

    @PostMapping("/getAmzKeywordBid/{profileid}/{campaignType}")
    public Result<String> getAmzKeywordBid(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody JSONObject param) {
        UserInfo user = UserInfoContext.get();
        return Result.success(
                this.amzAdvRecommendationsHsaService.amzAdvRecommendationsBid(user, new BigInteger(profileid), param));
    }
    ...
    public Result<PageList<Map<String, Object>>> getKeywordListAction(
            @ApiParam("查询关键词") @RequestBody QueryForList query) {
        UserInfo user = UserInfoContext.get();
    ...
    public Result<PageList<Map<String, Object>>> getNegativaKeywordsListAction(
            @ApiParam("查询关键词") @RequestBody QueryForList query) {
        UserInfo user = UserInfoContext.get();
        Map<String, Object> map = AdvertController.amzAdvParameterMap(query);
        String state = query.getState();
    ...
    public Result<?> getkeywordNegativaAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            JSONObject param = new JSONObject();
            ...
            param.put("includeExtendedDataFields", false);
            return Result.success(
                    amzAdvKeywordsNegativaService.amzListNegativaKeywords(user, new BigInteger(profileid), param));
        } else {
            List<AmzAdvKeywordsNegativaHsa> sb = new LinkedList<AmzAdvKeywordsNegativaHsa>();
            for (String id : idlist) {
                AmzAdvKeywordsNegativaHsa amzAdvKeywordsNegativaHsa = amzAdvKeywordsNegativaHsaService.amzGetNegativaKeywordEx(
    ...
    public Result<?> getkeywordNegativaExtAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            JSONObject param = new JSONObject();
    ...
    public Result<?> CreateKeywordNegativaAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody Map<String, Object> params) {
        UserInfo user = UserInfoContext.get();
        String json = params.get("jsonstr").toString();
        JSONObject jsonobject = GeneralUtil.getJsonObject(json);
        ...
        if ("hsa".equals(campaignType.toLowerCase()) || "sb".equals(campaignType.toLowerCase())) {
            return Result.success(
                    amzAdvKeywordsNegativaHsaService.amzCreateNegativaKeywords(user, profileid, nkeywords));
        } else {
    ...
    public Result<?> updateNegativaKeywordListAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody Map<String, Object> param) {
        UserInfo user = UserInfoContext.get();
        String json = param.get("jsonstr").toString();
        JSONObject jsonobject = GeneralUtil.getJsonObject(json);
    ...
    public Result<?> deleteNegativaKeywordListAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        if ("sp".equals(campaignType.toLowerCase())) {
            ...
            param.put("includeExtendedDataFields", true);
            return Result.success(
                    amzAdvKeywordsNegativaService.amzDeleteNegativaKeywords(user, new BigInteger(profileid), param));
        } else {
            List<AmzAdvKeywordsNegativaHsa> result = new LinkedList<AmzAdvKeywordsNegativaHsa>();
            for (String id : idlist) {
                AmzAdvKeywordsNegativaHsa item = amzAdvKeywordsNegativaHsaService.amzDeleteNegativaKeywords(user,
                        new BigInteger(profileid), id);
                result.add(item);
            }
    ...
    public Result<?> getCampKeywordNegativaAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        JSONObject param = new JSONObject();
        JSONObject keywordIdFilter = new JSONObject();
        ...
        param.put("includeExtendedDataFields", false);
        return Result.success(
                amzAdvCampKeywordsNegativaService.amzListCampaignNegativeKeywords(user, new BigInteger(profileid),
                        param));
    }

    @PostMapping("/campKeywordNegativaExt/{profileid}/{campaignType}")
    public Result<?> getCampKeywordNegativaExtAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        JSONObject param = new JSONObject();
        JSONObject keywordIdFilter = new JSONObject();
    ...
    public Result<List<AmzAdvCampKeywordsNegativa>> CreateCampKeywordsNegativaAction(@PathVariable String profileid,
        ...
        JSONArray nkeywords = jsonobject.getJSONArray("nkeywords");
        return Result.success(
                amzAdvCampKeywordsNegativaService.amzCreateCampaignNegativeKeywords(user, profileid, nkeywords));
    }


    @PostMapping("/updateCampNegativaKeywordList/{profileid}/{campaignType}")
    public Result<?> updateCampNegativaKeywordListAction(@PathVariable String profileid,
        ...
        JSONArray keywordArray = jsonobject.getJSONArray("nkeywords");
        return Result.success(
                amzAdvCampKeywordsNegativaService.amzUpdateCampaignNegativeKeywords(user, profileid, keywordArray));
    }

    @PostMapping("/deleteCampNegativaKeywordList/{profileid}/{campaignType}")
    public Result<?> deleteCampNegativaKeywordListAction(@PathVariable String profileid,
            @PathVariable String campaignType, @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        JSONObject param = new JSONObject();
        JSONObject adGroupIdFilter = new JSONObject();
        adGroupIdFilter.put("include", idlist);
        ...
        return Result.success(
                amzAdvCampKeywordsNegativaService.amzDeleteCampaignNegativaKeywords(user, new BigInteger(profileid),
                        param));
    }
    ...
    public Result<PageList<Map<String, Object>>> getKeywordQueryListAction(
            @ApiParam("查询关键词") @RequestBody QueryForList query) {
        UserInfo user = UserInfoContext.get();
        Map<String, Object> map = AdvertController.amzAdvParameterMap(query);
    ...
    public Result<Map<String, Object>> getKeywordQueryChartAction(
            @ApiParam("查询关键词") @RequestBody QueryForList query) {
        UserInfo user = UserInfoContext.get();
        String state = query.getState();
        String matchType = query.getMatchType();
    ...
    public Result<?> getKeywordListAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        JSONObject param = new JSONObject();
        JSONObject keywordIdFilter = new JSONObject();
    ...
    public Result<?> getKeywordExtListAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            JSONObject param = new JSONObject();
