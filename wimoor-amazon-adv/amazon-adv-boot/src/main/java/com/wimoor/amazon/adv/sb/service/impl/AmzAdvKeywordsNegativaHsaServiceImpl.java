...
public class AmzAdvKeywordsNegativaHsaServiceImpl extends BaseService<AmzAdvKeywordsNegativaHsa> implements
        IAmzAdvKeywordsNegativaHsaService {
    ...
    public AmzAdvKeywordsNegativaHsa amzGetNegativaKeyword(UserInfo user, BigInteger profileId, String keywordId,
            String campaignType) {
        // TODO Auto-generated method stub
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            AmzAdvKeywordsNegativaHsa oldamzAdvKeywordsNegativa = amzAdvKeywordsNegativaHsaMapper.selectByPrimaryKey(
                    amzAdvKeywordsNegativa);
    ...
    public List<AmzAdvKeywordsNegativaHsa> amzCreateNegativaKeywords(UserInfo user, BigInteger profileId,
            List<AmzAdvKeywordsNegativaHsa> negetivaKeywordList) {
        // TODO Auto-generated method stub
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < negetivaKeywordList.size(); i++) {
                ...
                if ("SUCCESS".equals(item.getString("code"))) {
                    ...
                    BaseException exception = new BaseException(
                            "否定关键词：'" + keywordText + "' 创建失败：" + errormsg);
            ...
            amzAdvOperateLogService.saveBatchOperateLog("AmzAdvKeywordsNegativaHsa", user.getId(), profileId, map,
                    null);
    ...
    public List<AmzAdvKeywordsNegativaHsa> amzUpdateNegativaKeywords(UserInfo user, BigInteger profileId,
            List<AmzAdvKeywordsNegativaHsa> negetivaKeywordList) {
        // TODO Auto-generated method stub
        if (negetivaKeywordList == null || negetivaKeywordList.size() <= 0) {
            return null;
        ...
        for (int i = 0; i < negetivaKeywordList.size(); i++) {
            ...
            AmzAdvKeywordsNegativaHsa oldamzAdvKeywordsNegativa = amzAdvKeywordsNegativaHsaMapper.selectOneByExample(
                    example);
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < negetivaKeywordList.size(); i++) {
                ...
                if ("SUCCESS".equals(item.getString("code"))) {
                    ...
                    errormsg = errormsg + item.getString("description");
                    BaseException exception = new BaseException(
                            "否定关键词：'" + keywordText + "' 修改失败：" + errormsg);
                    exception.setCode("ERROER");
                    throw exception;
                }
            }
    ...
    public List<AmzAdvKeywordsNegativaHsa> amzListNegativaKeywords(UserInfo user, BigInteger profileId,
    ...
    public List<AmzAdvKeywordsNegativaHsa> amzNegativaKeywordsEx(UserInfo user, BigInteger profileId,
            Map<String, Object> param) {
        // TODO Auto-generated method stub
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(profileId);
    ...
    public List<AmzAdvKeywordsNegativaHsa> convertJsonToBean(UserInfo user, BigInteger profileId,
    ...
    public List<AmzAdvKeywordsNegativaHsa> amzCreateNegativaKeywords(UserInfo user, String profileid,
            JSONArray nkeywords) {
        // TODO Auto-generated method stub
        return this.amzCreateNegativaKeywords(user, new BigInteger(profileid),
