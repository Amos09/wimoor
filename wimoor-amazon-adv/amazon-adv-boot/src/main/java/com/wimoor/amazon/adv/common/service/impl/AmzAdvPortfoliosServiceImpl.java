...
public class AmzAdvPortfoliosServiceImpl extends BaseService<AmzAdvPortfolios> implements IAmzAdvPortfoliosService {
    ...
    public List<AmzAdvPortfolios> amzGetListPortfolios(UserInfo user, BigInteger profileId,
            Map<String, Object> portfoliosParam) {
    ...
    public List<AmzAdvPortfolios> amzGetListPortfoliosEx(UserInfo user, BigInteger profileId,
            Map<String, Object> portfoliosParam) {
        if (portfoliosParam == null) {
            return null;
        }
    ...
    public List<AmzAdvPortfolios> amzCreatePortfolios(UserInfo user, BigInteger profileId,
            List<AmzAdvPortfolios> portfoliosList) {
        if (portfoliosList == null || portfoliosList.size() <= 0) {
            return null;
        }
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(profileId);
        String url = "/portfolios";
    ...
    public List<AmzAdvPortfolios> amzUpdatePortfolios(UserInfo user, BigInteger profileId,
            List<AmzAdvPortfolios> portfoliosList) {
        if (portfoliosList == null || portfoliosList.size() <= 0) {
            return null;
        }
