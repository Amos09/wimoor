...
public class AmzAdvReportTreatCampaignsPlaceServiceImpl extends AmzAdvReportTreatServiceImpl implements
    ...
    public synchronized void treatReport(AmzAdvProfile profile, AmzAdvRequest request, JSONReader jsonReader) {
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                String placement =
                        item.getString("placementClassification") != null ? item.getString("placementClassification")
                                : item.getString("placement");
                if (placement == null) {
                    continue;
                }
