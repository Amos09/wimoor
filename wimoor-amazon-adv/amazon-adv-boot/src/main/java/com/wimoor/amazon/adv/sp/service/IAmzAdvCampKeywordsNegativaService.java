...
public interface IAmzAdvCampKeywordsNegativaService extends IService<AmzAdvCampKeywordsNegativa> {
    ...
    public List<AmzAdvCampKeywordsNegativa> amzCreateCampaignNegativeKeywords(UserInfo user, BigInteger profileId,
            List<AmzAdvCampKeywordsNegativa> campKeywordsNegativa);
    ...
    public List<AmzAdvCampKeywordsNegativa> amzListCampaignNegativeKeywords(UserInfo user, BigInteger bigInteger,
            JSONObject param);
}
