...
public class AmzAdvProductTargeSDServiceImpl extends BaseService<AmzAdvProductTargeSD> implements
        IAmzAdvProductTargeSDService {
    ...
    public List<AmzAdvProductTargeSD> amzListTargetingClausesEx(UserInfo user, BigInteger profileId,
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < a.size(); i++) {
                ...
                AmzAdvProductTargeSD oldamzAdvProductads = amzAdvProductTargeSDMapper.selectByPrimaryKey(
                        amzAdvProductTarge);
    ...
    public List<AmzAdvProductTargeSD> amzCreateTargetingClauses(UserInfo user, BigInteger profileId,
    ...
    public List<AmzAdvProductTargeSD> amzUpdateTargetingClauses(UserInfo user, BigInteger profileId,
            List<AmzAdvProductTargeSD> productTargeList) {
        if (productTargeList == null || productTargeList.size() <= 0) {
            return null;
        }
    ...
    public AmzAdvProductTargeSD amzArchiveTargetingClause(UserInfo user, BigInteger profileId, String targetId) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            if ("SUCCESS".equals(a.getString("code"))) {
                ...
                amzAdvOperateLogService.saveOperateLog("AmzAdvProductTargeSD", user.getId(), profileId, productTarge,
                        oldproductTarge);
                return productTarge;
            } else {
                String errormsg = "";
    ...
    public List<AmzAdvProductTargeSD> amzUpdateTargets(UserInfo user, String profileid, JSONArray keywords) {
        // TODO Auto-generated method stub
        return this.amzUpdateTargetingClauses(user, new BigInteger(profileid),
    ...
    public List<AmzAdvProductTargeSD> amzCreateTargets(UserInfo user, String profileid, JSONArray keywords) {
        // TODO Auto-generated method stub
        return this.amzCreateTargetingClauses(user, new BigInteger(profileid),
                this.convertJsonToBean(user, profileid, keywords));
    }
