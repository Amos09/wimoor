...
public class AdvertProductAdsManagetController {
    ...
    public Result<Object> getloadProductAdsAction(@PathVariable String profileid, @PathVariable String campaignType,
            String adgroupid) {
        ...
        if (campaignType != null && "sd".equals(campaignType.toLowerCase())) {
            List<AmzAdvProductadsSD> list = amzAdvProductAdsSDService.getProductadByAdgroupId(user,
                    new BigInteger(profileid), adgroupid);
            result = list;
        } else {
            List<AmzAdvProductads> list = amzAdvProductAdsService.getProductadByAdgroupId(user,
                    new BigInteger(profileid), adgroupid);
            result = list;
        }
    ...
    public Result<PageList<Map<String, Object>>> getProductAdListAction(
    ...
    public Result<String> createProductAdListAction(@PathVariable String profileid, @PathVariable String campaignType,
    ...
    public Result<String> updateProductAdListAction(@PathVariable String profileid, @PathVariable String campaignType,
    ...
    public Result<List<Map<String, Object>>> getProductAdotherAsinAction(String campaignid, String adGroupid,
            String profileid,
    ...
    public Result<?> deleteProductAdsListAction(@PathVariable String profileid, @PathVariable String campaignType,
        ...
        List<AmzAdvProductads> list = amzAdvProductAdsService.amzDeleteProductAds(user, new BigInteger(profileid),
                param);
        if (list != null) {
            result.addAll(list);
        }
    ...
    public Result<?> getProductAdsListAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        if (campaignType.toLowerCase().equals("sp")) {
            ...
            param.put("adIdFilter", campaignIdFilter);
            param.put("includeExtendedDataFields", false);
            List<AmzAdvProductads> list = amzAdvProductAdsService.amzListProductAds(user, new BigInteger(profileid),
                    param);
            if (list != null) {
                result.addAll(list);
            }
            ...
            for (String item : idlist) {
                AmzAdvProductadsSD ads = amzAdvProductAdsSDService.amzListProductAds(user, new BigInteger(profileid),
                        item);
                if (ads != null) {
                    result.add(ads);
                }
    ...
    public Result<?> getProductAdsExtListAction(@PathVariable String profileid, @PathVariable String campaignType,
            @RequestBody List<String> idlist) {
        UserInfo user = UserInfoContext.get();
        if (idlist == null) {
            return Result.success(null);
