...
public class AmzAdvProductAdsServiceImpl extends BaseService<AmzAdvProductads> implements IAmzAdvProductAdsService {
    ...
    public List<AmzAdvProductads> amzCreateProductAds(UserInfo user, BigInteger profileId,
            List<AmzAdvProductads> productAdsList) {
    ...
    public List<AmzAdvProductads> amzUpdateProductAds(UserInfo user, BigInteger profileId,
            List<AmzAdvProductads> productAdsList) {
        if (productAdsList == null || productAdsList.size() <= 0) {
            return null;
        }
    ...
    public List<AmzAdvProductads> amzUpdateProductAds(UserInfo user, String profileId, JSONArray productst) {
        // TODO Auto-generated method stub
        return this.amzUpdateProductAds(user, new BigInteger(profileId),
                this.convertJsonToBean(user, profileId, productst));
    }

    @Override
    public List<AmzAdvProductads> amzCreateProductAds(UserInfo user, String profileid, JSONArray productAdArray) {
        // TODO Auto-generated method stub
        return this.amzCreateProductAds(user, new BigInteger(profileid),
