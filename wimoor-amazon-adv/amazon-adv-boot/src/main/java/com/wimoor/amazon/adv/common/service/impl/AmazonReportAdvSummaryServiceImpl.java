    ...
    public void refreshSummary(String shopid) {
        ...
        for (AmzAdvAuth item : advauthlist) {
            ...
            for (AmzAdvProfile profile : listprofile) {
                confirmSDByDay(profile.getSellerid(), profile.getMarketplaceid(), c.getTime(), new Date(),
                        profile.getId().toString());
                confirmSPByDay(profile.getSellerid(), profile.getMarketplaceid(), c.getTime(), new Date(),
                        profile.getId().toString());
