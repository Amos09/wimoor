...
public class AmzAdvProductTargeNegativaHsaServiceImpl extends BaseService<AmzAdvProductTargeNegativaHsa> implements
        IAmzAdvProductTargeNegativaHsaService {
    ...
    public AmzAdvProductTargeNegativaHsa amzArchiveNegativeTargetingClause(UserInfo user, BigInteger profileId,
            String targetId) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            if ("SUCCESS".equals(a.getString("code"))) {
                ...
                amzAdvOperateLogService.saveOperateLog("AmzAdvProductTargeNegativa", user.getId(), profileId,
    ...
    public List<AmzAdvProductTargeNegativaHsa> amzCreateNegativeTargetingClauses(UserInfo user, BigInteger profileId,
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            amzAdvOperateLogService.saveBatchOperateLog("AmzAdvProductTargeNegativaSB", user.getId(), profileId, map,
                    null);
    ...
    public List<AmzAdvProductTargeNegativaHsa> amzUpdateNegativeTargetingClauses(UserInfo user, BigInteger profileId,
        ...
        for (int i = 0; i < productTargeNegativaList.size(); i++) {
            ...
            AmzAdvProductTargeNegativaHsa productTargeNegativa = amzAdvProductTargeNegativaHsaMapper.selectOneByExample(
                    example);
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < oldProductTargeNegativaList.size(); i++) {
                ...
                BigInteger key = oldproductTargeNegativa.getCampaignid()
                        .subtract(oldproductTargeNegativa.getAdgroupid());
            ...
            amzAdvOperateLogService.saveBatchOperateLog("AmzAdvProductTargeNegativa", user.getId(), profileId, map,
                    oldmap);
    ...
    public AmzAdvProductTargeNegativaHsa amzNegativeTargetingClauses(UserInfo user, BigInteger profileId, String id) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            amzAdvProductTarge.setOpttime(new Date());
            AmzAdvProductTargeNegativaHsa oldamzAdvProductads = amzAdvProductTargeNegativaHsaMapper.selectByPrimaryKey(
                    amzAdvProductTarge);
    ...
    public List<AmzAdvProductTargeNegativaHsa> convertJsonToBean(UserInfo user, String profileId,
