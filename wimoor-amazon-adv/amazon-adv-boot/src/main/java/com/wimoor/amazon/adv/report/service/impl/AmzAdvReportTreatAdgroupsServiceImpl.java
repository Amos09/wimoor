...
public class AmzAdvReportTreatAdgroupsServiceImpl extends AmzAdvReportTreatServiceImpl implements
    ...
    public synchronized void treatReport(AmzAdvProfile profile, AmzAdvRequest request, JSONReader jsonReader) {
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                amzAdvReportAdgroupsAttributedSame.setAttributedsales1dsamesku(
                        item.getBigDecimal("attributedSalesSameSku1d"));
                amzAdvReportAdgroupsAttributedSame.setAttributedsales7dsamesku(
                        item.getBigDecimal("attributedSalesSameSku7d"));
                amzAdvReportAdgroupsAttributedSame.setAttributedsales14dsamesku(
                        item.getBigDecimal("attributedSalesSameSku14d"));
                amzAdvReportAdgroupsAttributedSame.setAttributedsales30dsamesku(
                        item.getBigDecimal("attributedSalesSameSku30d"));

                amzAdvReportAdgroupsAttributedSame.setAttributedconversions1dsamesku(
                        item.getInteger("purchasesSameSku1d"));
                amzAdvReportAdgroupsAttributedSame.setAttributedconversions7dsamesku(
                        item.getInteger("purchasesSameSku7d"));
                amzAdvReportAdgroupsAttributedSame.setAttributedconversions14dsamesku(
                        item.getInteger("purchasesSameSku14d"));
                amzAdvReportAdgroupsAttributedSame.setAttributedconversions30dsamesku(
                        item.getInteger("purchasesSameSku30d"));

                amzAdvReportAdgroupsAttributedSame.setAttributedUnitsOrdered1dSameSKU(
                        item.getInteger("unitsSoldSameSku1d"));
                amzAdvReportAdgroupsAttributedSame.setAttributedUnitsOrdered7dSameSKU(
                        item.getInteger("unitsSoldSameSku7d"));
                amzAdvReportAdgroupsAttributedSame.setAttributedUnitsOrdered14dSameSKU(
                        item.getInteger("unitsSoldSameSku14d"));
                amzAdvReportAdgroupsAttributedSame.setAttributedUnitsOrdered30dSameSKU(
                ...
                if ((amzAdvReportGroup.getClicks() == null || amzAdvReportGroup.getClicks() == 0)
                        ...
                        && (amzAdvReportGroup.getCost() == null
                        || amzAdvReportGroup.getCost().compareTo(new BigDecimal("0")) == 0)
                ) {
                    continue;
                }
