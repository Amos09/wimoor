...
public class AmzAdvKeywordsNegativaServiceImpl extends BaseService<AmzAdvKeywordsNegativa> implements
        IAmzAdvKeywordsNegativaService {
    ...
    public List<AmzAdvKeywordsNegativa> amzCreateNegativaKeywords(UserInfo user, BigInteger profileId,
            List<AmzAdvKeywordsNegativa> negetivaKeywordList) {
        // TODO Auto-generated method stub
    ...
    public List<AmzAdvKeywordsNegativa> amzDeleteNegativaKeywords(UserInfo user, BigInteger profileId,
            JSONObject param) {
        // TODO Auto-generated method stub
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < success.size(); i++) {
                ...
                amzAdvKeywordsNegativa.setOpttime(new Date());
                AmzAdvKeywordsNegativa oldamzAdvKeywordsNegativa = amzAdvKeywordsNegativaMapper.selectByPrimaryKey(
    ...
    public List<AmzAdvKeywordsNegativa> amzUpdateNegativaKeywords(UserInfo user, BigInteger profileId,
            List<AmzAdvKeywordsNegativa> negetivaKeywordList) {
        // TODO Auto-generated method stub
        if (negetivaKeywordList == null || negetivaKeywordList.size() <= 0) {
            return null;
    ...
    public List<AmzAdvKeywordsNegativa> convertJsonToBean(UserInfo user, BigInteger profileId,
    ...
    @Override
    public List<AmzAdvKeywordsNegativa> amzUpdateNegativaKeywords(UserInfo user, String profileid,
            JSONArray nkeywordArray) {
        // TODO Auto-generated method stub
        return this.amzUpdateNegativaKeywords(user, new BigInteger(profileid),
                this.convertJsonToBean(user, new BigInteger(profileid), nkeywordArray));
    }
