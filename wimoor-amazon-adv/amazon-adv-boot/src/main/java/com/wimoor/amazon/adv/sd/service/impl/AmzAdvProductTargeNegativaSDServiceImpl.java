...
public class AmzAdvProductTargeNegativaSDServiceImpl extends BaseService<AmzAdvProductTargeNegativaSD> implements
        IAmzAdvProductTargeNegativaSDService {
    ...
    public List<AmzAdvProductTargeNegativaSD> amzListNegativeTargetingClauses(UserInfo user, BigInteger profileId,
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < a.size(); i++) {
                ...
                AmzAdvProductTargeNegativaSD oldamzAdvProductads = amzAdvProductTargeNegativaSDMapper.selectByPrimaryKey(
    ...
    public List<AmzAdvProductTargeNegativaSD> amzListNegativeTargetingClausesEx(UserInfo user, BigInteger profileId,
            Map<String, Object> param) {
        // TODO Auto-generated method stub
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(profileId);
    ...
    public List<AmzAdvProductTargeNegativaSD> amzCreateNegativeTargetingClauses(UserInfo user, BigInteger profileId,
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            if (results != null && results.size() > 0) {
                ...
                if (item.getString("code") != null && !"SUCCESS".equals(item.getString("code"))) {
                    ...
                    BaseException exception = new BaseException(
                            "否定商品投放创建失败：【" + item.getString("code") + "】" + errormsg);
            ...
            amzAdvOperateLogService.saveBatchOperateLog("AmzAdvProductTargeNegativaSD", user.getId(), profileId, map,
                    null);
    ...
    public List<AmzAdvProductTargeNegativaSD> amzUpdateNegativeTargetingClauses(UserInfo user, BigInteger profileId,
        ...
        for (int i = 0; i < productTargeNegativaList.size(); i++) {
            ...
            AmzAdvProductTargeNegativaSD productTargeNegativa = amzAdvProductTargeNegativaSDMapper.selectOneByExample(
                    example);
    ...
    public AmzAdvProductTargeNegativaSD amzArchiveNegativeTargetingClause(UserInfo user, BigInteger profileId,
            String targetId) {
        // TODO Auto-generated method stub
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(profileId);
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            if ("SUCCESS".equals(a.getString("code"))) {
                ...
                amzAdvOperateLogService.saveOperateLog("AmzAdvProductTargeNegativaSD", user.getId(), profileId,
    ...
    @Override
    public AmzAdvProductTargeNegativaSD amzNegativeTargetingClauses(UserInfo user, BigInteger profileid,
            String targetId) {
        // TODO Auto-generated method stub
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(profileid);
    ...
    public List<AmzAdvProductTargeNegativaSD> convertJsonToBean(UserInfo user, String profileId,
    ...
    public List<AmzAdvProductTargeNegativaSD> amzUpdateNegativeTargetingClauses(UserInfo user, String profileid,
        ...
        return this.amzUpdateNegativeTargetingClauses(user, new BigInteger(profileid),
                this.convertJsonToBean(user, profileid, keywords));
    }
