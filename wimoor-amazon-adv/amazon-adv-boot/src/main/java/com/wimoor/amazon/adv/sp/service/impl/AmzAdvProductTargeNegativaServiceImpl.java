...
public class AmzAdvProductTargeNegativaServiceImpl extends BaseService<AmzAdvProductTargeNegativa> implements
        IAmzAdvProductTargeNegativaService {
    ...
    public AmzAdvProductTargeNegativa amzGetNegativeTargetingClause(UserInfo user, BigInteger profileId,
            String targetId) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            AmzAdvProductTargeNegativa oldamzAdvProductads = amzAdvProductTargeNegativaMapper.selectByPrimaryKey(
    ...
    public AmzAdvProductTargeNegativa amzGetNegativeTargetingClauseEx(UserInfo user, BigInteger profileId,
            String targetId) {
        // TODO Auto-generated method stub
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(profileId);
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            amzAdvProductTargeNegativa.setProfileid(profileId);
            amzAdvProductTargeNegativa.setOpttime(new Date());
            AmzAdvProductTargeNegativa oldAmzAdvProductTargeNegativa = amzAdvProductTargeNegativaMapper.selectByPrimaryKey(
                    amzAdvProductTargeNegativa);
    ...
    public List<AmzAdvProductTargeNegativa> amzCreateNegativeTargetingClauses(UserInfo user, BigInteger profileId,
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < success.size(); i++) {
                ...
                AmzAdvProductTargeNegativa dbAdvProductTargeNegativa = amzAdvProductTargeNegativaMapper.selectOneByExample(
                        example);
    ...
    public List<AmzAdvProductTargeNegativa> amzUpdateNegativeTargetingClauses(UserInfo user, BigInteger profileId,
        ...
        for (int i = 0; i < productTargeNegativaList.size(); i++) {
            ...
            AmzAdvProductTargeNegativa productTargeNegativa = amzAdvProductTargeNegativaMapper.selectOneByExample(
                    example);
    ...
    public List<AmzAdvProductTargeNegativa> amzArchiveNegativeTargetingClause(UserInfo user, BigInteger profileId,
            JSONObject param) {
        // TODO Auto-generated method stub
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(profileId);
    ...
    public List<AmzAdvProductTargeNegativa> amzListNegativeTargetingClauses(UserInfo user, BigInteger profileId,
            JSONObject param) {
        // TODO Auto-generated method stub
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(profileId);
    ...
    public List<AmzAdvProductTargeNegativa> convertJsonToBean(UserInfo user, BigInteger profileId,
