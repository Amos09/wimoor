...
public class AmzAdvReportTreatProductTargetSDServiceImpl extends AmzAdvReportTreatServiceImpl implements
    ...
    public synchronized void treatReport(AmzAdvProfile profile, AmzAdvRequest request, JSONReader jsonReader) {
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                amzAdvReportProductTargetsSDAttributed.setAttributedunitsordered1d(
                        item.getInteger("attributedUnitsOrdered1d"));
                amzAdvReportProductTargetsSDAttributed.setAttributedunitsordered7d(
                        item.getInteger("attributedUnitsOrdered7d"));
                amzAdvReportProductTargetsSDAttributed.setAttributedunitsordered14d(
                        item.getInteger("attributedUnitsOrdered14d"));
                amzAdvReportProductTargetsSDAttributed.setAttributedunitsordered30d(
                        item.getInteger("attributedUnitsOrdered30d"));

                amzAdvReportProductTargetsSDAttributed.setAttributedconversions1d(
                        item.getInteger("attributedConversions1d"));
                amzAdvReportProductTargetsSDAttributed.setAttributedconversions7d(
                        item.getInteger("attributedConversions7d"));
                amzAdvReportProductTargetsSDAttributed.setAttributedconversions14d(
                        item.getInteger("attributedConversions14d"));
                amzAdvReportProductTargetsSDAttributed.setAttributedconversions30d(
                        item.getInteger("attributedConversions30d"));
                ...
                amzAdvReportProductTargetsSDAttributedSame.setAttributedsales1dsamesku(
                        item.getBigDecimal("attributedSales1dSameSKU"));
                amzAdvReportProductTargetsSDAttributedSame.setAttributedsales7dsamesku(
                        item.getBigDecimal("attributedSales7dSameSKU"));
                amzAdvReportProductTargetsSDAttributedSame.setAttributedsales14dsamesku(
                        item.getBigDecimal("attributedSales14dSameSKU"));
                amzAdvReportProductTargetsSDAttributedSame.setAttributedsales30dsamesku(
                        item.getBigDecimal("attributedSales30dSameSKU"));

                amzAdvReportProductTargetsSDAttributedSame.setAttributedconversions1dsamesku(
                        item.getInteger("attributedConversions1dSameSKU"));
                amzAdvReportProductTargetsSDAttributedSame.setAttributedconversions7dsamesku(
                        item.getInteger("attributedConversions7dSameSKU"));
                amzAdvReportProductTargetsSDAttributedSame.setAttributedconversions14dsamesku(
                        item.getInteger("attributedConversions14dSameSKU"));
                amzAdvReportProductTargetsSDAttributedSame.setAttributedconversions30dsamesku(
                        item.getInteger("attributedConversions30dSameSKU"));
                ...
                amzAdvReportProductTargetsSDAttributedNew.setAttributedUnitsOrderedNewToBrand14d(
                        item.getInteger("attributedUnitsOrderedNewToBrand14d"));
                amzAdvReportProductTargetsSDAttributedNew.setAttributedOrdersNewToBrand14d(
                        item.getInteger("attributedOrdersNewToBrand14d"));
                amzAdvReportProductTargetsSDAttributedNew.setAttributedSalesNewToBrand14d(
                        item.getBigDecimal("attributedSalesNewToBrand14d"));
                ...
                amzAdvReportProductTargetsSDAttributedView.setViewAttributedConversions14d(
                        item.getInteger("viewAttributedConversions14d"));
                amzAdvReportProductTargetsSDAttributedView.setViewAttributedSales14d(
                        item.getBigDecimal("viewAttributedSales14d"));
                amzAdvReportProductTargetsSDAttributedView.setViewAttributedUnitsOrdered14d(
                        item.getInteger("viewAttributedUnitsOrdered14d"));
                ...
                if ((amzAdvReportProductTarge.getImpressions() == null
                        || amzAdvReportProductTarge.getImpressions() == 0)) {
                    continue;
                }
