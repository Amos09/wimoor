...
public class AmzAdvReportCampaignsPlaceHsaVideo {
    ...
    public boolean iszero() {
        if (viewableImpressions != null && viewableImpressions != 0) {
            return false;
        }
        if (videoFirstQuartileViews != null && videoFirstQuartileViews != 0) {
            return false;
        }
        if (videoMidpointViews != null && videoMidpointViews != 0) {
            return false;
        }
        if (videoThirdQuartileViews != null && videoThirdQuartileViews != 0) {
            return false;
        }
        if (videoCompleteViews != null && videoCompleteViews != 0) {
            return false;
        }
        if (video5SecondViews != null && video5SecondViews != 0) {
            return false;
        }
        if (videoUnmutes != null && videoUnmutes != 0) {
            return false;
        }
        if (video5SecondViewRate != null && video5SecondViewRate.floatValue() > 0.001) {
            return false;
        }
        if (vtr != null && vtr.floatValue() > 0.001) {
            return false;
        }
        if (vctr != null && vctr.floatValue() > 0.001) {
            return false;
        }
        return true;
    }
