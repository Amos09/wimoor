...
public class AmzAdvProductAdsSDServiceImpl extends BaseService<AmzAdvProductadsSD> implements
        IAmzAdvProductAdsSDService {
    ...
    public List<AmzAdvProductadsSD> amzCreateProductAds(UserInfo user, BigInteger profileId,
    ...
    public List<AmzAdvProductadsSD> amzUpdateProductAds(UserInfo user, BigInteger profileId,
            List<AmzAdvProductadsSD> productAdsList) {
        if (productAdsList == null || productAdsList.size() <= 0) {
            return null;
        }
    ...
    public AmzAdvProductadsSD amzArchiveProductAd(UserInfo user, BigInteger profileId, String adId) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            if ("SUCCESS".equals(a.getString("code"))) {
                ...
                amzAdvOperateLogService.saveOperateLog("AmzAdvProductadsSD", user.getId(), profileId, amzAdvProductads,
                        oldamzAdvProductads);
    ...
    public List<AmzAdvProductadsSD> amzUpdateProductAds(UserInfo user, String profileid, JSONArray productAdArray) {
        // TODO Auto-generated method stub
        return amzUpdateProductAds(user, new BigInteger(profileid),
                this.convertJsonToBean(user, profileid, productAdArray));
    }

    @Override
    public List<AmzAdvProductadsSD> amzCreateProductAds(UserInfo user, String profileid, JSONArray productAdArray) {
        // TODO Auto-generated method stub
        return amzCreateProductAds(user, new BigInteger(profileid),
                this.convertJsonToBean(user, profileid, productAdArray));
    }
