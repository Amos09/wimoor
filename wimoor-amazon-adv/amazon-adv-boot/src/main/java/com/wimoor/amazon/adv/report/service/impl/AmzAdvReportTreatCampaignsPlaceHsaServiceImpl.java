...
public class AmzAdvReportTreatCampaignsPlaceHsaServiceImpl extends AmzAdvReportTreatServiceImpl implements
    ...
    public synchronized void treatReport(AmzAdvProfile profile, AmzAdvRequest request, JSONReader jsonReader) {
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                amzAdvReportCampaignsPlaceHsaAttributed.setAttributedsales14dsamesku(
                        item.getBigDecimal("attributedSales14dSameSKU"));
                amzAdvReportCampaignsPlaceHsaAttributed.setAttributedconversions14d(
                        item.getInteger("attributedConversions14d"));
                amzAdvReportCampaignsPlaceHsaAttributed.setAttributedconversions14dsamesku(
                ...
                if (request.getCreativeType() != null && "video".equals(request.getCreativeType())) {
                    ...
                    amzAdvReportCampaignsPlaceHsaVideo.setVideoFirstQuartileViews(
                    ...
                    amzAdvReportCampaignsPlaceHsaVideo.setVideoThirdQuartileViews(
                    ...
                    amzAdvReportCampaignsPlaceHsaVideo.setVideo5SecondViewRate(
                    ...
                    amzAdvReportCampaignsPlaceHsaBrand.setAttributedDetailPageViewsClicks14d(
                            item.getInteger("attributedDetailPageViewsClicks14d"));
                    amzAdvReportCampaignsPlaceHsaBrand.setAttributedOrdersNewToBrand14d(
                            item.getInteger("attributedOrdersNewToBrand14d"));
                    amzAdvReportCampaignsPlaceHsaBrand.setAttributedOrdersNewToBrandPercentage14d(
                            item.getBigDecimal("attributedOrdersNewToBrandPercentage14d"));
                    amzAdvReportCampaignsPlaceHsaBrand.setAttributedOrderRateNewToBrand14d(
                            item.getInteger("attributedOrderRateNewToBrand14d"));
                    amzAdvReportCampaignsPlaceHsaBrand.setAttributedSalesNewToBrand14d(
                            item.getInteger("attributedSalesNewToBrand14d"));
                    amzAdvReportCampaignsPlaceHsaBrand.setAttributedSalesNewToBrandPercentage14d(
                            item.getBigDecimal("attributedSalesNewToBrandPercentage14d"));
                    amzAdvReportCampaignsPlaceHsaBrand.setAttributedUnitsOrderedNewToBrand14d(
                            item.getInteger("attributedUnitsOrderedNewToBrand14d"));
                    amzAdvReportCampaignsPlaceHsaBrand.setAttributedUnitsOrderedNewToBrandPercentage14d(
