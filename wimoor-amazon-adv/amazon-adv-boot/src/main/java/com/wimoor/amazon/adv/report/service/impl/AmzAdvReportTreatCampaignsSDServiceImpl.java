...
public class AmzAdvReportTreatCampaignsSDServiceImpl extends AmzAdvReportTreatServiceImpl implements
    ...
    public synchronized void treatReport(AmzAdvProfile profile, AmzAdvRequest request, JSONReader jsonReader) {
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                amzAdvReportCampaignsSDAttributed.setAttributedunitsordered1d(
                        item.getInteger("attributedUnitsOrdered1d"));
                amzAdvReportCampaignsSDAttributed.setAttributedunitsordered7d(
                        item.getInteger("attributedUnitsOrdered7d"));
                amzAdvReportCampaignsSDAttributed.setAttributedunitsordered14d(
                        item.getInteger("attributedUnitsOrdered14d"));
                amzAdvReportCampaignsSDAttributed.setAttributedunitsordered30d(
                        item.getInteger("attributedUnitsOrdered30d"));

                amzAdvReportCampaignsSDAttributed.setAttributedconversions1d(
                        item.getInteger("attributedConversions1d"));
                amzAdvReportCampaignsSDAttributed.setAttributedconversions7d(
                        item.getInteger("attributedConversions7d"));
                amzAdvReportCampaignsSDAttributed.setAttributedconversions14d(
                        item.getInteger("attributedConversions14d"));
                amzAdvReportCampaignsSDAttributed.setAttributedconversions30d(
                ...
                amzAdvReportCampaignsSDAttributedSame.setAttributedsales1dsamesku(
                        item.getBigDecimal("attributedSales1dSameSKU"));
                amzAdvReportCampaignsSDAttributedSame.setAttributedsales7dsamesku(
                        item.getBigDecimal("attributedSales7dSameSKU"));
                amzAdvReportCampaignsSDAttributedSame.setAttributedsales14dsamesku(
                        item.getBigDecimal("attributedSales14dSameSKU"));
                amzAdvReportCampaignsSDAttributedSame.setAttributedsales30dsamesku(
                        item.getBigDecimal("attributedSales30dSameSKU"));

                amzAdvReportCampaignsSDAttributedSame.setAttributedconversions1dsamesku(
                        item.getInteger("attributedConversions1dSameSKU"));
                amzAdvReportCampaignsSDAttributedSame.setAttributedconversions7dsamesku(
                        item.getInteger("attributedConversions7dSameSKU"));
                amzAdvReportCampaignsSDAttributedSame.setAttributedconversions14dsamesku(
                        item.getInteger("attributedConversions14dSameSKU"));
                amzAdvReportCampaignsSDAttributedSame.setAttributedconversions30dsamesku(
                ...
                amzAdvReportCampaignsSDAttributedNew.setAttributedUnitsOrderedNewToBrand14d(
                        item.getInteger("attributedUnitsOrderedNewToBrand14d"));
                amzAdvReportCampaignsSDAttributedNew.setAttributedOrdersNewToBrand14d(
                        item.getInteger("attributedOrdersNewToBrand14d"));
                amzAdvReportCampaignsSDAttributedNew.setAttributedSalesNewToBrand14d(
                ...
                amzAdvReportCampaignsSDAttributedView.setViewAttributedConversions14d(
                        item.getInteger("viewAttributedConversions14d"));
                amzAdvReportCampaignsSDAttributedView.setViewAttributedSales14d(
                        item.getBigDecimal("viewAttributedSales14d"));
                amzAdvReportCampaignsSDAttributedView.setViewAttributedUnitsOrdered14d(
                ...
                if ((amzAdvReportCampaignsSD.getClicks() == null || amzAdvReportCampaignsSD.getClicks() == 0)
                        && (amzAdvReportCampaignsSD.getImpressions() == null
                        || amzAdvReportCampaignsSD.getImpressions() == 0)
                        && (amzAdvReportCampaignsSD.getCost() == null
                        || amzAdvReportCampaignsSD.getCost().compareTo(new BigDecimal("0")) == 0)
                ) {
                    continue;
                }
