...
public class AmzAdvCampKeywordsNegativaServiceImpl extends BaseService<AmzAdvCampKeywordsNegativa> implements
        IAmzAdvCampKeywordsNegativaService {
    ...
    public List<AmzAdvCampKeywordsNegativa> amzDeleteCampaignNegativaKeywords(UserInfo user, BigInteger profileId,
            JSONObject param) {
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < success.size(); i++) {
                ...
                AmzAdvCampKeywordsNegativa oldamzAdvKeywordsNegativa = amzAdvCampKeywordsNegativaMapper.selectByPrimaryKey(
    ...
    public List<AmzAdvCampKeywordsNegativa> getCampKeywordsNegativaByCampaignsId(BigInteger profileId,
            String campaignsId) {
    ...
    public List<AmzAdvCampKeywordsNegativa> amzCreateCampaignNegativeKeywords(UserInfo user, BigInteger profileId,
        ...
        String response = apiBuildService.amzAdvPost(profile, url, campaignNegativeTargetingClauses.toString(),
                this.getHeaderExt());
        if (StringUtil.isNotEmpty(response)) {
            String errormsg = "";
            JSONObject json = GeneralUtil.getJsonObject(response.toString());
    ...
    public List<AmzAdvCampKeywordsNegativa> amzUpdateCampaignNegativeKeywords(UserInfo user, BigInteger profileId,
        ...
        for (int i = 0; i < campKeywordsNegativaList.size(); i++) {
            ...
            AmzAdvCampKeywordsNegativa oldamzAdvCampKeywordsNegativa = amzAdvCampKeywordsNegativaMapper.selectOneByExample(
                    example);
    ...
    public List<AmzAdvCampKeywordsNegativa> convertJsonToBean(UserInfo user, BigInteger profileId,
    ...
    public List<AmzAdvCampKeywordsNegativa> amzUpdateCampaignNegativeKeywords(UserInfo user, String profileid,
        ...
        // TODO Auto-generated method stub
        return this.amzUpdateCampaignNegativeKeywords(user, new BigInteger(profileid),
                this.convertJsonToBean(user, new BigInteger(profileid), keywordArray));
    }

    @Override
    public List<AmzAdvCampKeywordsNegativa> amzCreateCampaignNegativeKeywords(UserInfo user, String profileid,
            JSONArray nkeywords) {
        // TODO Auto-generated method stub
        return this.amzCreateCampaignNegativeKeywords(user, new BigInteger(profileid),
