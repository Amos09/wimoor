...
public class AmzAdvCampProductTargeNegativaServiceImpl extends BaseService<AmzAdvCampProductTargeNegativa> implements
        IAmzAdvCampProductTargeNegativaService {
    ...
    public List<AmzAdvCampProductTargeNegativa> amzCreateNegativeTargetingClauses(UserInfo user, BigInteger profileId,
            List<AmzAdvCampProductTargeNegativa> productTargeList) {
        ...
        String response = apiBuildService.amzAdvPost(profile, url, negativeTargetingClauses.toString(),
                this.getHeaderExt());
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < success.size(); i++) {
                ...
                AmzAdvCampProductTargeNegativa dbAdvProductTargeNegativa = amzAdvCampProductTargeNegativaMapper.selectOneByExample(
                        example);
    ...
    public List<AmzAdvCampProductTargeNegativa> amzUpdateNegativeTargetingClauses(UserInfo user, BigInteger profileId,
            List<AmzAdvCampProductTargeNegativa> productTargeNegativaList) {
        // TODO Auto-generated method stub
        ...
        for (int i = 0; i < productTargeNegativaList.size(); i++) {
            ...
            AmzAdvCampProductTargeNegativa productTargeNegativa = amzAdvCampProductTargeNegativaMapper.selectOneByExample(
                    example);
        ...
        String response = apiBuildService.amzAdvPut(profile, url, campaignNegativeTargetingClauses.toString(),
                this.getHeaderExt());
        if (StringUtil.isNotEmpty(response)) {
            String errormsg = "";
            JSONObject json = GeneralUtil.getJsonObject(response.toString());
    ...
    public AmzAdvCampProductTargeNegativa amzArchiveNegativeTargetingClause(UserInfo user, BigInteger profileId,
            String targetId) {
        // TODO Auto-generated method stub
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(profileId);
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            if ("SUCCESS".equals(a.getString("code"))) {
                ...
                amzAdvOperateLogService.saveOperateLog("AmzAdvCampProductTargeNegativa", user.getId(), profileId,
                        productTarge, oldproductTarge);
                return productTarge;
            } else {
                String errormsg = "";
    ...
    public List<AmzAdvCampProductTargeNegativa> amzListNegativeTargetingClauses(UserInfo user, BigInteger profileId,
            JSONObject param) {
        // TODO Auto-generated method stub
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(profileId);
        ...
        if (StringUtil.isNotEmpty(response)) {
            ...
            for (int i = 0; i < a.size(); i++) {
                ...
                AmzAdvCampProductTargeNegativa oldamzAdvProductads = amzAdvCampProductTargeNegativaMapper.selectByPrimaryKey(
                        amzAdvProductTargeNegativa);
    ...
    public List<AmzAdvCampProductTargeNegativa> convertJsonToBean(UserInfo user, BigInteger profileId,
            JSONArray nkeywordArray) {
    ...
    public List<AmzAdvCampProductTargeNegativa> amzCreateNegativeTargetingClauses(UserInfo user, String profileid,
            JSONArray nkeywords) {
        // TODO Auto-generated method stub
        return this.amzCreateNegativeTargetingClauses(user, new BigInteger(profileid),
                this.convertJsonToBean(user, new BigInteger(profileid), nkeywords));
    }
    ...
    public List<AmzAdvCampProductTargeNegativa> amzUpdateNegativeTargetingClauses(UserInfo user, String profileid,
            JSONArray nkeywords) {
        // TODO Auto-generated method stub
        return this.amzUpdateNegativeTargetingClauses(user, new BigInteger(profileid),
                this.convertJsonToBean(user, new BigInteger(profileid), nkeywords));
    }
