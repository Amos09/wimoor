...
public class AdvertBiddingRulesController {
    ...
    public Result<?> amzCreateBudgetRulesAction(@PathVariable String profileid, @PathVariable String CampaignType,
    ...
    public Result<?> amzGetBiddingRulesByCampaignAction(@PathVariable String profileid,
    ...
    public Result<?> amzCreateCampaignOptimiztionRulesAction(@PathVariable String profileid,
    ...
    public Result<?> amzUpdatesCampaignOptimiztionRulesAction(@PathVariable String profileid,
            @PathVariable String CampaignType, @RequestBody JSONObject param) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
    ...
    public Result<?> amzUpdatesCampaignOptimiztionRulesAction(@PathVariable String profileid,
            @PathVariable String CampaignType, String campaignOptimizationId) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
        return Result.success(
                amzAdvCampOptimizationRulesService.amzDeleteCampaignOptimiztionRules(profile, campaignOptimizationId));
    }

    @PostMapping("/amzGetCampaignEligibilityRules/{profileid}/{CampaignType}")
    public Result<?> amzGetCampaignEligibilityRulesAction(@PathVariable String profileid,
            @PathVariable String CampaignType, @RequestBody JSONObject param) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
    ...
    public Result<?> amzGetCampaignOptimiztionRulesAction(@PathVariable String profileid,
            @PathVariable String CampaignType, String campaignOptimizationId) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
        return Result.success(
                amzAdvCampOptimizationRulesService.amzGetCampaignOptimiztionRules(profile, campaignOptimizationId));
    }

    @PostMapping("/amzListCampaignOptimiztionRules/{profileid}/{CampaignType}")
    public Result<?> amzListCampaignOptimiztionRulesAction(@PathVariable String profileid,
            @PathVariable String CampaignType, JSONObject param) {
        AmzAdvProfile profile = amzAdvAuthService.getAmzAdvProfileByKey(new BigInteger(profileid));
