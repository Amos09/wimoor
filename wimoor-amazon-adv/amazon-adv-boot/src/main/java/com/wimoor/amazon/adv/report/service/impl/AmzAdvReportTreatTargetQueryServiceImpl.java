...
public class AmzAdvReportTreatTargetQueryServiceImpl extends AmzAdvReportTreatServiceImpl implements
    ...
    public synchronized void treatReport(AmzAdvProfile profile, AmzAdvRequest request, JSONReader jsonReader) {
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                BigInteger target = item.getBigInteger("targetId") == null ? item.getBigInteger("keywordId")
                        : item.getBigInteger("targetId");
                ...
                amzAdvReportTargetQueryAttributedSame.setAttributedsales1dsamesku(
                        item.getBigDecimal("attributedSalesSameSku1d"));
                amzAdvReportTargetQueryAttributedSame.setAttributedsales7dsamesku(
                        item.getBigDecimal("attributedSalesSameSku7d"));
                amzAdvReportTargetQueryAttributedSame.setAttributedsales14dsamesku(
                        item.getBigDecimal("attributedSalesSameSku14d"));
                amzAdvReportTargetQueryAttributedSame.setAttributedsales30dsamesku(
                        item.getBigDecimal("attributedSalesSameSku30d"));

                amzAdvReportTargetQueryAttributedSame.setAttributedconversions1dsamesku(
                        item.getInteger("purchasesSameSku1d"));
                amzAdvReportTargetQueryAttributedSame.setAttributedconversions7dsamesku(
                        item.getInteger("purchasesSameSku7d"));
                amzAdvReportTargetQueryAttributedSame.setAttributedconversions14dsamesku(
                        item.getInteger("purchasesSameSku14d"));
                amzAdvReportTargetQueryAttributedSame.setAttributedconversions30dsamesku(
                        item.getInteger("purchasesSameSku30d"));

                amzAdvReportTargetQueryAttributedSame.setAttributedUnitsOrdered1dSameSKU(
                        item.getInteger("unitsSoldSameSku1d"));
                amzAdvReportTargetQueryAttributedSame.setAttributedUnitsOrdered7dSameSKU(
                        item.getInteger("unitsSoldSameSku7d"));
                amzAdvReportTargetQueryAttributedSame.setAttributedUnitsOrdered14dSameSKU(
                        item.getInteger("unitsSoldSameSku14d"));
                amzAdvReportTargetQueryAttributedSame.setAttributedUnitsOrdered30dSameSKU(
                        item.getInteger("unitsSoldSameSku30d"));
                if ((amzAdvReportTargetQuery.getImpressions() == null
                        || amzAdvReportTargetQuery.getImpressions() == 0)) {
                    continue;
                }
