...
public class AmzAdvReportTreatCampaignsHsaServiceImpl extends AmzAdvReportTreatServiceImpl implements
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (request.getLog() != null && request.getLog().equals("hasName")) {
                    AmzAdvCampaignsHsa campaign = amzAdvCampaignsHsaMapper.selectByPrimaryKey(
                            amzAdvReportHasCampaign.getCampaignid());
                    if (campaign == null) {
                ...
                amzAdvReportCampaignsHsaAttributed.setAttributedsales14dsamesku(
                        item.getBigDecimal("attributedSales14dSameSKU"));
                amzAdvReportCampaignsHsaAttributed.setAttributedconversions14d(
                        item.getInteger("attributedConversions14d"));
                amzAdvReportCampaignsHsaAttributed.setAttributedconversions14dsamesku(
                ...
                if (request.getCreativeType() != null && "video".equals(request.getCreativeType())) {
                    ...
                    amzAdvReportHasCampaignBrand.setAttributedDetailPageViewsClicks14d(
                            item.getInteger("attributedDetailPageViewsClicks14d"));
                    amzAdvReportHasCampaignBrand.setAttributedOrdersNewToBrand14d(
                            item.getInteger("attributedOrdersNewToBrand14d"));
                    amzAdvReportHasCampaignBrand.setAttributedOrdersNewToBrandPercentage14d(
                            item.getBigDecimal("attributedOrdersNewToBrandPercentage14d"));
                    amzAdvReportHasCampaignBrand.setAttributedOrderRateNewToBrand14d(
                            item.getInteger("attributedOrderRateNewToBrand14d"));
                    amzAdvReportHasCampaignBrand.setAttributedSalesNewToBrand14d(
                            item.getBigDecimal("attributedSalesNewToBrand14d"));
                    amzAdvReportHasCampaignBrand.setAttributedSalesNewToBrandPercentage14d(
                            item.getBigDecimal("attributedSalesNewToBrandPercentage14d"));
                    amzAdvReportHasCampaignBrand.setAttributedUnitsOrderedNewToBrand14d(
                            item.getInteger("attributedUnitsOrderedNewToBrand14d"));
                    amzAdvReportHasCampaignBrand.setAttributedUnitsOrderedNewToBrandPercentage14d(
                ...
                if (request.getCreativeType() != null && "video".equals(request.getCreativeType())) {
                    addSummary(request, mapsum, date, "sv", amzAdvReportHasCampaign.getClicks(),
                            ...
                            amzAdvReportCampaignsHsaAttributed.getAttributedsales14d() != null
                                    ? amzAdvReportCampaignsHsaAttributed.getAttributedsales14d().intValue() : 0,
