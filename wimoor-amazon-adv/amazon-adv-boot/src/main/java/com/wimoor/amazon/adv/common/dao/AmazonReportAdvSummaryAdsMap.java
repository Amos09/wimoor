...
public class AmazonReportAdvSummaryAdsMap {
    ...
    public void addAdvReportSummary(AmzAdvProfile profile, AmzAdvReportProductAds padv,
            AmzAdvReportProductAdsAttributed padvattr, String asin, String sku, String currency) {
        double ctr = 0;
        double acos = 0;
    ...
    public void addAdvReportSummary(AmzAdvProfile profile, AmzAdvReportProductAdsSD padv,
            AmzAdvReportProductAdsSDAttributed padvattr, String sku, String asin, String currency) {
