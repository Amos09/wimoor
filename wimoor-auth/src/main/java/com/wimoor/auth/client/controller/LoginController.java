...
public class LoginController {
            ...
            if (subject.getPrincipal() != null) {
                ...
                if (Result.isSuccess(userresult)) {
                    ...
                    stringRedisTemplate.opsForValue()
                            .set(key, jsonuser, expiresIn, java.util.concurrent.TimeUnit.SECONDS);
                } else {
    ...
    public Result<UserInfo> loginAction(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (result.getData() != null) {
                ...
                int expiresIn = 3600;
                stringRedisTemplate.opsForValue()
                        .set(sessionkey, jsonuser, expiresIn, java.util.concurrent.TimeUnit.SECONDS);
                return result;
            } else {
                return result;
            }
    ...
    public Result<?> verifyWechatAppAction(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (Result.isSuccess(result)) {
            ...
            String jsonuser = JSONObject.toJSONString(user);
            stringRedisTemplate.opsForValue()
                    .set(jsessionid, jsonuser, expiresIn, java.util.concurrent.TimeUnit.SECONDS);
            user.setId(null);
    ...
    public Result<?> changeLoginWechatAppAction(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (appType.equals("website")) {
            ...
            cn.hutool.crypto.symmetric.AES aes = new cn.hutool.crypto.symmetric.AES(Mode.CBC, Padding.ISO10126Padding,
