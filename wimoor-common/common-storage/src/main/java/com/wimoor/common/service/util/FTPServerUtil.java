...
//	            flag = getDefaultFtpClient().makeDirectory(dir);
     ...
     * @param fileName 文件名称 * //* @param localpath 下载后的文件路径 *
     * @return
     */
    public boolean downloadFile(FTPClient ftpClient, String pathName, String fileName, OutputStream os)
            throws Exception {
        boolean flag;
        ...
        for (FTPFile file : files) {
            ...
            if (file.getName().equals(fileName)) {
                ...
                flag = ftpClient.storeFile(
                        newPath + File.separator + (new String(file.getName().getBytes("UTF-8"), "ISO-8859-1")), in);
                out.flush();
                out.close();
                in.close();
