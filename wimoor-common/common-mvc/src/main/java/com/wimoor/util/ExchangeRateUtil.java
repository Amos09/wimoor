...
public class ExchangeRateUtil {
    ...
    public static String getRate(String from, String to) {
        ...
        Result<?> result = null;
        try {
            result = restTemplate.getForObject("http://wimoor-amazon/amazon/api/v1/summary/getCurrency/" + to,
                    Result.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static BigDecimal changeCurrencyByLocal(String from, String to, BigDecimal money) {
        ...
        if (money.equals(new BigDecimal("0")) || (money.floatValue() < 0.0000000001
                && money.floatValue() > -0.0000000001)) {
