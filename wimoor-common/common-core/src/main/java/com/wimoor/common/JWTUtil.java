...
public class JWTUtil {
    ...
    public static void verifyToken(String token, String secretKey) throws TokenAuthenticationException {
        try {
            ...
            throw new TokenAuthenticationException(ResultCode.TOKEN_INVALID.getCode(),
                    ResultCode.TOKEN_INVALID.getMsg());
        } catch (SignatureVerificationException signatureVerificationException) {
            throw new TokenAuthenticationException(ResultCode.TOKEN_SIGNATURE_INVALID.getCode(),
                    ResultCode.TOKEN_SIGNATURE_INVALID.getMsg());
        } catch (TokenExpiredException tokenExpiredException) {
            throw new TokenAuthenticationException(ResultCode.TOKEN_EXPIRED.getCode(),
                    ResultCode.TOKEN_INVALID.getMsg());
        } catch (Exception ex) {
            throw new TokenAuthenticationException(ResultCode.UNKNOWN_ERROR.getCode(),
