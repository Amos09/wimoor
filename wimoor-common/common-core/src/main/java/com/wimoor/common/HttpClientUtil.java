...
public class HttpClientUtil {
            ...
            if (GeneralUtil.isNotEmpty(respContent)) {
                ...
                if (json != null) {
                    ...
                    if (xml != null) {
                        ...
                        errormsg =
                                messagelist != null && messagelist.getLength() > 0 ? messagelist.item(0).getNodeValue()
                                        : "";
                    }
                }
    ...
    public static String postUrl(String url, Map<String, Object> param, Map<String, String> header)
        ...
        try {
            ...
            if (param != null && param.size() > 0) {
                ...
                File file = GeneralUtil.getFileByBytes(GeneralUtil.decryptBASE64(base64ImgData), null,
                        param.get("name").toString(), "." + imageType);
    ...
    public static String postUrl(String url, String param, Map<String, String> header, String type)
            throws HttpException {
        HttpPost httpPost = null;
        CloseableHttpClient client = null;
        try {
    ...
    public static String postUrl(String url, Map<String, String> param, Map<String, String> header, String type)
            throws HttpException {
        HttpPost httpPost = null;
        CloseableHttpClient client = null;
        try {
    ...
    public static String putUrl(String url, Map<String, String> param, Map<String, String> header, String type)
            throws HttpException {
    ...
    public static String putUrl(String url, String param, Map<String, String> header, String type)
            throws HttpException {
        HttpPut httpPut = null;
        CloseableHttpClient client = null;
        try {
