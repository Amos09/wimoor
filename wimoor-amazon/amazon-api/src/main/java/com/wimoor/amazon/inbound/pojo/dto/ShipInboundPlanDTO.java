...
public class ShipInboundPlanDTO extends BizBaseEntity {
    ...
    public static Boolean NeedInv(ShipInboundShipmentDTO shipment) {
        if (shipment == null) {
            ...
            return shipment.getInboundplan() == null || shipment.getInboundplan().getInvtype() == null
                    || shipment.getInboundplan().getInvtype() == 0 || shipment.getInboundplan().getInvtype() == 1;
        }
    }
    ...
    public static Boolean NeedAmz(ShipInboundShipmentDTO shipment) {
        if (shipment == null) {
            ...
            return shipment.getInboundplan() == null || shipment.getInboundplan().getInvtype() == null
                    || shipment.getInboundplan().getInvtype() == 0 || shipment.getInboundplan().getInvtype() == 2;
        }
    }
}