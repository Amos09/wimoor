...
public class UKProfitServiceImpl extends ProfitServiceImpl {
    ...
    public String determineProductTier(String country, InputDimensions inputDimension, String isMedia)
        ...
        InputDimensions inputDimension_new = new InputDimensions(length_cm, width_cm, height_cm, getDimUnit(country),
                weight, getWeightUnit(country));
    ...
    public BigDecimal determineOutboundWeight(String country, ProductTier productTier, InputDimensions dimensions,
        ...
        OutboundWeightFormat outboundWeightFormat = outboundWeightFormatService.findByProductTierId(
                productTier.getId());
            ...
            if (warehousesite != null && warehousesite.equals(country.toLowerCase())) {
                ...
                if (warehousesite.equals("UK")) {
                    ...
                    if (country.equals("DE") || country.equals("IT") || country.equals("ES")) {
                        ...
                        if (country.equals("DE") || country.equals("FR") || country.equals("IT") || country.equals(
                                "ES")) {
    ...
    public BigDecimal calculateSmlFBA(String country, String productTierId, BigDecimal outboundWeight,
        ...
        FBAFormat fbaFormat = fbaFormatService.findByProductTierIdAndWeightSL(productTierId, outboundWeight, fenpeiType,
                country);
        if (fbaFormat != null) {
            String format = fbaFormat.getFbaFormat();
            FBA = new BigDecimal(format);
    ...
    public BigDecimal getFBAFormatWeight(String country, String productTierId, InputDimensions inputDimension,
        ...
        return fbaFormat.getWeight().multiply(new BigDecimal("1000")).subtract(weight.multiply(new BigDecimal("1000")))
                .setScale(0);
    }
