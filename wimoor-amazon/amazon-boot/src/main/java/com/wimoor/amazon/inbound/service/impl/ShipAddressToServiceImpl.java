...
public class ShipAddressToServiceImpl extends ServiceImpl<ShipAddressToMapper, ShipAddressTo> implements
        IShipAddressToService {
    ...
    public ShipAddressTo getToAddress(ShipInboundShipment ship) {
        ...
        if (ship.getShiptoaddressid() != null) {
            ...
            AmzShipFulfillmentCenter center = iAmzShipFulfillmentCenterService.getByCode(
                    ship.getDestinationfulfillmentcenterid());
            if (center != null) {
