...
//	Map<String, Object> selectProductOrdersTodaySummary(Map<String, Object> paramMap);
    ...
    List<Map<String, Object>> selectDataByDay(@Param("amazonAuthId") String amazonAuthId,
            @Param("startDate") String startDate, @Param("endDate") String endDate);

    int deleRptByAuth(@Param("amazonAuthId") String authid, @Param("startDate") String time,
            @Param("endDate") String time2);
    ...
    String getLastShippedOrder(@Param("authid") String authid, @Param("pointname") String pointName,
