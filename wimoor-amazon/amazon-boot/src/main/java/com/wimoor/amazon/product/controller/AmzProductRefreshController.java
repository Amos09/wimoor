...
public class AmzProductRefreshController {
    ...
    public Result<?> refreshItemBySKUAction(String groupid, String marketplaceid, String sku) {
        ...
        Item item = iProductListingsItemService.captureListMatchingProduct(auth, sku, Arrays.asList(marketplaceid),
                null, includedData);
    ...
    public Result<?> refreshCatalogBySKUAction(String groupid, String marketplaceid, String asin, String sku) {
        ...
        com.amazon.spapi.model.catalogitems.Item item = iProductCatalogItemService.captureCatalogProduct(auth,
                skuRefresh, Arrays.asList(marketplaceid));
