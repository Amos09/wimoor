 ...
 */
@Service
public class MerchantShippingGroupServiceImpl extends
        ServiceImpl<MerchantShippingGroupMapper, MerchantShippingGroup> implements IMerchantShippingGroupService {
    ...
    public List<MerchantShippingGroup> refreshListGroups(String amazonauthid, String marketplaceid) {
        ...
        ProductTypeDefinition response = iProductProductTypeService.captureTypeDefinition(authority, marketplaceid,
                "SANDAL");
        if (response != null && response.getSchema() != null) {
            ...
            JSONObject merchant_shipping_group =
                    properties == null ? null : properties.getJSONObject("merchant_shipping_group");
