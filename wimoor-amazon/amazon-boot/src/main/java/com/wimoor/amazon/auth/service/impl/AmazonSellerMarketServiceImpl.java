 ...
 */
@Service
public class AmazonSellerMarketServiceImpl extends ServiceImpl<AmazonSellerMarketMapper, AmazonSellerMarket> implements
        IAmazonSellerMarketService {
    ...
    public void runApi(AmazonAuthority amazonAuthority) {
        ...
        try {
            if (amazonAuthority.apiNotRateLimit()) {
                ApiCallback<GetMarketplaceParticipationsResponse> callback = new ApiCallbackGetMarketplaceParticipations(
    ...
    public List<AmazonSellerMarket> handler(AmazonAuthority amazonAuthority,
            GetMarketplaceParticipationsResponse response) {
        // TODO Auto-generated method stub
    ...
    private boolean campare(AmazonAuthority amazonAuthority, AmazonSellerMarket sellerMarket, Marketplace market) {
        ...
        if (sellerMarket.getAmazonauthid() == null || !sellerMarket.getAmazonauthid().toString()
                .equals(amazonAuthority.getId())) {
            if (StrUtil.isNotBlank(amazonAuthority.getId())) {
                sellerMarket.setAmazonauthid(new BigInteger(amazonAuthority.getId()));
                needupdate = true;
            }
