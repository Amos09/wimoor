...
public class ReportFBAUNOInventoryServiceImpl extends ReportServiceImpl {
    ...
    /**
     * SKU FNSKU ASIN Product Name Enrolled in SnL? Marketplace Your SnL Price Inventory in SnL FC (units) Inventory in
     * Non-SnL FC (units)
     */
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (lineNumber != 0 && length > 1) {
                    ...
                    if (marketplaceEntity != null) {
                        List<ProductInfo> record = productInfoMapper.selectBySku(sku,
                                marketplaceEntity.getMarketplaceid(), amazonAuthority.getId());
