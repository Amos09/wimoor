 ...
 */
@Service
public class AmzNotificationsSubscriptionsServiceImpl extends
        ServiceImpl<AmzNotificationsSubscriptionsMapper, AmzNotificationsSubscriptions> implements
        IAmzNotificationsSubscriptionsService {
    ...
    void handlerCreateSubscriptionResponse(AmazonAuthority amazonAuthority, AmzNotifications type,
            CreateSubscriptionResponse createResponse) {
    ...
    void requestCreateSubscription(AmazonAuthority amazonAuthority, AmzNotifications type) throws ApiException {
        ...
        List<AmzNotificationsDestination> destinationList = iAmzNotificationsDestinationService.list(
                new LambdaQueryWrapper<AmzNotificationsDestination>()
    ...
    void handlerGetSubscriptionResponse(AmazonAuthority amazonAuthority, AmzNotifications type,
        ...
        if (response != null && response.getPayload() != null) {
            ...
            if (subscription.getProcessingDirective() != null
                    && subscription.getProcessingDirective().getEventFilter() != null) {
    ...
    public void deleteSubscriptions(String destinationId) {
        ...
        for (AmzNotificationsSubscriptions item : list) {
            ...
            NotificationsApi api = apiBuildService.getNotificationsApi(amazonAuthority);
            try {
                DeleteSubscriptionByIdResponse response = api.deleteSubscriptionById(item.getSubscriptionId(),
                        item.getEventFilterType());
    ...
    public void runApi(AmazonAuthority amazonAuthority) {
        ...
        List<AmzNotifications> typeList = iAmzNotificationsService.list(
                new LambdaQueryWrapper<AmzNotifications>().eq(AmzNotifications::getIsrun, Boolean.TRUE));
