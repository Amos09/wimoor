...
public class AmzAuthApiTimelimitServiceImpl extends
        ServiceImpl<AmzAuthApiTimelimitMapper, AmzAuthApiTimelimit> implements IAmzAuthApiTimelimitService {
    ...
    public AmzAuthApiTimelimit getApiLimit(String amazonauthid, String apiname) {
        ...
        if (limit != null) {
            ...
            AmzAuthApiTimelimit result = (AmzAuthApiTimelimit) JSONObject.toJavaObject(jsonObject,
                    AmzAuthApiTimelimit.class);
            return result;
        }
