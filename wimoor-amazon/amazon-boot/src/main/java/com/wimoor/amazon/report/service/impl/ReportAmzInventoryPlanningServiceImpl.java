...
public class ReportAmzInventoryPlanningServiceImpl extends ReportServiceImpl {
    ...
    /**
     * snapshot-date sku	fnsku	asin product-name	condition	available	pending-removal-quantity
     * inv-age-0-to-90-days	inv-age-91-to-180-days	inv-age-181-to-270-days
     * inv-age-271-to-365-days	inv-age-365-plus-days	currency qty-to-be-charged-ltsf-11-mo	projected-ltsf-11-mo
     * qty-to-be-charged-ltsf-12-mo	estimated-ltsf-next-charge units-shipped-t7	units-shipped-t30	units-shipped-t60
     ...
     * sell-through	item-volume	volume-unit-measurement	storage-type storage-volume	marketplace	product-group	sales-rank
     * days-of-supply	estimated-excess-quantity	weeks-of-cover-t30	weeks-of-cover-t90
     * featuredoffer-price	sales-shipped-last-7-days sales-shipped-last-30-days	sales-shipped-last-60-days
     * sales-shipped-last-90-days inv-age-0-to-30-days	inv-age-31-to-60-days	inv-age-61-to-90-days
     ...
     * afn-researching-quantity	afn-reserved-future-supply	afn-future-supply-buyable fba-minimum-inventory-level
     * historical-days-of-supply fba-inventory-level-health-status
     */
        ...
        try {
            while ((line = br.readLine()) != null) {
                ...
                if (lineNumber == 0) {
                    ...
                    e.setPendingRemovalQuantity(
                            GeneralUtil.getIntegerValue(info, titleList, "pending-removal-quantity"));
                    ...
                    e.setQtyToBeChargedLtsf11Mo(
                            GeneralUtil.getBigDecimalValue(info, titleList, "qty-to-be-charged-ltsf-11-mo"));
                    e.setProjectedLtsf11Mo(GeneralUtil.getBigDecimalValue(info, titleList, "projected-ltsf-11-mo"));
                    e.setQtyToBeChargedLtsf12Mo(
                            GeneralUtil.getBigDecimalValue(info, titleList, "qty-to-be-charged-ltsf-12-mo"));
                    e.setEstimatedLtsfNextCharge(
                            GeneralUtil.getBigDecimalValue(info, titleList, "estimated-ltsf-next-charge"));
                    ...
                    e.setLowestPriceNewPlusShipping(
                            GeneralUtil.getBigDecimalValue(info, titleList, "lowest-price-new-plus-shipping"));
                    ...
                    e.setRecommendedSalesPrice(
                            GeneralUtil.getBigDecimalValue(info, titleList, "recommended-sales-price"));
                    e.setRecommendedSaleDurationDays(
                            GeneralUtil.getIntegerValue(info, titleList, "recommended-sale-duration-days"));
                    e.setRecommendedRemovalQuantity(
                            GeneralUtil.getIntegerValue(info, titleList, "recommended-removal-quantity"));
                    e.setEstimatedCostSavingsOfRecommendedActions(GeneralUtil.getBigDecimalValue(info, titleList,
                    ...
                    e.setEstimatedExcessQuantity(
                            GeneralUtil.getIntegerValue(info, titleList, "estimated-excess-quantity"));
                    ...
                    e.setSalesShippedLast7Days(
                            GeneralUtil.getBigDecimalValue(info, titleList, "sales-shipped-last-7-days"));
                    e.setSalesShippedLast30Days(
                            GeneralUtil.getBigDecimalValue(info, titleList, "sales-shipped-last-30-days"));
                    e.setSalesShippedLast60Days(
                            GeneralUtil.getBigDecimalValue(info, titleList, "sales-shipped-last-60-days"));
                    e.setSalesShippedLast90Days(
                            GeneralUtil.getBigDecimalValue(info, titleList, "sales-shipped-last-90-days"));
                    ...
                    e.setEstimatedStorageCostNextMonth(
                            GeneralUtil.getBigDecimalValue(info, titleList, "estimated-storage-cost-next-month"));
                    ...
                    e.setAfnResearchingQuantity(
                            GeneralUtil.getIntegerValue(info, titleList, "afn-researching-quantity"));
                    e.setAfnReservedFutureSupply(
                            GeneralUtil.getIntegerValue(info, titleList, "afn-reserved-future-supply"));
                    e.setAfnFutureSupplyBuyable(
                            GeneralUtil.getIntegerValue(info, titleList, "afn-future-supply-buyable"));

                    e.setQuantityToBeChargedAis181T210Days(
                            GeneralUtil.getIntegerValue(info, titleList, "quantity-to-be-charged-ais-181-210-days"));
                    e.setQuantityToBeChargedAis211T240Days(
                            GeneralUtil.getIntegerValue(info, titleList, "quantity-to-be-charged-ais-211-240-days"));
                    e.setQuantityToBeChargedAis241T270Days(
                            GeneralUtil.getIntegerValue(info, titleList, "quantity-to-be-charged-ais-241-270-days"));
                    e.setQuantityToBeChargedAis271T300Days(
                            GeneralUtil.getIntegerValue(info, titleList, "quantity-to-be-charged-ais-271-300-days"));
                    e.setQuantityToBeChargedAis301T330Days(
                            GeneralUtil.getIntegerValue(info, titleList, "quantity-to-be-charged-ais-301-330-days"));
                    e.setQuantityToBeChargedAis331T365Days(
                            GeneralUtil.getIntegerValue(info, titleList, "quantity-to-be-charged-ais-331-365-days"));
                    e.setQuantityToBeChargedAis365PlusDays(
                            GeneralUtil.getIntegerValue(info, titleList, "quantity-to-be-charged-ais-365-plus-days"));

                    e.setEstimatedAis181T210Days(
                            GeneralUtil.getBigDecimalValue(info, titleList, "estimated-ais-181-210-days"));
                    e.setEstimatedAis211T240Days(
                            GeneralUtil.getBigDecimalValue(info, titleList, "estimated-ais-211-240-days"));
                    e.setEstimatedAis241T270Days(
                            GeneralUtil.getBigDecimalValue(info, titleList, "estimated-ais-241-270-days"));
                    e.setEstimatedAis271T300Days(
                            GeneralUtil.getBigDecimalValue(info, titleList, "estimated-ais-271-300-days"));
                    e.setEstimatedAis301T330Days(
                            GeneralUtil.getBigDecimalValue(info, titleList, "estimated-ais-301-330-days"));
                    e.setEstimatedAis331T365Days(
                            GeneralUtil.getBigDecimalValue(info, titleList, "estimated-ais-331-356-days"));
                    e.setEstimatedAis365PlusDays(
                            GeneralUtil.getBigDecimalValue(info, titleList, "estimated-ais-365-plus-days"));

                    e.setFbaInventoryLevelHealthStatus(
                            GeneralUtil.getStrValue(info, titleList, "fba-inventory-level-health-status"));
                    e.setFbaMinimumInventoryLevel(
                            GeneralUtil.getStrValue(info, titleList, "fba-minimum-inventory-level"));
