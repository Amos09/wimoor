 ...
 */
@Service
public class AmzStorageFeeServiceImpl extends
        ServiceImpl<FBALongTermStorageFeeReportMapper, FBALongTermStorageFeeReport> implements IAmzStorageFeeService {
                ...
                for (int j = 0; j < titlearray.length; j++) {
                    ...
                    if (value != null) {
                        if ("weight".equals(titlearray[j].toString())) {
                            if (map.get("unit_of_dimension") != null && map.get("unit_of_dimension").toString()
                                    .equals("inches")) {
