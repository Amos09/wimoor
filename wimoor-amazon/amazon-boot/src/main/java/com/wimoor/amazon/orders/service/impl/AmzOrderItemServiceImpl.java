...
public class AmzOrderItemServiceImpl extends ServiceImpl<AmzOrderItemMapper, AmzOrderItem> implements
        IAmzOrderItemService {
    ...
    public void ordersItem(AmzOrderMain order, String token) {
        ...
        if (auth != null) {
            ...
            if (api != null) {
                ApiCallback<GetOrderItemsResponse> apiCallbackGetOrderItems = new ApiCallbackGetOrderItems(this, auth,
                        order);
                try {
            ...
            if (itemsList != null) {
                ...
                if (items != null) {
                    for (OrderItem orderitem : items) {
                        ...
                        item.setOrderitemid(orderitem.getOrderItemId());
                        item.setScheduleddeliverystartdate(
                                GeneralUtil.getDatez(orderitem.getScheduledDeliveryStartDate()));
