...
public class AmzProductSalesPlanShipItemController {
    ...
    public Result<?> getSummary(String groupid, String warehouseid) {
        UserInfo user = UserInfoContext.get();
        return Result.success(
                iAmzProductSalesPlanShipItemService.getSummary(user.getCompanyid(), groupid, warehouseid));
    }
    ...
    public Result<?> list(String groupid, String warehouseid) {
        UserInfo user = UserInfoContext.get();
        return Result.success(
                iAmzProductSalesPlanShipItemService.getList(user.getCompanyid(), groupid, warehouseid, null));
    }
    ...
    public Result<?> getBatch(String groupid, String warehouseid, String batchnumber) {
        UserInfo user = UserInfoContext.get();
        return Result.success(
                iAmzProductSalesPlanShipItemService.getList(user.getCompanyid(), groupid, warehouseid, batchnumber));
    }
