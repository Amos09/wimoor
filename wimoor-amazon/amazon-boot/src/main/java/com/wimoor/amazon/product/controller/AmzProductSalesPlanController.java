...
public class AmzProductSalesPlanController {
    ...
    public Result<IPage<Map<String, Object>>> getPlanModel(@RequestBody PlanDTO dto) {
        ...
        if (dto.getTags() != null && dto.getTags().size() > 0) {
            List<String> pidlist = iProductInfoService.getPidListByTagList(dto.getTags(), dto.getShopid(), null,
                    dto.getGroupid(), null, dto.getMarketplaceids(), dto.getNotag());
        ...
        if (page != null && page.getRecords() != null) {
            ...
            if (dto.getExpendall() != null && dto.getExpendall()) {
                ...
                if (skus.size() > 0) {
                    ...
                    Map<String, List<Map<String, Object>>> expendDatas = iAmzProductSalesPlanService.ExpandCountrysDataByGroup(
                            countrydto);
                    for (Map<String, Object> item : page.getRecords()) {
