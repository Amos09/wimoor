...
public class ReportAmzInventorySummaryServiceImpl extends ReportServiceImpl {
    ...
    public void requestReport(AmazonAuthority amazonAuthority, Calendar cstart, Calendar cend, Boolean ignore) {
        ...
        callCreateAPI(this, body, amazonAuthority, market, AmzDateUtils.getUTCToDate(ofstart),
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (lineNumber == 0) {
                    ...
                    e.setStartingWarehouseBalance(
                            GeneralUtil.getIntegerValue(info, titleList, "starting warehouse balance"));
                    e.setInTransitBetweenWarehouses(
                            GeneralUtil.getStrValue(info, titleList, "in transit between warehouses"));
                    ...
                    e.setWarehouseTransferInOut(
                            GeneralUtil.getIntegerValue(info, titleList, "warehouse transfer in/out"));
                    ...
                    e.setEndingWarehouseBalance(
                            GeneralUtil.getIntegerValue(info, titleList, "ending warehouse balance"));
