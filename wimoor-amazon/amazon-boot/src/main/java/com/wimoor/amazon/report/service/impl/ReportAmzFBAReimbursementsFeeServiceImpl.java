            ...
            while ((line = br.readLine()) != null) {
                ...
                if (lineNumber == 0) {
                    ...
                    if (StrUtil.isEmpty(GeneralUtil.getStrValue(info, titleList, "quantity-reimbursed-cash"))) {
                        ...
                        report.setQuantityReimbursedCash(
                                GeneralUtil.getIntegerValue(info, titleList, "quantity-reimbursed-cash"));
                    }
                    if (StrUtil.isEmpty(GeneralUtil.getStrValue(info, titleList, "quantity-reimbursed-inventory"))) {
                        ...
                        report.setQuantityReimbursedInventory(
                                GeneralUtil.getIntegerValue(info, titleList, "quantity-reimbursed-inventory"));
                    }
                    if (StrUtil.isEmpty(GeneralUtil.getStrValue(info, titleList, "quantity-reimbursed-total"))) {
                        ...
                        report.setQuantityReimbursedTotal(
                                GeneralUtil.getIntegerValue(info, titleList, "quantity-reimbursed-total"));
                    }
