...
public class ProductInOrderServiceImpl extends ServiceImpl<ProductInOrderMapper, ProductInOrder> implements
    ...
    @Override
    public List<Map<String, Object>> getChartData(Map<String, Integer> typesMap, Map<String, Object> parameter,
            UserInfo user) {
        ...
        if (typesMap.containsKey("uns") || typesMap.containsKey("ods")
            ...
            orderlist = iOrdersSumService.orderSummaryBySkuDate(sku, marketplace, beginDate, endDate, amazonAuthId,
                    user, ftype);
        }
        ...
        for (Entry<String, Integer> typeentry : typesMap.entrySet()) {
            ...
            if ("ses".equals(ftype)) {// session 页面访问量
                ...
                if ("acoas".equals(ftype)) {
                    long diff = GeneralUtil.getDatez(endDate).getTime() - GeneralUtil.getDatez(beginDate)
                            .getTime();// 这样得到的差值是微秒级别
                    ...
                    for (int i = 1; i <= daysize; i++, c.add(Calendar.DATE, 1)) {
                        ...
                        if (totalUnits.compareTo(new BigDecimal("0")) != 0) {
                            aups = adUnits.multiply(new BigDecimal("100"))
                                    .divide(totalUnits, 2, RoundingMode.HALF_EVEN);
                        }
            ...
            long diff =
                    GeneralUtil.getDatez(endDate).getTime() - GeneralUtil.getDatez(beginDate).getTime();// 这样得到的差值是微秒级别
            long daysize = diff / (1000 * 60 * 60 * 24);
            Calendar c = Calendar.getInstance();
            c.setTime(GeneralUtil.getDatez(beginDate));
    ...
    private List<ProductRank> productRank(String sku, String marketplace, String beginDate, String endDate,
    ...
    private List<Map<String, Object>> getCountRankBySku(String sku, String marketplace, String amazonAuthId,
            UserInfo user) {
        Map<String, Object> param = new HashMap<String, Object>();
        param.put("sku", sku);
        param.put("marketplaceid", marketplace);
    ...
    private List<Map<String, Object>> getRankBySku(String sku, String marketplace, String beginDate, String endDate,
            String amazonAuthId, UserInfo user) {
        Map<String, Object> param = new HashMap<String, Object>();
        param.put("sku", sku);
        param.put("marketplaceid", marketplace);
        param.put("begindate", beginDate);
    ...
    private List<Map<String, Object>> advInfo(String sku, String marketplace, String beginDate, String endDate,
            String amazonAuthId, UserInfo user, String ftype) {
        Map<String, Object> param = new HashMap<String, Object>();
        param.put("sku", sku);
        param.put("marketplaceid", marketplace);
            ...
            while (iterator.hasNext()) {
                ...
                if (name == null) {
                    ...
                    try {
                        ...
                        String strName = categoryId.toString().replace("_display_on_website", "").replace("_and_", "&")
                                .replace("_", " ");
    ...
    public List<AmzProductPageviews> sessionPage(String sku, String marketplaceid, String startdate, String enddate,
            String amazonAuthId, UserInfo user, String ftype) {
        Map<String, Object> param = new HashMap<String, Object>();
        param.put("sku", sku);
