 ...
 */
@Service
public class AmzFinAccountServiceImpl extends ServiceImpl<AmzFinAccountMapper, AmzFinAccount> implements
        IAmzFinAccountService {
        ...
        try {
            ...
            if (limit.apiNotRateLimit()) {
                if (!StrUtil.isBlank(limit.getNexttoken())) {
                    ...
                    ApiCallback<ListFinancialEventGroupsResponse> callback = new ApiCallbackListFinancialEventGroupsEvents(
                            this, amazonAuthority);
                    api.listFinancialEventGroupsAsync(100, financialEventGroupStartedBefore,
                            financialEventGroupStartedAfter, null, callback);
                }
            }
    ...
    public void runApiNextToken(AmazonAuthority amazonAuthority, String nexttoken) {
        ...
        FinancesApi api = apiBuildService.getFinancesApi(amazonAuthority);
        try {
            ApiCallback<ListFinancialEventGroupsResponse> callback = new ApiCallbackListFinancialEventGroupsEvents(this,
                    amazonAuthority);
    ...
    public Map<String, Map<String, Object>> getFinancialByShopId(String shopid, String currency) {
        ...
        for (Map<String, Object> item : list) {
            ...
            BigDecimal omoney =
                    item.get("original_total") == null ? new BigDecimal("0") : (BigDecimal) item.get("original_total");
            ...
            for (Map<String, Object> item : list.getRecords()) {
                if (item.get("currency") != null) {
                    ...
                    if (item != null && item.get("totalAmount") != null) {
                        ...
                        amount = this.exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromCurrency, tocurrency,
                                amount);
    ...
    public ListFinancialEventsResponse listFinancialEventsByGroupId(AmazonAuthority amazonAuthority, String groupid,
            String token) {
        // TODO Auto-generated method stub
