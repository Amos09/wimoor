    ...
    public Result<?> getFinDataWeekListAction(String marketplaceid, String groupid, String sku) {
        ...
        if (list != null) {
            ...
            for (Map<String, Object> itemMap : list) {
                ...
                BigDecimal otherCost = exchangeRateHandlerService.changeCurrencyByLocal(currency,
                        marketplace.getCurrency(), new BigDecimal(amount), 2);
    ...
    public void downFinItemDataTempAction(HttpServletResponse response) {
        try {
            ...
            if (acurrency != null && acurrency.length > 0) {
                ...
                DataValidation dstDataValidation5 = helper.createValidation(
                        helper.createExplicitListConstraint(acurrency), dstAddrList5);
            ...
            if (agroup != null && agroup.length > 0) {
                ...
                DataValidation dstDataValidation0 = helper.createValidation(helper.createExplicitListConstraint(agroup),
                        dstAddrList0);
            ...
            if (amarket != null && amarket.length > 0) {
                ...
                DataValidation dstDataValidation1 = helper.createValidation(
                        helper.createExplicitListConstraint(amarket), dstAddrList1);
            ...
            if (array != null && array.length > 0) {
                ...
                DataValidation dstDataValidation4 = helper.createValidation(helper.createExplicitListConstraint(array),
                        dstAddrList4);
            ...
            DataValidationConstraint dvc3 = helper.createDateConstraint(OperatorType.BETWEEN, "2010-12-12",
