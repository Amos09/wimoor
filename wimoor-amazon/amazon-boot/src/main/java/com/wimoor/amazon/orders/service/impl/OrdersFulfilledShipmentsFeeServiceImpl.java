 ...
 */
@Service
public class OrdersFulfilledShipmentsFeeServiceImpl extends
        ServiceImpl<OrdersFulfilledShipmentsFeeMapper, OrdersFulfilledShipmentsFee> implements
        IOrdersFulfilledShipmentsFeeService {
        ...
        for (InventorySummaryReport item : list) {
            ...
            if (marketPlace.getRegion().equals("EU")) {
                ...
                if (cfg != null) {
                    ...
                    if (cfg.getIssystem() == false && cfgcountry != null && cfgcountry.getFenpeiType() != null
                            && cfgcountry.getFenpeiType().equals("EFN")) {
                        ispaneu = false;
                    }
                }
                if (ispaneu) {
                ...
                for (AmazonOrdersReturnVo reitem : relist) {
                    ...
                    if (refeelist != null && refeelist.size() > 0) {
                        for (OrdersFulfilledShipmentsFee fee : refeelist) {
                            ...
                            Integer oldsub =
                                    reinbound.getQuantityReceivedSub() != null ? reinbound.getQuantityReceivedSub() : 0;
                            reinbound.setQuantityReceivedSub(oldsub - fee.getQuantity());
                            Integer oldbalance = reinbound.getQuantityReceivedBalance() != null
                                    ? reinbound.getQuantityReceivedBalance() : 0;
            ...
            for (ShipInboundItem shipitem : itemlist) {
                if (shipitem.getQuantityreceived() != null) {
                    ...
                    int oldbalance =
                            shipitem.getQuantityReceivedBalance() != null ? shipitem.getQuantityReceivedBalance() : 0;
