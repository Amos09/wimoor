...
public class DaysalesFormulaServiceImpl extends ServiceImpl<DaysalesFormulaMapper, DaysalesFormula> implements
        IDaysalesFormulaService {

    public static int getAvgSales(DaysalesFormula dayformula, int summonth, int sumseven, int sumhalfmonth,
            Date openDay) {
        int qty = 0;
