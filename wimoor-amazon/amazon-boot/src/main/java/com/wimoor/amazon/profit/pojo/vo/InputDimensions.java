...
public class InputDimensions {
    ...
    public InputDimensions(BigDecimal length, BigDecimal width, BigDecimal height, String LUnit, BigDecimal weight,
            String WUnit) {
    ...
    public ItemMeasure getVolume(String toUnit) throws BizException {
        if (getLength(toUnit).getValue() == null || getWidth(toUnit).getValue() == null
                || getHeight(toUnit).getValue() == null) {
            return new ItemMeasure(new BigDecimal("0"), toUnit);
        }
        BigDecimal v = getLength(toUnit).getValue().multiply(getWidth(toUnit).getValue())
                .multiply(getHeight(toUnit).getValue());
    ...
    public ItemMeasure getDimensionalWeight(String toUnit, BigDecimal length_in, BigDecimal width_in,
            BigDecimal height_in) {
