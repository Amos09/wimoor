...
public interface ProductInfoMapper extends BaseMapper<ProductInfo> {
    ...
    List<ProductInfo> selectBySku(@Param("sku") String sku, @Param("marketplaceid") String marketplaceid,
            @Param("amazonAuthId") String amazonAuthId);

    List<ProductInfo> selectByMSku(@Param("msku") String sku, @Param("marketplaceid") String marketplaceid,
            @Param("groupid") String groupid, @Param("shopid") String shopid);
    ...
    Map<String, Object> findNameAndPicture(@Param("sku") String sku_p, @Param("marketplaceid") String marketplaceid,
            @Param("groupid") String groupid);

    String findMSKUBySKUMarket(@Param("sku") String sku, @Param("marketplaceid") String marketplaceid,
            @Param("amazonAuthId") String amazonAuthId);
