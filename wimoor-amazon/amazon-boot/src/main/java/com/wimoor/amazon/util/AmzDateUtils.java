...
public class AmzDateUtils {
    ...
    public static Date getDate(OffsetDateTime date) {
        ...
        c.set(zonetime.getYear(), zonetime.getMonth().getValue() - 1, zonetime.getDayOfMonth(), zonetime.getHour(),
                zonetime.getMinute(), zonetime.getSecond());
        return c.getTime();
    }
    ...
    public static LocalDateTime getLocalTime(Date postdate) {
        ...
        return LocalDateTime.of(c.get(Calendar.YEAR), c.get(Calendar.MONTH) + 1, c.get(Calendar.DAY_OF_MONTH),
                c.get(Calendar.HOUR_OF_DAY), c.get(Calendar.HOUR_OF_DAY), c.get(Calendar.MINUTE),
    ...
    public static Date getDate(LocalDateTime date) {
        ...
        Calendar c = Calendar.getInstance();
        c.set(date.getYear(), date.getMonth().getValue() - 1, date.getDayOfMonth(), date.getHour(), date.getMinute(),
                date.getSecond());
        return c.getTime();
    }
