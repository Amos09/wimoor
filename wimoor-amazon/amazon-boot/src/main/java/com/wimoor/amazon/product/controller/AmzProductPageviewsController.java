...
public class AmzProductPageviewsController {
    ...
    public Map<String, Object> uploadSessionFileAction(String type, String marketplaceid, String sellerid, String date,
            String data, String ftype) {
        ...
        if (type != null && type.equals("uploadsessionbyextension")) {
            ...
            try {
                user.setId("1");
                iAmzProductPageviewsService.uploadSessionFile(user, data, marketplaceid, sellerid,
                        GeneralUtil.getDatez(date), ftype);
