...
public interface IShipInboundPlanQuotaV2Service {
    ...
    void setPDFDocShipFormDetail(PdfWriter writer, UserInfo user, Document document, QuotaInfoDTO quotaInfoDto,
            List<ShipPlanVo> volist);

    void setPDFDocShipForm(PdfWriter writer, UserInfo user, Document document, QuotaInfoDTO quotaInfoDto,
            List<ShipPlanVo> volist);
