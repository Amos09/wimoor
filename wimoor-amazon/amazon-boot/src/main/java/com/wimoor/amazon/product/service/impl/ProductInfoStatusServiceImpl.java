...
@Service
public class ProductInfoStatusServiceImpl extends
        ServiceImpl<ProductInfoStatusDefineMapper, ProductInfoStatusDefine> implements IProductInfoStatusService {
