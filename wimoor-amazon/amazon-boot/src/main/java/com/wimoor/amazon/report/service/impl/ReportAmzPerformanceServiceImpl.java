        ...
        for (AmazonAuthority item : authlist) {
            ...
            for (AmazonAuthMarketPerformance pf : pflist) {
                ...
                if (mfn != null) {
                    ...
                    if (vo.getOrderDefectRateTargetValue().compareTo(mfn.getBigDecimal("targetValue")) < 0
                            || vo.getOrderDefectRateTargetValue().compareTo(new BigDecimal("0")) == 0) {
                ...
                if (afn != null) {
                    ...
                    if (vo.getOrderDefectRateTargetValue().compareTo(afn.getBigDecimal("targetValue")) < 0
                            || vo.getOrderDefectRateTargetValue().compareTo(new BigDecimal("0")) == 0) {
                        vo.setOrderDefectRateTargetValue(afn.getBigDecimal("targetValue"));
                    }
                }

                JSONObject suspectedIntellectualPropertyViolations = json.getJSONObject(
                        "suspectedIntellectualPropertyViolations");
                if (suspectedIntellectualPropertyViolations != null) {
                    vo.setPolicyDefectsCount(
                            vo.getPolicyDefectsCount() + suspectedIntellectualPropertyViolations.getInteger(
                                    "defectsCount"));
                    vo.setPolicyTargetValue(
                            vo.getPolicyTargetValue() + suspectedIntellectualPropertyViolations.getInteger(
                                    "targetValue"));
                }
                ...
                if (listingPolicyViolations != null) {
                    vo.setPolicyDefectsCount(
                            vo.getPolicyDefectsCount() + listingPolicyViolations.getInteger("defectsCount"));
                    vo.setPolicyTargetValue(
                            vo.getPolicyTargetValue() + listingPolicyViolations.getInteger("targetValue"));
                }
                ...
                if (validTrackingRate != null) {
                    ...
                    if (vo.getValidTrackingRateTargetValue().compareTo(validTrackingRate.getBigDecimal("targetValue"))
                            < 0 || vo.getValidTrackingRateTargetValue().compareTo(new BigDecimal("0")) == 0) {
                        vo.setValidTrackingRateTargetValue(validTrackingRate.getBigDecimal("targetValue"));
                    }
                }
                ...
                if (lateShipmentRate != null) {
                    ...
                    if (vo.getLateShipmentRateTargetValue().compareTo(lateShipmentRate.getBigDecimal("targetValue")) < 0
                            || vo.getLateShipmentRateTargetValue().compareTo(new BigDecimal("0")) == 0) {
                ...
                if (preFulfillmentCancellationRate != null) {
                    ...
                    if (vo.getCancelRateTargetValue()
                            .compareTo(preFulfillmentCancellationRate.getBigDecimal("targetValue")) < 0
                            || vo.getCancelRateTargetValue().compareTo(new BigDecimal("0")) == 0) {
                ...
                if (invoiceDefectRate != null) {
                    ...
                    if (vo.getInvoiceDefectRateTargetValue().compareTo(invoiceDefectRate.getBigDecimal("targetValue"))
                            < 0 || vo.getInvoiceDefectRateTargetValue().compareTo(new BigDecimal("0")) == 0) {
