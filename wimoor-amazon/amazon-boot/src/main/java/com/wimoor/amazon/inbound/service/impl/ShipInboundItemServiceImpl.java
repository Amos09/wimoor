...
public class ShipInboundItemServiceImpl extends ServiceImpl<ShipInboundItemMapper, ShipInboundItem> implements
        IShipInboundItemService {
                ...
                if (item != null) {
                    ...
                    if (skufeeavg != null) {
                        ...
                        if (skufees.compareTo(BigDecimal.ZERO) == 0) {
                            ...
                            BigDecimal fee = new BigDecimal(skufee.toString()).divide(
                                    new BigDecimal(item.getQuantityshipped()), 2, RoundingMode.HALF_UP);
