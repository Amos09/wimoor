...
public class MerchantShippingGroupController {
    ...
    public Result<?> getAllGroupAction(@RequestBody ProductListingItemDTO dto) {
        setAuthority(dto);
        List<MerchantShippingGroup> list = iMerchantShippingGroupServices.listGroups(dto.getAmazonauthid(),
    ...
    public Result<?> refreshAllGroupAction(@RequestBody ProductListingItemDTO dto) {
        setAuthority(dto);
        List<MerchantShippingGroup> list = iMerchantShippingGroupServices.refreshListGroups(dto.getAmazonauthid(),
                dto.getMarketplaceids().get(0));
        return Result.success(list);
    }
