...
public class AmzSettlementReportServiceImpl extends
        ServiceImpl<AmzSettlementReportMapper, AmzSettlementReport> implements IAmzSettlementReportService {
            ...
            for (Entry<String, Object> entry : item.entrySet()) {
                ...
                if (posted_date != null) {
                    ...
                    if (oldValue.compareTo(new BigDecimal("0")) == 0) {
                        ...
                        value = value.abs().divide(oldValue.abs(), 4, RoundingMode.HALF_UP)
        ...
        if (item != null) {
            for (Entry<String, Object> entry : item.entrySet()) {
                ...
                if (oldValue.compareTo(new BigDecimal("0")) == 0) {
                    ...
                    value = value.subtract(oldValue).divide(oldValue, 4, RoundingMode.HALF_UP)
                            .multiply(new BigDecimal("100"));
                }
                itemRate.put(posted_date, value);
            }
    ...
    private void addMap(String shopid, HashMap<String, HashMap<String, Object>> result, Map<String, Object> item,
        ...
        BigDecimal currencyValue = this.exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency,
                tocurrency, value);
    ...
    public HashMap<String, HashMap<String, Object>> getLacolSummaryMonth(Map<String, Object> param) {
        ...
        if (param.get("marketplaceid") != null) {
            marketplaceid = param.get("marketplaceid").toString();
        }
    ...
    public int downLoadSettlementRpt(Sheet sheet, Map<String, Object> parameter, int line) throws BizException {
        ...
        if (list != null) {
            String[] titlemap = {"groupname", "settlement", "settlement_id", "currency", "transaction_type", "order_id",
                    "merchant_order_id",
    ...
    List<Map<String, Object>> putItem(Map<String, Object> map, Map<String, Object> item, String key) {
        ...
        List<Map<String, Object>> itemlist =
                map.get(key) != null ? (List<Map<String, Object>>) map.get(key) : new LinkedList<Map<String, Object>>();
        itemlist.add(item);
    ...
    public Map<String, Object> getDetailSettment(Map<String, Object> param) {
        ...
        String currency =
                param.get("currency") != null && !"undefined".equals(param.get("currency").toString()) ? param.get(
                        "currency").toString() : "RMB";
        String shopid = param.get("shopid") != null ? param.get("shopid").toString() : null;
        Map<String, Object> detail = new HashMap<String, Object>();
        BigDecimal totalsummary = new BigDecimal("0");
        for (Map<String, Object> item : list) {
            BigDecimal itemamount =
                    item.get("amount") == null ? new BigDecimal("0") : new BigDecimal(item.get("amount").toString());
            ...
            if (item.get("transaction_type") != null) {
                ...
                Map<String, Object> transactionTypeMap =
                        detail.get(transaction_type) != null ? (Map<String, Object>) detail.get(transaction_type)
                ...
                if (item.get("amount_type") != null) {
                    ...
                    Map<String, Object> amountTypeMap =
                            transactionTypeMap.get(amount_type) != null ? (Map<String, Object>) transactionTypeMap.get(
                                    amount_type) : new HashMap<String, Object>();
                ...
                BigDecimal summary = transactionTypeMap.get("summary") != null ? new BigDecimal(
                        transactionTypeMap.get("summary").toString()) : new BigDecimal("0");
    ...
    public List<Map<String, Object>> getDetailSettmentNoSKU(Map<String, Object> param, Map<String, String> descName) {
        ...
        for (Map<String, Object> item : list) {
            ...
            if (item.get("in_principal") != null) {
                BigDecimal in_principal = item.get("in_principal") == null ? new BigDecimal("0")
                        : new BigDecimal(item.get("in_principal").toString());
                in_principal = exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency, currency,
                        in_principal);
    ...
    public Map<String, Object> getDetail(Map<String, Object> param) {
        ...
        if (param.get("sku") != null) {
            ...
            if (param.get("market") != null) {
                ...
                if (param.get("groupid") != null) {
                    ...
                    AmazonAuthority amazonAuth = amazonAuthorityService.selectByGroupAndMarket(groupid,
        ...
        for (Entry<String, Object> entry : result.entrySet()) {
            ...
            for (Map<String, Object> item : itemlist) {
                BigDecimal itemamount = item.get("amount") == null ? new BigDecimal("0")
                ...
                if (item.get("posted_date") != null) {
                    ...
                    daytotal = daytotal.add(item.get("amount") == null ? new BigDecimal("0")
                            : new BigDecimal(item.get("amount").toString()));
                    totalDate.put(item.get("posted_date").toString(), daytotal);
                }
                itemamount = exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency, currency,
                        itemamount);
                item.put("amount", itemamount.setScale(2, RoundingMode.DOWN));
            }

            BigDecimal curamounttotal = exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency, currency,
                    amounttotal);
    ...
    public void changeValueExchangeRate(String shopid, Map<String, Object> item, String ftype, String currency,
            String tocurrency) {
        ...
        for (String mgroupid : grouplist) {
            ...
            for (String marketplace : marketlist) {
                ...
                if (map.get("groupid") != null && map.get("marketplaceid") != null) {
                    ...
                    AmazonAuthority auth = amazonAuthorityService.selectByGroupAndMarket(tempgroupid,
                            tempmarketplaceid);
                    if (auth == null) {
                        continue;
                    }
    ...
    private void set_camount_description(Map<String, Object> amountmap, Map<String, String> descName) {
        ...
        if (amountmap.get("maketpointname") != null) {
            ckey = amountmap.get("groupname").toString() + "(" + amountmap.get("maketpointname").toString() + "):"
                    + ckey;
        } else {
    ...
    public List<Map<String, Object>> getSettlementGroupOverAll(Map<String, Object> map) {
        ...
        for (Map<String, Object> item : result) {
            ...
            Map<String, BigDecimal> currencyrate = exchangeRateHandlerService.currencyChangeRateByLocal(shopid,
                    tocurrency);
            map.put("currencyrate", currencyrate);
            ...
            String marketplace_name =
                    item.get("marketplace_name") == null ? null : item.get("marketplace_name").toString();
            BigDecimal principal = item.get("principal") == null ? new BigDecimal("0")
                    : new BigDecimal(item.get("principal").toString());
            BigDecimal commission = item.get("commission") == null ? new BigDecimal("0")
                    : new BigDecimal(item.get("commission").toString());
            BigDecimal fbafee =
                    item.get("fbafee") == null ? new BigDecimal("0") : new BigDecimal(item.get("fbafee").toString());
            BigDecimal refund =
                    item.get("refund") == null ? new BigDecimal("0") : new BigDecimal(item.get("refund").toString());
            BigDecimal advfee =
                    item.get("advfee") == null ? new BigDecimal("0") : new BigDecimal(item.get("advfee").toString());
            BigDecimal storagefee = item.get("storagefee") == null ? new BigDecimal("0")
                    : new BigDecimal(item.get("storagefee").toString());
            BigDecimal setin =
                    item.get("setin") == null ? new BigDecimal("0") : new BigDecimal(item.get("setin").toString());
            ...
            other = setin.subtract(storagefee).subtract(advfee).subtract(refund).subtract(fbafee).subtract(commission)
                    .subtract(principal);

            principal = exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency, tocurrency, principal,
                    2);
            commission = exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency, tocurrency, commission,
                    2);
            ...
            storagefee = exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency, tocurrency, storagefee,
                    2);
            ...
            BigDecimal gprincipal = mapgroup.get("principal") == null ? new BigDecimal("0")
                    : new BigDecimal(mapgroup.get("principal").toString());
            BigDecimal gcommission = mapgroup.get("commission") == null ? new BigDecimal("0")
                    : new BigDecimal(mapgroup.get("commission").toString());
            BigDecimal gfbafee = mapgroup.get("fbafee") == null ? new BigDecimal("0")
                    : new BigDecimal(mapgroup.get("fbafee").toString());
            BigDecimal grefund = mapgroup.get("refund") == null ? new BigDecimal("0")
                    : new BigDecimal(mapgroup.get("refund").toString());
            BigDecimal gadvfee = mapgroup.get("advfee") == null ? new BigDecimal("0")
                    : new BigDecimal(mapgroup.get("advfee").toString());
            BigDecimal gstoragefee = mapgroup.get("storagefee") == null ? new BigDecimal("0")
                    : new BigDecimal(mapgroup.get("storagefee").toString());
            BigDecimal gsetin = mapgroup.get("setin") == null ? new BigDecimal("0")
                    : new BigDecimal(mapgroup.get("setin").toString());
            BigDecimal gother = mapgroup.get("other") == null ? new BigDecimal("0")
                    : new BigDecimal(mapgroup.get("other").toString());
            BigDecimal gprice = mapgroup.get("price") == null ? new BigDecimal("0")
                    : new BigDecimal(mapgroup.get("price").toString());
            BigDecimal gprofit = mapgroup.get("profit") == null ? new BigDecimal("0")
                    : new BigDecimal(mapgroup.get("profit").toString());
    ...
    public List<Map<String, Object>> downloadSettlementGroupOverAll(Map<String, Object> map) {
        ...
        for (Map<String, Object> item : result) {
            ...
            BigDecimal setin =
                    item.get("setin") == null ? new BigDecimal("0") : new BigDecimal(item.get("setin").toString());
            BigDecimal tax = item.get("tax") == null ? new BigDecimal("0") : new BigDecimal(item.get("tax").toString());
            BigDecimal shipcharge = item.get("shipcharge") == null ? new BigDecimal("0")
                    : new BigDecimal(item.get("shipcharge").toString());
            BigDecimal reserve =
                    item.get("reserve") == null ? new BigDecimal("0") : new BigDecimal(item.get("reserve").toString());
            BigDecimal savefee =
                    item.get("savefee") == null ? new BigDecimal("0") : new BigDecimal(item.get("savefee").toString());
            BigDecimal untransfer = item.get("untransfer") == null ? new BigDecimal("0")
                    : new BigDecimal(item.get("untransfer").toString());
            ...
            setin = exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency, tocurrency, setin, 2);
            other = exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency, tocurrency, other, 2);
            shipcharge = exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency, tocurrency, shipcharge,
                    2);
            ...
            untransfer = exchangeRateHandlerService.changeCurrencyByLocal(shopid, fromcurrency, tocurrency, untransfer,
                    2);
    ...
    public BigDecimal initAmount(String shopid, Map<String, Object> item, String ftype, String currency,
            String tocurrency) {
        if (item != null && item.get(ftype) != null) {
    ...
    public List<Map<String, Object>> findCommodity(Map<String, Object> map) {
        ...
        for (String mgroupid : grouplist) {
            ...
            for (String marketplace : marketlist) {
                ...
                map.put("marketplace_name", marketplace_name);
                if (map.get("marketplaceid") != null) {
                    Marketplace tmepmarket = marketplaceService.findMapByMarketplaceId()
                            .get(map.get("marketplaceid").toString());
    ...
    public void handlerSettlementSKURowData(String shopid, Map<String, Object> item, String tocurrency,
        ...
        if (item.get("currency") != null) {
            ...
            BigDecimal profit_local_shipmentfee = initAmount(shopid, item, "profit_local_shipmentfee", "CNY",
                    tocurrency);
            ...
            if (item.get("ordernum") != null && item.get("refundorder") != null) {
                ...
                BigDecimal refundorder = new BigDecimal(
                        item.get("refundorder") != null ? item.get("refundorder").toString() : "0");
        ...
        if (maps != null) {
            for (Entry<String, Object> entry : maps.entrySet()) {
                ...
                if (SumDatamap.containsKey(key)) {
                    if (key.equals("principal") || key.equals("commission") || key.equals("fbafee") || key.equals(
                            "shipping")
                            || key.equals("promotion") || key.equals("refund") || key.equals("setincome") || key.equals(
                            "otherfee")
                            || key.equals("income") || key.equals("share_adv_spend_fee") || key.equals(
                            "share_storage_fee")
                            ...
                            || key.equals("local_other_cost") || key.equals("local_price") || key.equals(
                            "local_return_tax")
                            || key.equals("profit_local_shipmentfee") || key.contains("profit_marketfee")
                            || key.contains("profit_vat")
                            || key.equals("profit_companytax") || key.equals("profit_customstax") || key.equals(
                            "profit_exchangelost")
                            || key.equals("profit_lostrate") || key.equals("profit_otherfee") || key.equals("profit")
                    ) {
                        BigDecimal maptemp = new BigDecimal(value);
                        BigDecimal summaptemp = new BigDecimal(
                                SumDatamap.get(key) == null ? "0" : SumDatamap.get(key).toString().trim());
                        result = result.add(maptemp);
                        SumDatamap.put(key, maptemp.add(summaptemp));
                    }
                    if (key.equals("salenum") || key.equals("ordernum") || key.equals("refundsales") || key.equals(
                            "refundorder")) {
                        BigDecimal maptemp = new BigDecimal(value);
                        BigDecimal summaptemp = new BigDecimal(
                                SumDatamap.get(key) == null ? "0" : SumDatamap.get(key).toString().trim());
    ...
    public void sumSettlementSKURowData(Map<String, Object> SumData, List<Map<String, Object>> list, boolean hasspend) {
        ...
        BigDecimal principal = new BigDecimal(
                SumData.get("principal") != null ? SumData.get("principal").toString() : "0.00");
        //BigDecimal sumgrossprate = new BigDecimal("0");
        if (principal.floatValue() > 0.000001) {
            if (SumData.get("principal") != null && SumData.get("salenum") != null && !"0".equals(
                    SumData.get("salenum").toString())) {
                    ...
                    if (value != null) {
                        ...
                        if ("profitrate".equals(titlearray[j].toString())) {
                            BigDecimal principal =
                                    map.get("principal") != null ? new BigDecimal(map.get("principal").toString())
                                            : new BigDecimal("0");
                            if (principal.floatValue() > 0.0000001 || principal.floatValue() < -0.0000001) {
                                cell.setCellValue(new BigDecimal(map.get("profit").toString()).divide(principal, 2,
