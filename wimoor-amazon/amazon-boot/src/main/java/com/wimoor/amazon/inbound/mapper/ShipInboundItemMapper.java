...
public interface ShipInboundItemMapper extends BaseMapper<ShipInboundItem> {
    ...
    Integer summaryShipmentSku(@Param("groupid") String groupid, @Param("marketplaceid") String marketplaceid,
    ...
    IPage<Map<String, Object>> getShipinboundItemBatchCondition(Page<?> page,
    ...
    Integer refreshOutbound(@Param("shopid") String shopid, @Param("warehouseid") String warehouseid,
