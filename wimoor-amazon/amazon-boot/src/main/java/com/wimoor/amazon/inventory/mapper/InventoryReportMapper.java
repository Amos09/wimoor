...
public interface InventoryReportMapper extends BaseMapper<InventoryReport> {
    ...
    IPage<Map<String, Object>> findInventoryCost(Page<?> page, @Param("groupid") String groupid,
            @Param("marketplaceid") String warehouseid, @Param("sku") String sku, @Param("shopid") String shopid,
            @Param("byday") String byday);

    Map<String, Object> findInventoryCostTotal(@Param("groupid") String groupid,
            @Param("marketplaceid") String warehouseid, @Param("sku") String sku, @Param("shopid") String shopid,
            @Param("byday") String byday);

    List<Map<String, Object>> findInventoryCost(@Param("groupid") String groupid,
            @Param("marketplaceid") String marketplaceid, @Param("sku") String sku, @Param("shopid") String shopid,
            @Param("byday") String byday);
    ...
    List<Map<String, Object>> getUnionFinAndInvCost(@Param("shopid") String shopid,
    ...
    List<Map<String, Object>> findFBAWithoutUnsellable(@Param("amazonAuthId") String amazonAuthId,
            @Param("marketplaceid") String marketplaceid, @Param("sku") String sku);

    Map<String, Object> findFBAInvDetailById(@Param("sku") String sku, @Param("marketplaceid") String marketplaceid,
            @Param("shopid") String shopid, @Param("groupid") String groupid);
