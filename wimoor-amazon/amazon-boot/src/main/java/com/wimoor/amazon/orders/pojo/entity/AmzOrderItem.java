...
public class AmzOrderItem {
    ...
    public AmzOrderItem(OrderItem orderitem, String market) {
        ...
        if (orderitem.getScheduledDeliveryStartDate() != null) {
            this.setScheduleddeliverystartdate(
                    GeneralUtil.getDatePlus(orderitem.getScheduledDeliveryStartDate().toString(), market));
        }
        if (orderitem.getScheduledDeliveryEndDate() != null) {
            this.setScheduleddeliveryenddate(
                    GeneralUtil.getDatePlus(orderitem.getScheduledDeliveryEndDate().toString(), market));
        }
    }
