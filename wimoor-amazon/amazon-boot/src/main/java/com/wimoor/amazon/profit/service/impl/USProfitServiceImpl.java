...
public class USProfitServiceImpl extends ProfitServiceImpl {
    ...
    /**
     * 判断US Product Tier Small Standard-Size,Large Standard-Size,Small Oversize, Medium Oversize,Large Oversize,Special
     * Oversize
     *
     * @throws BizException
     */
    ...
    public String determineProductTier(String country, InputDimensions dimensions, String isMedia)
        ...
        BigDecimal dimensionalWeight = dimensions
                .getDimensionalWeight(getDimUnit(country), length_in, width_in, height_in)
                .getValue();// 尺寸重量,单位体积（基于长度x宽度x高度（以英寸计））除以166。
