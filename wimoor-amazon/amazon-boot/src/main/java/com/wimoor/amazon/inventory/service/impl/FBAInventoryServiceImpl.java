...
public class FBAInventoryServiceImpl extends ServiceImpl<InventoryReportMapper, InventoryReport> implements
        IFBAInventoryService {
            ...
            if (Result.isSuccess(res) && res.getData() != null) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    Map<String, Object> skuinfo =
                            result.get(item.getMsku()) != null ? (Map<String, Object>) result.get(item.getMsku())
                                    : null;
    ...
    @Override
    public IPage<Map<String, Object>> selectInventoryCost(Page<?> page, String groupid, String marketplaceid,
            String sku, String shopid, String byday) {
        // TODO Auto-generated method stub
        ...
        IPage<Map<String, Object>> pagelist = this.baseMapper.findInventoryCost(page, groupid, marketplaceid, sku,
                shopid, byday);
    ...
    public List<Map<String, Object>> selectInventoryCostAll(String groupid, String marketplaceid, String sku,
        ...
        List<Map<String, Object>> pagelist = this.baseMapper.findInventoryCost(groupid, marketplaceid, sku, shopid,
                byday);
        return pagelist;
    }
}
