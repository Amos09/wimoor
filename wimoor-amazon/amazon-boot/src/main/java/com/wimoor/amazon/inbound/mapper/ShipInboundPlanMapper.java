...
public interface ShipInboundPlanMapper extends BaseMapper<ShipInboundPlan> {
    ...
    List<SummaryShipmentVo> selectitemListByPlanid(@Param("planid") String planid,
            @Param("shipmentid") String shipmentid);

    List<Map<String, Object>> getsumreport(Map<String, Object> param);

    List<Map<String, Object>> getShipRecordByMarket(@Param("marketplaceid") String marketplaceid,
    ...
    List<Map<String, Object>> getShipRecord(@Param("groupid") String groupid,
            @Param("marketplaceid") String marketplaceid, @Param("sku") String sku, @Param("shopid") String shopid);

    List<Map<String, Object>> getShipBadRecord(@Param("marketplaceid") String marketplaceid, @Param("sku") String sku,
