...
public class ShipFormSyncController {
    ...
    public Result<List<ShipInboundShipmenSummarytVo>> getSyncListAction(
    ...
    public Result<ShipInboundShipmenSummarytVo> getUnSyncShipmentAction(
            @ApiParam("店铺ID") @RequestParam String groupid,
            @ApiParam("站点ID") @RequestParam String marketplaceid,
            @ApiParam("货件ID") @RequestParam String shipmentid,
            @ApiParam("仓库ID") @RequestParam String warehouseid) {
        return Result.success(
                shipInboundShipmentService.getUnSyncShipment(groupid, marketplaceid, shipmentid, warehouseid));
    }

    private List<InventoryParameter> fulfillableOut(UserInfo user, ShipInboundPlanDTO plan,
            ShipInboundShipmentDTO shipment) throws BizException {
    ...
    public Result<ShipInboundShipmentDTO> saveShipmentItemAndPlanBathAction(
        ...
        UserInfo user = UserInfoContext.get();
        Result<ShipInboundShipmentDTO> shipmentResult = syncShipmentAction(groupid, marketplaceid, shipmentid,
                warehouseid);
