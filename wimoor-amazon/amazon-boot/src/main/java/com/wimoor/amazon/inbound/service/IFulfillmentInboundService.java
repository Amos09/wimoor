...
public interface IFulfillmentInboundService extends IRunAmazonService {
    ...
    List<ShipInboundShipment> createInboundShipmentPlan(AmazonAuthority auth, Marketplace market,
            ShipInboundPlan inplan);

    void handlerItemResult(AmazonAuthority auth, Marketplace market, GetShipmentItemsResponse result,
    ...
    String getLabelDownloadUR(AmazonAuthority amazonAuthority, String shipmentid, Integer boxnum, String pagetype,
            String labelType, String pannum);
