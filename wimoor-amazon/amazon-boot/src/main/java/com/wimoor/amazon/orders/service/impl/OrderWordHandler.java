...
public class OrderWordHandler {
    ...
    public void setAmzOrderVatInvoiceWord(String shopid, Document document, String orderid, String language,
            ...
            String ordertype, String invoiceno) {
        ...
        try {
            ...
            //处理order的数据和费用信息
            if (orderMain != null) {
                List<AmazonOrdersDetailVo> itemlist = orderManagerService.selectOrderItemDetail(
            ...
            String text1 =
                    OrdersInvoice.getCity() + "," + OrdersInvoice.getProvince() + "," + OrdersInvoice.getCountry() +
            ...
            if (listO != null && listO.size() > 0) {
                for (int i = 0; i < listO.size(); i++) {
                    ...
                    BigDecimal itemprice = new BigDecimal(
                            item.getItemprice() == null ? "0" : item.getItemprice().toString());
