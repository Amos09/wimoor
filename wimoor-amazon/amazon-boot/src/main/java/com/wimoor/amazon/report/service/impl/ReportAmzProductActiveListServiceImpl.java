...
public class ReportAmzProductActiveListServiceImpl extends ReportServiceImpl {
    ...
    /**
     * item-name item-description listing-id seller-sku price quantity open-date image-url item-is-marketplace
     * product-id-type zshop-shipping-fee item-note item-condition zshop-category1 zshop-browse-path
     * zshop-storefront-feature asin1 asin2 asin3 will-ship-internationally expedited-shipping zshop-boldface product-id
     * bid-for-featured-placement add-delete pending-quantity fulfillment-channel Business Price Quantity Price Type
     * Quantity Lower Bound 1 Quantity Price 1 Quantity Lower Bound 2 Quantity Price 2 Quantity Lower Bound 3 Quantity
     * Price 3 Quantity Lower Bound 4 Quantity Price 4 Quantity Lower Bound 5 Quantity Price 5
     *
     * @throws IOException
     */
                ...
                if (lineNumber == 0) {
                    ...
                    if (StrUtil.isNotEmpty(opendate)) {
                        SimpleDateFormat sdf1 = new SimpleDateFormat(
                                "dd/MM/yyyy");// 2019-12-06 03:30:06 PST, 05/09/2018 09:58:06 MEST
                        if (isJP) {
