...
public class CalculateProfitServiceImpl implements ICalculateProfitService {
    ...
    public CostDetail getProfit(ProductInfo info, BigDecimal price, AmazonAuthority auth, DimensionsInfo dim_local,
            BigDecimal cost, String profitcfgid) {
        ...
        fbaFee = iFBAEstimatedFeeService.getOneBySku(info.getSku(), info.getAsin(), auth.getId(),
        ...
        if ("EU".equals(market.getRegion())) {
            ...
            stockCycle = iFBAShipCycleService.getFbaShipCycle(auth.getGroupid(), market.getMarketplaceid(),
                    info.getSku());
        }
        ...
        try {
            ...
            if (fbaFee == null) {
                ...
                if (fbaFee != null && deatail == null) {
                    ...
                    deatail = this.profitService.getProfitByAmazonData(country, profitcfg, inputDimension_local,
                            isMedia,
