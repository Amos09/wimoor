...
public interface ReportRequestRecordMapper extends BaseMapper<ReportRequestRecord> {
    ...
    List<ReportRequestRecord> selectNeedProcessRequest(@Param("reporttype") String reporttype,
            @Param("marketplaceid") String marketplaceid);

    List<ReportRequestRecord> selectNeedRefreshRequest(@Param("reporttype") String reporttype,
            @Param("marketplaceid") String marketplaceid);

    List<ReportRequestRecord> selectByReportType(@Param("sellerid") String sellerid,
    ...
    List<ReportRequestRecord> selectNoTreatReport(@Param("reporttype") String reporttype,
            @Param("marketplaceid") String marketplaceid);

    List<Map<String, Object>> selectTaskInfoList(@Param("sellerid") String sellerid,
            @Param("marketplaceid") String marketplaceid);
}
