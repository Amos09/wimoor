...
public class ProductInfoController {
    ...
    public Result<Item> getAsinItem(String marketplaceid, String asin) {
        ...
        Item response = iProductCatalogItemService.captureCatalogProductDim(amazonAuthority, asin,
                Arrays.asList(marketPlace.getMarketplaceid()));
    ...
    public Result<IPage<AmzProductListVo>> productListAction(@RequestBody ProductListQuery query) {
        ...
        parameter.put("marketplace",
                marketplace != null && !marketplace.isEmpty() && !"all".equals(marketplace) ? marketplace.trim()
                        : null);
