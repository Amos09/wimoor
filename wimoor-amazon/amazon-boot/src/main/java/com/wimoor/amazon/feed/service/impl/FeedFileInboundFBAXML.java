...
public class FeedFileInboundFBAXML {
    ...
    /**
     * 不同提交方式获取箱标的方式不同 POST_FLAT_FILE_FROM_EXCEL_FBA_CREATE_CARTON_INFO  ：SELLER_LABEL
     ...
     * @return
     */
    public static ByteArrayOutputStream getFile(ShipInboundShipment shipment, String sellerid,
            List<ShipInboundCase> boxcase) {
