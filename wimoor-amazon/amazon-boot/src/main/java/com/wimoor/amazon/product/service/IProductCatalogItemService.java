...
public interface IProductCatalogItemService extends IRunAmazonService {
    ...
    void captureCatalogProductSync(AmazonAuthority amazonAuthority, AmzProductRefresh amzProductRefresh,
    ...
    void handlerResult(AmazonAuthority auth, AmzProductRefresh skuRefresh,
            com.amazon.spapi.model.catalogitems.Item result);
