...
public class AmazonAuthorityController {
    ...
    public Result<AmazonAuthority> authSellerAction(String state, String selling_partner_id, String mws_auth_token,
            String spapi_oauth_code) {
        AmazonAuthority result = iAmazonAuthorityService.authSeller(state, selling_partner_id, mws_auth_token,
                spapi_oauth_code);
        if (result != null) {
