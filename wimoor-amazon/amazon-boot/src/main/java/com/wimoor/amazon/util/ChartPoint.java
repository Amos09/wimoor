...
public class ChartPoint {
    ...
    public static List<String> getLabels(String sumtype, Date beginDate, Date endDate) {
        ...
        Calendar c = Calendar.getInstance();
        for (c.setTime(beginDate); checkTimeType(sumtype, c, beginDate, endDate);
                step(sumtype, c, beginDate, endDate)) {
    ...
    public static List<Object> getChartData(String sumtype, List<Map<String, Object>> map, String keyField,
            String feild, Date beginDate, Date endDate) {
    ...
    public static Map<String, Object> generateChartDate(String sumtype, Map<String, Object> map, Date beginDate,
            Date endDate) {
