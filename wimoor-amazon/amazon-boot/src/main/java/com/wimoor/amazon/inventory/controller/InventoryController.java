...
public class InventoryController {
    ...
    public Result<Map<String, InventorySummary>> getInventorySupplyAction(String groupid, String marketplaceid,
            String skuStr) {
    ...
    public Result<Map<String, Object>> findFBAAction(String groupid, String marketplaceid, String sku) {
        ...
        List<ProductInventoryVo> list = inventorySupplyService.findFBA(groupid, marketplaceid, sku, null,
