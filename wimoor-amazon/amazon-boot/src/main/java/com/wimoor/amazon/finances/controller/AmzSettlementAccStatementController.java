...
public class AmzSettlementAccStatementController {
    ...
    public Result<?> findAmzSettlementAccStatementAction(@RequestBody BasePageQuery dto) {
        UserInfo user = UserInfoContext.get();
        List<Map<String, Object>> list = iAmzSettlementAccStatementService.findAmzSettlementAccStatement(
                user.getCompanyid());
    ...
    public Result<?> selectSettlementOpenAction(@RequestBody AmzSettlementDTO dto) {
        UserInfo user = UserInfoContext.get();
        IPage<Map<String, Object>> list = iAmzSettlementAccStatementService.selectSettlementOpen(dto,
                user.getCompanyid());
