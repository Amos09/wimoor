...
public class ProductInPresaleController {
    ...
    public Result<?> getProductPreSalesByMonthAction(@RequestBody ProductPresaleListDTO dto) {
        ...
        List<Map<String, Object>> result = iProductInPresaleService.getProductPreSalesByMonth(sku, marketplaceid,
                groupid);
    ...
    public Result<?> getProductPreSalesAction(@RequestBody ProductPresaleListDTO dto) {
        ...
        List<Map<String, Object>> result = iProductInPresaleService.getProductPreSales(sku, marketplaceid, groupid,
                month);
        return Result.success(result);
    }
