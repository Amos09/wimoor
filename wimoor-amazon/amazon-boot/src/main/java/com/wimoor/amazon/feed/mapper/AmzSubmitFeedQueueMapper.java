...
public interface AmzSubmitFeedQueueMapper extends BaseMapper<AmzSubmitFeedQueue> {
    ...
    AmzSubmitFeedQueue findByMarket(@Param("shopid") String shopId, @Param("authid") String authid,
    ...
    List<AmzSubmitFeedQueue> findQueue(@Param("authorityid") String authid,
            @Param("marketplaceid") String marketplaceid);
