...
public class OrderReportController {
    ...
    public Result<Chart> getSalesLineAction(@RequestBody SalesChartDTO dto) {
        ...
        if (StrUtil.isNotBlank(dto.getSku())) {
            ...
            ChartLine line = iSummaryDataService.findOrderSummaryBySku(dto.getGroupid(), dto.getAmazonAuthId(),
                    dto.getSku(), dto.getParentAsin(), dto.getMarketplaceid(), dto.getDaysize(), dto.getLineType(),
                    userinfo);
            lines.add(line);
            ...
            List<ProductInfo> groupList = iProductInfoService.selectByMSku(dto.getMsku(), dto.getMarketplaceid(),
            ...
            for (ProductInfo item : groupList) {
                ...
                ChartLine line = iSummaryDataService.findOrderSummaryBySku(auth.getGroupid(),
                        item.getAmazonAuthId().toString(), item.getSku(), dto.getParentAsin(), dto.getMarketplaceid(),
                        dto.getDaysize(), dto.getLineType(), userinfo);
                lines.add(line);
