...
public class InboundPlan {
     ...
     * corresponding endpoint. If there is a chosen placement option, only packing options for that placement option
     ...
     * corresponding endpoint. If there is a chosen placement option, that will be the only returned option. Query the
    ...
    /**
     * Shipment IDs for the inbound plan. This property will be populated when it has been generated via the
     * corresponding endpoint. If there is a chosen placement option, only shipments for that option will be returned.
     * If there are confirmed shipments, only those shipments will be returned. Query the shipment for more details.
     *
     * @return shipments
     **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(contactInformation, createdAt, inboundPlanId, lastUpdatedAt, marketplaceIds, name,
                packingOptions, placementOptions, shipments, sourceAddress, status);
    }
