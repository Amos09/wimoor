...
public class ReturnItem {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(sellerReturnItemId, sellerFulfillmentOrderItemId, amazonShipmentId, sellerReturnReasonCode,
                returnComment, amazonReturnReasonCode, status, statusChangedDate, returnAuthorizationId,
                returnReceivedCondition, fulfillmentCenterId);
    }
