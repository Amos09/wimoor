...
public class CompetitivePriceType {
    ...
    /**
     * Indicates the type of customer that the offer is valid for.&lt;br&gt;&lt;br&gt;When the offer type is B2C in a
     * quantity discount, the seller is winning the Buy Box because others do not have inventory at that quantity, not
     * because they have a quantity discount on the ASIN.
     *
     * @return offerType
     **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(competitivePriceId, price, condition, subcondition, offerType, quantityTier,
                quantityDiscountType, sellerId, belongsToRequester);
    }
