...
public class FbaInboundEligibilityApi {
     ...
     * @param marketplaceIds          The identifier for the marketplace in which you want to determine eligibility.
     *                                Required only when program&#x3D;INBOUND. (optional)
    ...
    public ApiResponse<GetItemEligibilityPreviewResponse> getItemEligibilityPreviewWithHttpInfo(String asin,
            String program, List<String> marketplaceIds) throws ApiException, LWAException {
