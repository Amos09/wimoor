...
public class PackageTrackingDetails {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(packageNumber, trackingNumber, customerTrackingLink, carrierCode, carrierPhoneNumber,
                carrierURL, shipDate, estimatedArrivalDate, shipToAddress, currentStatus, currentStatusDescription,
                signedForBy, additionalLocationInfo, trackingEvents);
    }
