...
public class FbaInboundV20240320Api {
     ...
     */
    public com.squareup.okhttp.Call cancelInboundPlanCall(String inboundPlanId,
    ...
    private com.squareup.okhttp.Call cancelInboundPlanValidateBeforeCall(String inboundPlanId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    public ApiResponse<CancelInboundPlanResponse> cancelInboundPlanWithHttpInfo(String inboundPlanId)
        ...
        Type localVarReturnType = new TypeToken<CancelInboundPlanResponse>() {
        }.getType();
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call cancelInboundPlanAsync(String inboundPlanId,
            final ApiCallback<CancelInboundPlanResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = cancelInboundPlanValidateBeforeCall(inboundPlanId, progressListener,
    ...
    public com.squareup.okhttp.Call cancelSelfShipAppointmentCall(String inboundPlanId, String shipmentId,
            CancelSelfShipAppointmentRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call cancelSelfShipAppointmentValidateBeforeCall(String inboundPlanId,
            String shipmentId, CancelSelfShipAppointmentRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = cancelSelfShipAppointmentCall(inboundPlanId, shipmentId, body, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public CancelSelfShipAppointmentResponse cancelSelfShipAppointment(String inboundPlanId, String shipmentId,
            CancelSelfShipAppointmentRequest body) throws ApiException, LWAException {
        ApiResponse<CancelSelfShipAppointmentResponse> resp = cancelSelfShipAppointmentWithHttpInfo(inboundPlanId,
                shipmentId, body);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<CancelSelfShipAppointmentResponse> cancelSelfShipAppointmentWithHttpInfo(String inboundPlanId,
            String shipmentId, CancelSelfShipAppointmentRequest body) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = cancelSelfShipAppointmentValidateBeforeCall(inboundPlanId, shipmentId, body,
                null, null);
        Type localVarReturnType = new TypeToken<CancelSelfShipAppointmentResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Cancels a self-ship appointment slot against a shipment.  **Usage Plan:**  | Rate (requests per
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call cancelSelfShipAppointmentAsync(String inboundPlanId, String shipmentId,
            CancelSelfShipAppointmentRequest body, final ApiCallback<CancelSelfShipAppointmentResponse> callback)
            throws ApiException, LWAException {
    ...
    public com.squareup.okhttp.Call confirmDeliveryWindowOptionsCall(String inboundPlanId, String shipmentId,
            String deliveryWindowOptionId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
        ...
        String localVarPath = "/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation"
                .replaceAll("\\{" + "inboundPlanId" + "\\}", apiClient.escapeString(inboundPlanId.toString()))
                .replaceAll("\\{" + "shipmentId" + "\\}", apiClient.escapeString(shipmentId.toString()))
                .replaceAll("\\{" + "deliveryWindowOptionId" + "\\}",
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call confirmDeliveryWindowOptionsValidateBeforeCall(String inboundPlanId,
            String shipmentId, String deliveryWindowOptionId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = confirmDeliveryWindowOptionsCall(inboundPlanId, shipmentId,
                deliveryWindowOptionId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ConfirmDeliveryWindowOptionsResponse confirmDeliveryWindowOptions(String inboundPlanId, String shipmentId,
            String deliveryWindowOptionId) throws ApiException, LWAException {
        ApiResponse<ConfirmDeliveryWindowOptionsResponse> resp = confirmDeliveryWindowOptionsWithHttpInfo(inboundPlanId,
                shipmentId, deliveryWindowOptionId);
        return resp.getData();
    }
    ...
    public ApiResponse<ConfirmDeliveryWindowOptionsResponse> confirmDeliveryWindowOptionsWithHttpInfo(
        ...
        com.squareup.okhttp.Call call = confirmDeliveryWindowOptionsValidateBeforeCall(inboundPlanId, shipmentId,
                deliveryWindowOptionId, null, null);
        Type localVarReturnType = new TypeToken<ConfirmDeliveryWindowOptionsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call confirmDeliveryWindowOptionsAsync(String inboundPlanId, String shipmentId,
            String deliveryWindowOptionId, final ApiCallback<ConfirmDeliveryWindowOptionsResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call confirmPackingOptionCall(String inboundPlanId, String packingOptionId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call confirmPackingOptionValidateBeforeCall(String inboundPlanId,
            String packingOptionId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = confirmPackingOptionCall(inboundPlanId, packingOptionId, progressListener,
                progressRequestListener);
        return call;
     ...
     * | ---- | | 2 | 2 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits
    ...
    public ConfirmPackingOptionResponse confirmPackingOption(String inboundPlanId, String packingOptionId)
            throws ApiException, LWAException {
        ApiResponse<ConfirmPackingOptionResponse> resp = confirmPackingOptionWithHttpInfo(inboundPlanId,
                packingOptionId);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ConfirmPackingOptionResponse> confirmPackingOptionWithHttpInfo(String inboundPlanId,
            String packingOptionId) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = confirmPackingOptionValidateBeforeCall(inboundPlanId, packingOptionId, null,
                null);
        Type localVarReturnType = new TypeToken<ConfirmPackingOptionResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * | Burst | | ---- | ---- | | 2 | 2 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call confirmPackingOptionAsync(String inboundPlanId, String packingOptionId,
            final ApiCallback<ConfirmPackingOptionResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = confirmPackingOptionValidateBeforeCall(inboundPlanId, packingOptionId,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ConfirmPackingOptionResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     *
     * @param inboundPlanId           Identifier of an inbound plan. (required)
     * @param placementOptionId       The identifier of a placement option. A placement option represents the shipment
     *                                splits and destinations of SKUs. (required)
     * @param progressListener        Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call confirmPlacementOptionCall(String inboundPlanId, String placementOptionId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call confirmPlacementOptionValidateBeforeCall(String inboundPlanId,
            String placementOptionId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = confirmPlacementOptionCall(inboundPlanId, placementOptionId, progressListener,
                progressRequestListener);
        return call;
    ...
    public ConfirmPlacementOptionResponse confirmPlacementOption(String inboundPlanId, String placementOptionId)
            throws ApiException, LWAException {
        ApiResponse<ConfirmPlacementOptionResponse> resp = confirmPlacementOptionWithHttpInfo(inboundPlanId,
                placementOptionId);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ConfirmPlacementOptionResponse> confirmPlacementOptionWithHttpInfo(String inboundPlanId,
            String placementOptionId) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = confirmPlacementOptionValidateBeforeCall(inboundPlanId, placementOptionId, null,
                null);
        Type localVarReturnType = new TypeToken<ConfirmPlacementOptionResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call confirmPlacementOptionAsync(String inboundPlanId, String placementOptionId,
            final ApiCallback<ConfirmPlacementOptionResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = confirmPlacementOptionValidateBeforeCall(inboundPlanId, placementOptionId,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ConfirmPlacementOptionResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
    ...
    public com.squareup.okhttp.Call confirmShipmentContentUpdatePreviewCall(String inboundPlanId, String shipmentId,
            String contentUpdatePreviewId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
        ...
        String localVarPath = "/inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews/{contentUpdatePreviewId}/confirmation"
                .replaceAll("\\{" + "inboundPlanId" + "\\}", apiClient.escapeString(inboundPlanId.toString()))
                .replaceAll("\\{" + "shipmentId" + "\\}", apiClient.escapeString(shipmentId.toString()))
                .replaceAll("\\{" + "contentUpdatePreviewId" + "\\}",
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call confirmShipmentContentUpdatePreviewValidateBeforeCall(String inboundPlanId,
            String shipmentId, String contentUpdatePreviewId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = confirmShipmentContentUpdatePreviewCall(inboundPlanId, shipmentId,
                contentUpdatePreviewId, progressListener, progressRequestListener);
        return call;
     ...
     * (requests per second) | Burst | | ---- | ---- | | 2 | 30 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ConfirmShipmentContentUpdatePreviewResponse confirmShipmentContentUpdatePreview(String inboundPlanId,
            String shipmentId, String contentUpdatePreviewId) throws ApiException, LWAException {
    ...
    public ApiResponse<ConfirmShipmentContentUpdatePreviewResponse> confirmShipmentContentUpdatePreviewWithHttpInfo(
        ...
        com.squareup.okhttp.Call call = confirmShipmentContentUpdatePreviewValidateBeforeCall(inboundPlanId, shipmentId,
                contentUpdatePreviewId, null, null);
        Type localVarReturnType = new TypeToken<ConfirmShipmentContentUpdatePreviewResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Confirm a shipment content update preview and accept the changes in transportation cost.
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call confirmShipmentContentUpdatePreviewAsync(String inboundPlanId, String shipmentId,
            String contentUpdatePreviewId, final ApiCallback<ConfirmShipmentContentUpdatePreviewResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call confirmTransportationOptionsCall(String inboundPlanId,
            ConfirmTransportationOptionsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call confirmTransportationOptionsValidateBeforeCall(String inboundPlanId,
            ConfirmTransportationOptionsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = confirmTransportationOptionsCall(inboundPlanId, body, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ConfirmTransportationOptionsResponse confirmTransportationOptions(String inboundPlanId,
            ConfirmTransportationOptionsRequest body) throws ApiException, LWAException {
        ApiResponse<ConfirmTransportationOptionsResponse> resp = confirmTransportationOptionsWithHttpInfo(inboundPlanId,
                body);
        return resp.getData();
    }
    ...
    public ApiResponse<ConfirmTransportationOptionsResponse> confirmTransportationOptionsWithHttpInfo(
        ...
        Type localVarReturnType = new TypeToken<ConfirmTransportationOptionsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call confirmTransportationOptionsAsync(String inboundPlanId,
            ConfirmTransportationOptionsRequest body, final ApiCallback<ConfirmTransportationOptionsResponse> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = confirmTransportationOptionsValidateBeforeCall(inboundPlanId, body,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ConfirmTransportationOptionsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createInboundPlanCall(CreateInboundPlanRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createInboundPlanValidateBeforeCall(CreateInboundPlanRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    public ApiResponse<CreateInboundPlanResponse> createInboundPlanWithHttpInfo(CreateInboundPlanRequest body)
        ...
        Type localVarReturnType = new TypeToken<CreateInboundPlanResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createInboundPlanAsync(CreateInboundPlanRequest body,
            final ApiCallback<CreateInboundPlanResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = createInboundPlanValidateBeforeCall(body, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<CreateInboundPlanResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createMarketplaceItemLabelsCall(CreateMarketplaceItemLabelsRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createMarketplaceItemLabelsValidateBeforeCall(
            CreateMarketplaceItemLabelsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = createMarketplaceItemLabelsCall(body, progressListener,
                progressRequestListener);
        return call;
    ...
    public ApiResponse<CreateMarketplaceItemLabelsResponse> createMarketplaceItemLabelsWithHttpInfo(
        ...
        Type localVarReturnType = new TypeToken<CreateMarketplaceItemLabelsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createMarketplaceItemLabelsAsync(CreateMarketplaceItemLabelsRequest body,
            final ApiCallback<CreateMarketplaceItemLabelsResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = createMarketplaceItemLabelsValidateBeforeCall(body, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<CreateMarketplaceItemLabelsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call generateDeliveryWindowOptionsCall(String inboundPlanId, String shipmentId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call generateDeliveryWindowOptionsValidateBeforeCall(String inboundPlanId,
            String shipmentId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = generateDeliveryWindowOptionsCall(inboundPlanId, shipmentId, progressListener,
                progressRequestListener);
        return call;
    ...
    public GenerateDeliveryWindowOptionsResponse generateDeliveryWindowOptions(String inboundPlanId, String shipmentId)
            throws ApiException, LWAException {
        ApiResponse<GenerateDeliveryWindowOptionsResponse> resp = generateDeliveryWindowOptionsWithHttpInfo(
    ...
    public ApiResponse<GenerateDeliveryWindowOptionsResponse> generateDeliveryWindowOptionsWithHttpInfo(
        ...
        com.squareup.okhttp.Call call = generateDeliveryWindowOptionsValidateBeforeCall(inboundPlanId, shipmentId, null,
                null);
        Type localVarReturnType = new TypeToken<GenerateDeliveryWindowOptionsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call generateDeliveryWindowOptionsAsync(String inboundPlanId, String shipmentId,
            final ApiCallback<GenerateDeliveryWindowOptionsResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = generateDeliveryWindowOptionsValidateBeforeCall(inboundPlanId, shipmentId,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GenerateDeliveryWindowOptionsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call generatePackingOptionsCall(String inboundPlanId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call generatePackingOptionsValidateBeforeCall(String inboundPlanId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = generatePackingOptionsCall(inboundPlanId, progressListener,
                progressRequestListener);
        return call;
    ...
    public ApiResponse<GeneratePackingOptionsResponse> generatePackingOptionsWithHttpInfo(String inboundPlanId)
        ...
        Type localVarReturnType = new TypeToken<GeneratePackingOptionsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call generatePackingOptionsAsync(String inboundPlanId,
            final ApiCallback<GeneratePackingOptionsResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = generatePackingOptionsValidateBeforeCall(inboundPlanId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<GeneratePackingOptionsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call generatePlacementOptionsCall(String inboundPlanId,
            GeneratePlacementOptionsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call generatePlacementOptionsValidateBeforeCall(String inboundPlanId,
            GeneratePlacementOptionsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = generatePlacementOptionsCall(inboundPlanId, body, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GeneratePlacementOptionsResponse generatePlacementOptions(String inboundPlanId,
            GeneratePlacementOptionsRequest body) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GeneratePlacementOptionsResponse> generatePlacementOptionsWithHttpInfo(String inboundPlanId,
            GeneratePlacementOptionsRequest body) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = generatePlacementOptionsValidateBeforeCall(inboundPlanId, body, null, null);
        Type localVarReturnType = new TypeToken<GeneratePlacementOptionsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call generatePlacementOptionsAsync(String inboundPlanId,
            GeneratePlacementOptionsRequest body, final ApiCallback<GeneratePlacementOptionsResponse> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = generatePlacementOptionsValidateBeforeCall(inboundPlanId, body,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GeneratePlacementOptionsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
    ...
    public com.squareup.okhttp.Call generateSelfShipAppointmentSlotsCall(String inboundPlanId, String shipmentId,
            GenerateSelfShipAppointmentSlotsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call generateSelfShipAppointmentSlotsValidateBeforeCall(String inboundPlanId,
            String shipmentId, GenerateSelfShipAppointmentSlotsRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = generateSelfShipAppointmentSlotsCall(inboundPlanId, shipmentId, body,
                progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Initiates the process of generating the appointment slots list.  **Usage Plan:**  | Rate (requests per second) |
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GenerateSelfShipAppointmentSlotsResponse generateSelfShipAppointmentSlots(String inboundPlanId,
            String shipmentId, GenerateSelfShipAppointmentSlotsRequest body) throws ApiException, LWAException {
        ApiResponse<GenerateSelfShipAppointmentSlotsResponse> resp = generateSelfShipAppointmentSlotsWithHttpInfo(
                inboundPlanId, shipmentId, body);
        return resp.getData();
    }
    ...
    public ApiResponse<GenerateSelfShipAppointmentSlotsResponse> generateSelfShipAppointmentSlotsWithHttpInfo(
            ...
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = generateSelfShipAppointmentSlotsValidateBeforeCall(inboundPlanId, shipmentId,
                body, null, null);
        Type localVarReturnType = new TypeToken<GenerateSelfShipAppointmentSlotsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Initiates the process of generating the appointment slots list.  **Usage Plan:**  | Rate
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call generateSelfShipAppointmentSlotsAsync(String inboundPlanId, String shipmentId,
            GenerateSelfShipAppointmentSlotsRequest body,
            final ApiCallback<GenerateSelfShipAppointmentSlotsResponse> callback) throws ApiException, LWAException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call generateShipmentContentUpdatePreviewsValidateBeforeCall(String inboundPlanId,
            String shipmentId, GenerateShipmentContentUpdatePreviewsRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = generateShipmentContentUpdatePreviewsCall(inboundPlanId, shipmentId, body,
                progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GenerateShipmentContentUpdatePreviewsResponse generateShipmentContentUpdatePreviews(String inboundPlanId,
            String shipmentId, GenerateShipmentContentUpdatePreviewsRequest body) throws ApiException, LWAException {
        ApiResponse<GenerateShipmentContentUpdatePreviewsResponse> resp = generateShipmentContentUpdatePreviewsWithHttpInfo(
                inboundPlanId, shipmentId, body);
        return resp.getData();
    }
    ...
    public ApiResponse<GenerateShipmentContentUpdatePreviewsResponse> generateShipmentContentUpdatePreviewsWithHttpInfo(
            ...
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = generateShipmentContentUpdatePreviewsValidateBeforeCall(inboundPlanId,
                shipmentId, body, null, null);
        Type localVarReturnType = new TypeToken<GenerateShipmentContentUpdatePreviewsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call generateShipmentContentUpdatePreviewsAsync(String inboundPlanId, String shipmentId,
            GenerateShipmentContentUpdatePreviewsRequest body,
        ...
        com.squareup.okhttp.Call call = generateShipmentContentUpdatePreviewsValidateBeforeCall(inboundPlanId,
                shipmentId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GenerateShipmentContentUpdatePreviewsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call generateTransportationOptionsCall(String inboundPlanId,
            GenerateTransportationOptionsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call generateTransportationOptionsValidateBeforeCall(String inboundPlanId,
            GenerateTransportationOptionsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = generateTransportationOptionsCall(inboundPlanId, body, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GenerateTransportationOptionsResponse generateTransportationOptions(String inboundPlanId,
            GenerateTransportationOptionsRequest body) throws ApiException, LWAException {
        ApiResponse<GenerateTransportationOptionsResponse> resp = generateTransportationOptionsWithHttpInfo(
                inboundPlanId, body);
        return resp.getData();
    }
    ...
    public ApiResponse<GenerateTransportationOptionsResponse> generateTransportationOptionsWithHttpInfo(
        ...
        com.squareup.okhttp.Call call = generateTransportationOptionsValidateBeforeCall(inboundPlanId, body, null,
                null);
        Type localVarReturnType = new TypeToken<GenerateTransportationOptionsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Generates available transportation options for a given placement option.  **Usage Plan:**  |
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call generateTransportationOptionsAsync(String inboundPlanId,
            GenerateTransportationOptionsRequest body,
            final ApiCallback<GenerateTransportationOptionsResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = generateTransportationOptionsValidateBeforeCall(inboundPlanId, body,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GenerateTransportationOptionsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getDeliveryChallanDocumentCall(String inboundPlanId, String shipmentId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getDeliveryChallanDocumentValidateBeforeCall(String inboundPlanId,
            String shipmentId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getDeliveryChallanDocumentCall(inboundPlanId, shipmentId, progressListener,
                progressRequestListener);
        return call;
    ...
    /**
     * Provide delivery challan document for PCP transportation in IN marketplace.  **Usage Plan:**  | Rate (requests
    ...
    public GetDeliveryChallanDocumentResponse getDeliveryChallanDocument(String inboundPlanId, String shipmentId)
            throws ApiException, LWAException {
        ApiResponse<GetDeliveryChallanDocumentResponse> resp = getDeliveryChallanDocumentWithHttpInfo(inboundPlanId,
                shipmentId);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GetDeliveryChallanDocumentResponse> getDeliveryChallanDocumentWithHttpInfo(String inboundPlanId,
            String shipmentId) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = getDeliveryChallanDocumentValidateBeforeCall(inboundPlanId, shipmentId, null,
                null);
        Type localVarReturnType = new TypeToken<GetDeliveryChallanDocumentResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getDeliveryChallanDocumentAsync(String inboundPlanId, String shipmentId,
            final ApiCallback<GetDeliveryChallanDocumentResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getDeliveryChallanDocumentValidateBeforeCall(inboundPlanId, shipmentId,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetDeliveryChallanDocumentResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getInboundOperationStatusCall(String operationId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getInboundOperationStatusValidateBeforeCall(String operationId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getInboundOperationStatusCall(operationId, progressListener,
                progressRequestListener);
        return call;
    ...
    public ApiResponse<InboundOperationStatus> getInboundOperationStatusWithHttpInfo(String operationId)
        ...
        Type localVarReturnType = new TypeToken<InboundOperationStatus>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Gets the status of the processing of an asynchronous API call.  **Usage Plan:**  | Rate
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getInboundOperationStatusAsync(String operationId,
            final ApiCallback<InboundOperationStatus> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getInboundOperationStatusValidateBeforeCall(operationId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<InboundOperationStatus>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getInboundPlanCall(String inboundPlanId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getInboundPlanValidateBeforeCall(String inboundPlanId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    public ApiResponse<InboundPlan> getInboundPlanWithHttpInfo(String inboundPlanId) throws ApiException, LWAException {
        ...
        Type localVarReturnType = new TypeToken<InboundPlan>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getInboundPlanAsync(String inboundPlanId, final ApiCallback<InboundPlan> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getInboundPlanValidateBeforeCall(inboundPlanId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<InboundPlan>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @param shipmentId              Identifier of a shipment. A shipment contains the boxes and units being inbounded.
     *                                (required)
     * @param pageSize                The number of self ship appointment slots to return in the response matching the
     *                                given query. (optional, default to 10)
     * @param paginationToken         A token to fetch a certain page when there are multiple pages worth of results.
     *                                The value of this token is fetched from the &#x60;pagination&#x60; returned in the
     *                                API response. In the absence of the token value from the query parameter the API
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getSelfShipAppointmentSlotsCall(String inboundPlanId, String shipmentId,
            Integer pageSize, String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSelfShipAppointmentSlotsValidateBeforeCall(String inboundPlanId,
        ...
        com.squareup.okhttp.Call call = getSelfShipAppointmentSlotsCall(inboundPlanId, shipmentId, pageSize,
                paginationToken, progressListener, progressRequestListener);
        return call;

    }

    /**
     * Retrieves a list of available self-ship appointment slots used to drop off a shipment at a warehouse.  **Usage
     ...
     * @param shipmentId      Identifier of a shipment. A shipment contains the boxes and units being inbounded.
     *                        (required)
     * @param pageSize        The number of self ship appointment slots to return in the response matching the given
     ...
     *                        of this token is fetched from the &#x60;pagination&#x60; returned in the API response. In
     *                        the absence of the token value from the query parameter the API returns the first page of
     *                        the result. (optional)
     * @return GetSelfShipAppointmentSlotsResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GetSelfShipAppointmentSlotsResponse getSelfShipAppointmentSlots(String inboundPlanId, String shipmentId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        ApiResponse<GetSelfShipAppointmentSlotsResponse> resp = getSelfShipAppointmentSlotsWithHttpInfo(inboundPlanId,
                shipmentId, pageSize, paginationToken);
        return resp.getData();
    }
    ...
    public ApiResponse<GetSelfShipAppointmentSlotsResponse> getSelfShipAppointmentSlotsWithHttpInfo(
            ...
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = getSelfShipAppointmentSlotsValidateBeforeCall(inboundPlanId, shipmentId,
                pageSize, paginationToken, null, null);
        Type localVarReturnType = new TypeToken<GetSelfShipAppointmentSlotsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * warehouse.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 6 |  The
     * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the
     * requested operation, when available. The table above indicates the default rate and burst values for this
     * operation. Selling partners whose business demands require higher throughput may see higher rate and burst values
     * than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getSelfShipAppointmentSlotsAsync(String inboundPlanId, String shipmentId,
            Integer pageSize, String paginationToken, final ApiCallback<GetSelfShipAppointmentSlotsResponse> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getSelfShipAppointmentSlotsValidateBeforeCall(inboundPlanId, shipmentId,
                pageSize, paginationToken, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetSelfShipAppointmentSlotsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getShipmentCall(String inboundPlanId, String shipmentId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getShipmentValidateBeforeCall(String inboundPlanId, String shipmentId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getShipmentCall(inboundPlanId, shipmentId, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getShipmentAsync(String inboundPlanId, String shipmentId,
            final ApiCallback<Shipment> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getShipmentValidateBeforeCall(inboundPlanId, shipmentId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<Shipment>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getShipmentContentUpdatePreviewCall(String inboundPlanId, String shipmentId,
            String contentUpdatePreviewId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getShipmentContentUpdatePreviewValidateBeforeCall(String inboundPlanId,
            String shipmentId, String contentUpdatePreviewId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getShipmentContentUpdatePreviewCall(inboundPlanId, shipmentId,
                contentUpdatePreviewId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ContentUpdatePreview getShipmentContentUpdatePreview(String inboundPlanId, String shipmentId,
            String contentUpdatePreviewId) throws ApiException, LWAException {
        ApiResponse<ContentUpdatePreview> resp = getShipmentContentUpdatePreviewWithHttpInfo(inboundPlanId, shipmentId,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ContentUpdatePreview> getShipmentContentUpdatePreviewWithHttpInfo(String inboundPlanId,
            String shipmentId, String contentUpdatePreviewId) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = getShipmentContentUpdatePreviewValidateBeforeCall(inboundPlanId, shipmentId,
                contentUpdatePreviewId, null, null);
        Type localVarReturnType = new TypeToken<ContentUpdatePreview>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * the expiry date specified.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 30 |
     * The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to
     * the requested operation, when available. The table above indicates the default rate and burst values for this
     * operation. Selling partners whose business demands require higher throughput may see higher rate and burst values
     * than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getShipmentContentUpdatePreviewAsync(String inboundPlanId, String shipmentId,
            String contentUpdatePreviewId, final ApiCallback<ContentUpdatePreview> callback)
            throws ApiException, LWAException {
     ...
     * @param pageSize                The number of delivery window options to return in the response matching the given
     *                                query. (optional, default to 10)
     * @param paginationToken         A token to fetch a certain page when there are multiple pages worth of results.
     *                                The value of this token is fetched from the &#x60;pagination&#x60; returned in the
     *                                API response. In the absence of the token value from the query parameter the API
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listDeliveryWindowOptionsValidateBeforeCall(String inboundPlanId,
            String shipmentId, Integer pageSize, String paginationToken,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listDeliveryWindowOptionsCall(inboundPlanId, shipmentId, pageSize,
                paginationToken, progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListDeliveryWindowOptionsResponse listDeliveryWindowOptions(String inboundPlanId, String shipmentId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        ApiResponse<ListDeliveryWindowOptionsResponse> resp = listDeliveryWindowOptionsWithHttpInfo(inboundPlanId,
                shipmentId, pageSize, paginationToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListDeliveryWindowOptionsResponse> listDeliveryWindowOptionsWithHttpInfo(String inboundPlanId,
            String shipmentId, Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listDeliveryWindowOptionsValidateBeforeCall(inboundPlanId, shipmentId, pageSize,
                paginationToken, null, null);
        Type localVarReturnType = new TypeToken<ListDeliveryWindowOptionsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 30 |  The &#x60;x-amzn-RateLimit-Limit&#x60;
     * response header returns the usage plan rate limits that were applied to the requested operation, when available.
     * The table above indicates the default rate and burst values for this operation. Selling partners whose business
     * demands require higher throughput may see higher rate and burst values than those shown here. For more
     * information, refer to [Usage Plans and Rate Limits in the Selling Partner
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listDeliveryWindowOptionsAsync(String inboundPlanId, String shipmentId,
            Integer pageSize, String paginationToken, final ApiCallback<ListDeliveryWindowOptionsResponse> callback)
            throws ApiException, LWAException {
     ...
     *
     * @param inboundPlanId           Identifier of an inbound plan. (required)
     * @param pageSize                The number of boxes to return in the response matching the given query. (optional,
     *                                default to 10)
     * @param paginationToken         A token to fetch a certain page when there are multiple pages worth of results.
     *                                The value of this token is fetched from the &#x60;pagination&#x60; returned in the
     *                                API response. In the absence of the token value from the query parameter the API
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listInboundPlanBoxesCall(String inboundPlanId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listInboundPlanBoxesValidateBeforeCall(String inboundPlanId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listInboundPlanBoxesCall(inboundPlanId, pageSize, paginationToken,
                progressListener, progressRequestListener);
        return call;
     ...
     *
     * @param inboundPlanId   Identifier of an inbound plan. (required)
     * @param pageSize        The number of boxes to return in the response matching the given query. (optional, default
     *                        to 10)
     * @param paginationToken A token to fetch a certain page when there are multiple pages worth of results. The value
     *                        of this token is fetched from the &#x60;pagination&#x60; returned in the API response. In
     *                        the absence of the token value from the query parameter the API returns the first page of
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListInboundPlanBoxesResponse listInboundPlanBoxes(String inboundPlanId, Integer pageSize,
            String paginationToken) throws ApiException, LWAException {
        ApiResponse<ListInboundPlanBoxesResponse> resp = listInboundPlanBoxesWithHttpInfo(inboundPlanId, pageSize,
                paginationToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListInboundPlanBoxesResponse> listInboundPlanBoxesWithHttpInfo(String inboundPlanId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listInboundPlanBoxesValidateBeforeCall(inboundPlanId, pageSize, paginationToken,
                null, null);
        Type localVarReturnType = new TypeToken<ListInboundPlanBoxesResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listInboundPlanBoxesAsync(String inboundPlanId, Integer pageSize,
            String paginationToken, final ApiCallback<ListInboundPlanBoxesResponse> callback)
            throws ApiException, LWAException {
     ...
     *
     * @param inboundPlanId           Identifier of an inbound plan. (required)
     * @param pageSize                The number of items to return in the response matching the given query. (optional,
     *                                default to 10)
     * @param paginationToken         A token to fetch a certain page when there are multiple pages worth of results.
     *                                The value of this token is fetched from the &#x60;pagination&#x60; returned in the
     *                                API response. In the absence of the token value from the query parameter the API
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listInboundPlanItemsCall(String inboundPlanId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listInboundPlanItemsValidateBeforeCall(String inboundPlanId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listInboundPlanItemsCall(inboundPlanId, pageSize, paginationToken,
                progressListener, progressRequestListener);
        return call;
     ...
     *
     * @param inboundPlanId   Identifier of an inbound plan. (required)
     * @param pageSize        The number of items to return in the response matching the given query. (optional, default
     *                        to 10)
     * @param paginationToken A token to fetch a certain page when there are multiple pages worth of results. The value
     *                        of this token is fetched from the &#x60;pagination&#x60; returned in the API response. In
     *                        the absence of the token value from the query parameter the API returns the first page of
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListInboundPlanItemsResponse listInboundPlanItems(String inboundPlanId, Integer pageSize,
            String paginationToken) throws ApiException, LWAException {
        ApiResponse<ListInboundPlanItemsResponse> resp = listInboundPlanItemsWithHttpInfo(inboundPlanId, pageSize,
                paginationToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListInboundPlanItemsResponse> listInboundPlanItemsWithHttpInfo(String inboundPlanId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listInboundPlanItemsValidateBeforeCall(inboundPlanId, pageSize, paginationToken,
                null, null);
        Type localVarReturnType = new TypeToken<ListInboundPlanItemsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Provides a paginated list of item packages in an inbound plan.  **Usage Plan:**  | Rate
     * (requests per second) | Burst | | ---- | ---- | | 2 | 6 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header
     * returns the usage plan rate limits that were applied to the requested operation, when available. The table above
     * indicates the default rate and burst values for this operation. Selling partners whose business demands require
     * higher throughput may see higher rate and burst values than those shown here. For more information, refer to
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listInboundPlanItemsAsync(String inboundPlanId, Integer pageSize,
            String paginationToken, final ApiCallback<ListInboundPlanItemsResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listInboundPlanPalletsCall(String inboundPlanId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listInboundPlanPalletsValidateBeforeCall(String inboundPlanId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listInboundPlanPalletsCall(inboundPlanId, pageSize, paginationToken,
                progressListener, progressRequestListener);
        return call;
     ...
     * related details are provided after generating Less-Than-Truckload (LTL) carrier shipments.  **Usage Plan:**  |
     * Rate (requests per second) | Burst | | ---- | ---- | | 2 | 6 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response
     * header returns the usage plan rate limits that were applied to the requested operation, when available. The table
     * above indicates the default rate and burst values for this operation. Selling partners whose business demands
     * require higher throughput may see higher rate and burst values than those shown here. For more information, refer
     ...
     *
     * @param inboundPlanId   Identifier of an inbound plan. (required)
     * @param pageSize        The number of pallets to return in the response matching the given query. (optional,
     *                        default to 10)
     * @param paginationToken A token to fetch a certain page when there are multiple pages worth of results. The value
     *                        of this token is fetched from the &#x60;pagination&#x60; returned in the API response. In
     *                        the absence of the token value from the query parameter the API returns the first page of
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListInboundPlanPalletsResponse listInboundPlanPallets(String inboundPlanId, Integer pageSize,
            String paginationToken) throws ApiException, LWAException {
        ApiResponse<ListInboundPlanPalletsResponse> resp = listInboundPlanPalletsWithHttpInfo(inboundPlanId, pageSize,
                paginationToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListInboundPlanPalletsResponse> listInboundPlanPalletsWithHttpInfo(String inboundPlanId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listInboundPlanPalletsValidateBeforeCall(inboundPlanId, pageSize,
                paginationToken, null, null);
        Type localVarReturnType = new TypeToken<ListInboundPlanPalletsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listInboundPlanPalletsAsync(String inboundPlanId, Integer pageSize,
            String paginationToken, final ApiCallback<ListInboundPlanPalletsResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listInboundPlansCall(Integer pageSize, String paginationToken, String status,
            String sortBy, String sortOrder, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listInboundPlansValidateBeforeCall(Integer pageSize, String paginationToken,
            String status, String sortBy, String sortOrder,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {

        com.squareup.okhttp.Call call = listInboundPlansCall(pageSize, paginationToken, status, sortBy, sortOrder,
                progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListInboundPlansResponse listInboundPlans(Integer pageSize, String paginationToken, String status,
            String sortBy, String sortOrder) throws ApiException, LWAException {
        ApiResponse<ListInboundPlansResponse> resp = listInboundPlansWithHttpInfo(pageSize, paginationToken, status,
                sortBy, sortOrder);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListInboundPlansResponse> listInboundPlansWithHttpInfo(Integer pageSize, String paginationToken,
            String status, String sortBy, String sortOrder) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listInboundPlansValidateBeforeCall(pageSize, paginationToken, status, sortBy,
                sortOrder, null, null);
        Type localVarReturnType = new TypeToken<ListInboundPlansResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Provides a list of inbound plans with minimal information.  **Usage Plan:**  | Rate (requests
     * per second) | Burst | | ---- | ---- | | 2 | 6 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns
     * the usage plan rate limits that were applied to the requested operation, when available. The table above
     * indicates the default rate and burst values for this operation. Selling partners whose business demands require
     * higher throughput may see higher rate and burst values than those shown here. For more information, refer to
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listInboundPlansAsync(Integer pageSize, String paginationToken, String status,
            String sortBy, String sortOrder, final ApiCallback<ListInboundPlansResponse> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listInboundPlansValidateBeforeCall(pageSize, paginationToken, status, sortBy,
                sortOrder, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListInboundPlansResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
     ...
     *                                (required)
     * @param marketplaceId           The Marketplace ID. Refer to [Marketplace
     *                                IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids) for a list of
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listItemComplianceDetailsCall(List<String> mskus, String marketplaceId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listItemComplianceDetailsValidateBeforeCall(List<String> mskus,
            String marketplaceId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listItemComplianceDetailsCall(mskus, marketplaceId, progressListener,
                progressRequestListener);
        return call;
     ...
     * @param marketplaceId The Marketplace ID. Refer to [Marketplace
     *                      IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids) for a list of possible
     *                      values. (required)
    ...
    public ListItemComplianceDetailsResponse listItemComplianceDetails(List<String> mskus, String marketplaceId)
            throws ApiException, LWAException {
        ApiResponse<ListItemComplianceDetailsResponse> resp = listItemComplianceDetailsWithHttpInfo(mskus,
                marketplaceId);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListItemComplianceDetailsResponse> listItemComplianceDetailsWithHttpInfo(List<String> mskus,
        ...
        Type localVarReturnType = new TypeToken<ListItemComplianceDetailsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listItemComplianceDetailsAsync(List<String> mskus, String marketplaceId,
            final ApiCallback<ListItemComplianceDetailsResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listItemComplianceDetailsValidateBeforeCall(mskus, marketplaceId,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListItemComplianceDetailsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listPackingGroupBoxesCall(String inboundPlanId, String packingGroupId,
            Integer pageSize, String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listPackingGroupBoxesValidateBeforeCall(String inboundPlanId,
            String packingGroupId, Integer pageSize, String paginationToken,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listPackingGroupBoxesCall(inboundPlanId, packingGroupId, pageSize,
                paginationToken, progressListener, progressRequestListener);
        return call;
     ...
     * determines shipment splits.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 30 |
     * The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to
     * the requested operation, when available. The table above indicates the default rate and burst values for this
     * operation. Selling partners whose business demands require higher throughput may see higher rate and burst values
     * than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner
     ...
     * @param inboundPlanId   Identifier of an inbound plan. (required)
     * @param packingGroupId  Identifier of a packing group. (required)
     * @param pageSize        The number of packing group boxes to return in the response matching the given query.
     *                        (optional, default to 10)
     * @param paginationToken A token to fetch a certain page when there are multiple pages worth of results. The value
     *                        of this token is fetched from the &#x60;pagination&#x60; returned in the API response. In
     *                        the absence of the token value from the query parameter the API returns the first page of
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListPackingGroupBoxesResponse listPackingGroupBoxes(String inboundPlanId, String packingGroupId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        ApiResponse<ListPackingGroupBoxesResponse> resp = listPackingGroupBoxesWithHttpInfo(inboundPlanId,
                packingGroupId, pageSize, paginationToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListPackingGroupBoxesResponse> listPackingGroupBoxesWithHttpInfo(String inboundPlanId,
            String packingGroupId, Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listPackingGroupBoxesValidateBeforeCall(inboundPlanId, packingGroupId, pageSize,
                paginationToken, null, null);
        Type localVarReturnType = new TypeToken<ListPackingGroupBoxesResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listPackingGroupBoxesAsync(String inboundPlanId, String packingGroupId,
            Integer pageSize, String paginationToken, final ApiCallback<ListPackingGroupBoxesResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listPackingGroupItemsCall(String inboundPlanId, String packingGroupId,
            Integer pageSize, String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listPackingGroupItemsValidateBeforeCall(String inboundPlanId,
            String packingGroupId, Integer pageSize, String paginationToken,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listPackingGroupItemsCall(inboundPlanId, packingGroupId, pageSize,
                paginationToken, progressListener, progressRequestListener);
        return call;
     ...
     * @param inboundPlanId   Identifier of an inbound plan. (required)
     * @param packingGroupId  Identifier of a packing group. (required)
     * @param pageSize        The number of packing group items to return in the response matching the given query.
     *                        (optional, default to 10)
     * @param paginationToken A token to fetch a certain page when there are multiple pages worth of results. The value
     *                        of this token is fetched from the &#x60;pagination&#x60; returned in the API response. In
     *                        the absence of the token value from the query parameter the API returns the first page of
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListPackingGroupItemsResponse listPackingGroupItems(String inboundPlanId, String packingGroupId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        ApiResponse<ListPackingGroupItemsResponse> resp = listPackingGroupItemsWithHttpInfo(inboundPlanId,
                packingGroupId, pageSize, paginationToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListPackingGroupItemsResponse> listPackingGroupItemsWithHttpInfo(String inboundPlanId,
            String packingGroupId, Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listPackingGroupItemsValidateBeforeCall(inboundPlanId, packingGroupId, pageSize,
                paginationToken, null, null);
        Type localVarReturnType = new TypeToken<ListPackingGroupItemsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listPackingGroupItemsAsync(String inboundPlanId, String packingGroupId,
            Integer pageSize, String paginationToken, final ApiCallback<ListPackingGroupItemsResponse> callback)
            throws ApiException, LWAException {
     ...
     *
     * @param inboundPlanId           Identifier of an inbound plan. (required)
     * @param pageSize                The number of packing options to return in the response matching the given query.
     *                                (optional, default to 10)
     * @param paginationToken         A token to fetch a certain page when there are multiple pages worth of results.
     *                                The value of this token is fetched from the &#x60;pagination&#x60; returned in the
     *                                API response. In the absence of the token value from the query parameter the API
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listPackingOptionsCall(String inboundPlanId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listPackingOptionsValidateBeforeCall(String inboundPlanId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listPackingOptionsCall(inboundPlanId, pageSize, paginationToken,
                progressListener, progressRequestListener);
        return call;
    ...
    public ListPackingOptionsResponse listPackingOptions(String inboundPlanId, Integer pageSize, String paginationToken)
            throws ApiException, LWAException {
        ApiResponse<ListPackingOptionsResponse> resp = listPackingOptionsWithHttpInfo(inboundPlanId, pageSize,
                paginationToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListPackingOptionsResponse> listPackingOptionsWithHttpInfo(String inboundPlanId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listPackingOptionsValidateBeforeCall(inboundPlanId, pageSize, paginationToken,
                null, null);
        Type localVarReturnType = new TypeToken<ListPackingOptionsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * generated by the corresponding operation before becoming available.  **Usage Plan:**  | Rate (requests per
     * second) | Burst | | ---- | ---- | | 2 | 6 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the
     * usage plan rate limits that were applied to the requested operation, when available. The table above indicates
     * the default rate and burst values for this operation. Selling partners whose business demands require higher
     * throughput may see higher rate and burst values than those shown here. For more information, refer to [Usage
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listPackingOptionsAsync(String inboundPlanId, Integer pageSize,
            String paginationToken, final ApiCallback<ListPackingOptionsResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listPlacementOptionsCall(String inboundPlanId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listPlacementOptionsValidateBeforeCall(String inboundPlanId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listPlacementOptionsCall(inboundPlanId, pageSize, paginationToken,
                progressListener, progressRequestListener);
        return call;
     ...
     *
     * @param inboundPlanId   Identifier of an inbound plan. (required)
     * @param pageSize        The number of placement options to return in the response matching the given query.
     *                        (optional, default to 10)
     * @param paginationToken A token to fetch a certain page when there are multiple pages worth of results. The value
     *                        of this token is fetched from the &#x60;pagination&#x60; returned in the API response. In
     *                        the absence of the token value from the query parameter the API returns the first page of
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListPlacementOptionsResponse listPlacementOptions(String inboundPlanId, Integer pageSize,
            String paginationToken) throws ApiException, LWAException {
        ApiResponse<ListPlacementOptionsResponse> resp = listPlacementOptionsWithHttpInfo(inboundPlanId, pageSize,
                paginationToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListPlacementOptionsResponse> listPlacementOptionsWithHttpInfo(String inboundPlanId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listPlacementOptionsValidateBeforeCall(inboundPlanId, pageSize, paginationToken,
                null, null);
        Type localVarReturnType = new TypeToken<ListPlacementOptionsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listPlacementOptionsAsync(String inboundPlanId, Integer pageSize,
            String paginationToken, final ApiCallback<ListPlacementOptionsResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listShipmentBoxesCall(String inboundPlanId, String shipmentId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listShipmentBoxesValidateBeforeCall(String inboundPlanId, String shipmentId,
            Integer pageSize, String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listShipmentBoxesCall(inboundPlanId, shipmentId, pageSize, paginationToken,
                progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListShipmentBoxesResponse listShipmentBoxes(String inboundPlanId, String shipmentId, Integer pageSize,
            String paginationToken) throws ApiException, LWAException {
        ApiResponse<ListShipmentBoxesResponse> resp = listShipmentBoxesWithHttpInfo(inboundPlanId, shipmentId, pageSize,
                paginationToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListShipmentBoxesResponse> listShipmentBoxesWithHttpInfo(String inboundPlanId, String shipmentId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listShipmentBoxesValidateBeforeCall(inboundPlanId, shipmentId, pageSize,
                paginationToken, null, null);
        Type localVarReturnType = new TypeToken<ListShipmentBoxesResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listShipmentBoxesAsync(String inboundPlanId, String shipmentId, Integer pageSize,
            String paginationToken, final ApiCallback<ListShipmentBoxesResponse> callback)
            throws ApiException, LWAException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listShipmentContentUpdatePreviewsValidateBeforeCall(String inboundPlanId,
            String shipmentId, Integer pageSize, String paginationToken,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listShipmentContentUpdatePreviewsCall(inboundPlanId, shipmentId, pageSize,
                paginationToken, progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListShipmentContentUpdatePreviewsResponse listShipmentContentUpdatePreviews(String inboundPlanId,
            String shipmentId, Integer pageSize, String paginationToken) throws ApiException, LWAException {
    ...
    public ApiResponse<ListShipmentContentUpdatePreviewsResponse> listShipmentContentUpdatePreviewsWithHttpInfo(
            String inboundPlanId, String shipmentId, Integer pageSize, String paginationToken)
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listShipmentContentUpdatePreviewsValidateBeforeCall(inboundPlanId, shipmentId,
                pageSize, paginationToken, null, null);
        Type localVarReturnType = new TypeToken<ListShipmentContentUpdatePreviewsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * implications of the change that can only be confirmed prior to the expiry date specified.  **Usage Plan:**  |
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listShipmentContentUpdatePreviewsAsync(String inboundPlanId, String shipmentId,
            Integer pageSize, String paginationToken,
            final ApiCallback<ListShipmentContentUpdatePreviewsResponse> callback) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listShipmentItemsCall(String inboundPlanId, String shipmentId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listShipmentItemsValidateBeforeCall(String inboundPlanId, String shipmentId,
            Integer pageSize, String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listShipmentItemsCall(inboundPlanId, shipmentId, pageSize, paginationToken,
                progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListShipmentItemsResponse listShipmentItems(String inboundPlanId, String shipmentId, Integer pageSize,
            String paginationToken) throws ApiException, LWAException {
        ApiResponse<ListShipmentItemsResponse> resp = listShipmentItemsWithHttpInfo(inboundPlanId, shipmentId, pageSize,
                paginationToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListShipmentItemsResponse> listShipmentItemsWithHttpInfo(String inboundPlanId, String shipmentId,
            Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listShipmentItemsValidateBeforeCall(inboundPlanId, shipmentId, pageSize,
                paginationToken, null, null);
        Type localVarReturnType = new TypeToken<ListShipmentItemsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listShipmentItemsAsync(String inboundPlanId, String shipmentId, Integer pageSize,
            String paginationToken, final ApiCallback<ListShipmentItemsResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listShipmentPalletsCall(String inboundPlanId, String shipmentId, Integer pageSize,
            String paginationToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call listShipmentPalletsValidateBeforeCall(String inboundPlanId, String shipmentId,
        ...
        com.squareup.okhttp.Call call = listShipmentPalletsCall(inboundPlanId, shipmentId, pageSize, paginationToken,
                progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListShipmentPalletsResponse listShipmentPallets(String inboundPlanId, String shipmentId, Integer pageSize,
            String paginationToken) throws ApiException, LWAException {
        ApiResponse<ListShipmentPalletsResponse> resp = listShipmentPalletsWithHttpInfo(inboundPlanId, shipmentId,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListShipmentPalletsResponse> listShipmentPalletsWithHttpInfo(String inboundPlanId,
            String shipmentId, Integer pageSize, String paginationToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listShipmentPalletsValidateBeforeCall(inboundPlanId, shipmentId, pageSize,
                paginationToken, null, null);
        Type localVarReturnType = new TypeToken<ListShipmentPalletsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listShipmentPalletsAsync(String inboundPlanId, String shipmentId, Integer pageSize,
            String paginationToken, final ApiCallback<ListShipmentPalletsResponse> callback)
            throws ApiException, LWAException {
     ...
     *
     * @param inboundPlanId           Identifier of an inbound plan. (required)
     * @param pageSize                The number of transportation options to return in the response matching the given
     *                                query. (optional, default to 10)
     * @param paginationToken         A token to fetch a certain page when there are multiple pages worth of results.
     *                                The value of this token is fetched from the &#x60;pagination&#x60; returned in the
     *                                API response. In the absence of the token value from the query parameter the API
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listTransportationOptionsCall(String inboundPlanId, Integer pageSize,
            String paginationToken, String placementOptionId, String shipmentId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listTransportationOptionsValidateBeforeCall(String inboundPlanId, Integer pageSize,
            String paginationToken, String placementOptionId, String shipmentId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listTransportationOptionsCall(inboundPlanId, pageSize, paginationToken,
                placementOptionId, shipmentId, progressListener, progressRequestListener);
        return call;
     ...
     *                          (optional, default to 10)
     * @param paginationToken   A token to fetch a certain page when there are multiple pages worth of results. The
     *                          value of this token is fetched from the &#x60;pagination&#x60; returned in the API
     *                          response. In the absence of the token value from the query parameter the API returns the
     *                          first page of the result. (optional)
     * @param placementOptionId The placement option to get transportation options for. Either
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListTransportationOptionsResponse listTransportationOptions(String inboundPlanId, Integer pageSize,
            String paginationToken, String placementOptionId, String shipmentId) throws ApiException, LWAException {
        ApiResponse<ListTransportationOptionsResponse> resp = listTransportationOptionsWithHttpInfo(inboundPlanId,
                pageSize, paginationToken, placementOptionId, shipmentId);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListTransportationOptionsResponse> listTransportationOptionsWithHttpInfo(String inboundPlanId,
            Integer pageSize, String paginationToken, String placementOptionId, String shipmentId)
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listTransportationOptionsValidateBeforeCall(inboundPlanId, pageSize,
                paginationToken, placementOptionId, shipmentId, null, null);
        Type localVarReturnType = new TypeToken<ListTransportationOptionsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listTransportationOptionsAsync(String inboundPlanId, Integer pageSize,
            String paginationToken, String placementOptionId, String shipmentId,
            final ApiCallback<ListTransportationOptionsResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listTransportationOptionsValidateBeforeCall(inboundPlanId, pageSize,
                paginationToken, placementOptionId, shipmentId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListTransportationOptionsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    ...
    public com.squareup.okhttp.Call scheduleSelfShipAppointmentCall(String inboundPlanId, String shipmentId,
            String slotId, ScheduleSelfShipAppointmentRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call scheduleSelfShipAppointmentValidateBeforeCall(String inboundPlanId,
            String shipmentId, String slotId, ScheduleSelfShipAppointmentRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = scheduleSelfShipAppointmentCall(inboundPlanId, shipmentId, slotId, body,
                progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Confirms or reschedules a self-ship appointment slot against a shipment.  **Usage Plan:**  | Rate (requests per
     * second) | Burst | | ---- | ---- | | 2 | 2 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the
     * usage plan rate limits that were applied to the requested operation, when available. The table above indicates
     * the default rate and burst values for this operation. Selling partners whose business demands require higher
     * throughput may see higher rate and burst values than those shown here. For more information, refer to [Usage
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ScheduleSelfShipAppointmentResponse scheduleSelfShipAppointment(String inboundPlanId, String shipmentId,
            String slotId, ScheduleSelfShipAppointmentRequest body) throws ApiException, LWAException {
        ApiResponse<ScheduleSelfShipAppointmentResponse> resp = scheduleSelfShipAppointmentWithHttpInfo(inboundPlanId,
                shipmentId, slotId, body);
        return resp.getData();
    }
    ...
    public ApiResponse<ScheduleSelfShipAppointmentResponse> scheduleSelfShipAppointmentWithHttpInfo(
            ...
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = scheduleSelfShipAppointmentValidateBeforeCall(inboundPlanId, shipmentId, slotId,
                body, null, null);
        Type localVarReturnType = new TypeToken<ScheduleSelfShipAppointmentResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Confirms or reschedules a self-ship appointment slot against a shipment.  **Usage Plan:**  |
     * Rate (requests per second) | Burst | | ---- | ---- | | 2 | 2 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response
     * header returns the usage plan rate limits that were applied to the requested operation, when available. The table
     * above indicates the default rate and burst values for this operation. Selling partners whose business demands
     * require higher throughput may see higher rate and burst values than those shown here. For more information, refer
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call scheduleSelfShipAppointmentAsync(String inboundPlanId, String shipmentId,
            String slotId, ScheduleSelfShipAppointmentRequest body,
            final ApiCallback<ScheduleSelfShipAppointmentResponse> callback) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call setPackingInformationCall(String inboundPlanId, SetPackingInformationRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call setPackingInformationValidateBeforeCall(String inboundPlanId,
            SetPackingInformationRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = setPackingInformationCall(inboundPlanId, body, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<SetPackingInformationResponse> setPackingInformationWithHttpInfo(String inboundPlanId,
            SetPackingInformationRequest body) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = setPackingInformationValidateBeforeCall(inboundPlanId, body, null, null);
        Type localVarReturnType = new TypeToken<SetPackingInformationResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * created to populate the box level information required for planning and transportation estimates.  **Usage
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call setPackingInformationAsync(String inboundPlanId, SetPackingInformationRequest body,
            final ApiCallback<SetPackingInformationResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = setPackingInformationValidateBeforeCall(inboundPlanId, body, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<SetPackingInformationResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateInboundPlanNameCall(String inboundPlanId, UpdateInboundPlanNameRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateInboundPlanNameValidateBeforeCall(String inboundPlanId,
            UpdateInboundPlanNameRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateInboundPlanNameCall(inboundPlanId, body, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateInboundPlanNameAsync(String inboundPlanId, UpdateInboundPlanNameRequest body,
            final ApiCallback<Void> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateInboundPlanNameValidateBeforeCall(inboundPlanId, body, progressListener,
                progressRequestListener);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateItemComplianceDetailsCall(String marketplaceId,
            UpdateItemComplianceDetailsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateItemComplianceDetailsValidateBeforeCall(String marketplaceId,
            UpdateItemComplianceDetailsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateItemComplianceDetailsCall(marketplaceId, body, progressListener,
                progressRequestListener);
        return call;
     ...
     * compliance validation.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 2 |  The
     * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the
     * requested operation, when available. The table above indicates the default rate and burst values for this
     * operation. Selling partners whose business demands require higher throughput may see higher rate and burst values
     * than those shown here. For more information, refer to [Usage Plans and Rate Limits in the Selling Partner
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public UpdateItemComplianceDetailsResponse updateItemComplianceDetails(String marketplaceId,
            UpdateItemComplianceDetailsRequest body) throws ApiException, LWAException {
        ApiResponse<UpdateItemComplianceDetailsResponse> resp = updateItemComplianceDetailsWithHttpInfo(marketplaceId,
                body);
        return resp.getData();
    }
    ...
    public ApiResponse<UpdateItemComplianceDetailsResponse> updateItemComplianceDetailsWithHttpInfo(
        ...
        Type localVarReturnType = new TypeToken<UpdateItemComplianceDetailsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Update compliance details for list of MSKUs. The details provided here are only used for the IN
     * marketplace compliance validation.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 2 |
     * 2 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateItemComplianceDetailsAsync(String marketplaceId,
            UpdateItemComplianceDetailsRequest body, final ApiCallback<UpdateItemComplianceDetailsResponse> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateItemComplianceDetailsValidateBeforeCall(marketplaceId, body,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UpdateItemComplianceDetailsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateShipmentNameCall(String inboundPlanId, String shipmentId,
            UpdateShipmentNameRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateShipmentNameValidateBeforeCall(String inboundPlanId, String shipmentId,
            UpdateShipmentNameRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateShipmentNameCall(inboundPlanId, shipmentId, body, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<Void> updateShipmentNameWithHttpInfo(String inboundPlanId, String shipmentId,
            UpdateShipmentNameRequest body) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = updateShipmentNameValidateBeforeCall(inboundPlanId, shipmentId, body, null,
                null);
        return apiClient.execute(call);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateShipmentNameAsync(String inboundPlanId, String shipmentId,
            UpdateShipmentNameRequest body, final ApiCallback<Void> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateShipmentNameValidateBeforeCall(inboundPlanId, shipmentId, body,
                progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateShipmentSourceAddressCall(String inboundPlanId, String shipmentId,
            UpdateShipmentSourceAddressRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateShipmentSourceAddressValidateBeforeCall(String inboundPlanId,
            String shipmentId, UpdateShipmentSourceAddressRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateShipmentSourceAddressCall(inboundPlanId, shipmentId, body,
                progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public UpdateShipmentSourceAddressResponse updateShipmentSourceAddress(String inboundPlanId, String shipmentId,
            UpdateShipmentSourceAddressRequest body) throws ApiException, LWAException {
        ApiResponse<UpdateShipmentSourceAddressResponse> resp = updateShipmentSourceAddressWithHttpInfo(inboundPlanId,
                shipmentId, body);
        return resp.getData();
    }
    ...
    public ApiResponse<UpdateShipmentSourceAddressResponse> updateShipmentSourceAddressWithHttpInfo(
            ...
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = updateShipmentSourceAddressValidateBeforeCall(inboundPlanId, shipmentId, body,
                null, null);
        Type localVarReturnType = new TypeToken<UpdateShipmentSourceAddressResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateShipmentSourceAddressAsync(String inboundPlanId, String shipmentId,
            UpdateShipmentSourceAddressRequest body, final ApiCallback<UpdateShipmentSourceAddressResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateShipmentTrackingDetailsCall(String inboundPlanId, String shipmentId,
            UpdateShipmentTrackingDetailsRequest body, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateShipmentTrackingDetailsValidateBeforeCall(String inboundPlanId,
            String shipmentId, UpdateShipmentTrackingDetailsRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateShipmentTrackingDetailsCall(inboundPlanId, shipmentId, body,
                progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public UpdateShipmentTrackingDetailsResponse updateShipmentTrackingDetails(String inboundPlanId, String shipmentId,
            UpdateShipmentTrackingDetailsRequest body) throws ApiException, LWAException {
        ApiResponse<UpdateShipmentTrackingDetailsResponse> resp = updateShipmentTrackingDetailsWithHttpInfo(
                inboundPlanId, shipmentId, body);
        return resp.getData();
    }
    ...
    public ApiResponse<UpdateShipmentTrackingDetailsResponse> updateShipmentTrackingDetailsWithHttpInfo(
            ...
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = updateShipmentTrackingDetailsValidateBeforeCall(inboundPlanId, shipmentId, body,
                null, null);
        Type localVarReturnType = new TypeToken<UpdateShipmentTrackingDetailsResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Updates a shipment&#39;s tracking details.  **Usage Plan:**  | Rate (requests per second) |
     * Burst | | ---- | ---- | | 2 | 2 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan
     * rate limits that were applied to the requested operation, when available. The table above indicates the default
     * rate and burst values for this operation. Selling partners whose business demands require higher throughput may
     * see higher rate and burst values than those shown here. For more information, refer to [Usage Plans and Rate
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateShipmentTrackingDetailsAsync(String inboundPlanId, String shipmentId,
            UpdateShipmentTrackingDetailsRequest body,
            final ApiCallback<UpdateShipmentTrackingDetailsResponse> callback) throws ApiException, LWAException {
