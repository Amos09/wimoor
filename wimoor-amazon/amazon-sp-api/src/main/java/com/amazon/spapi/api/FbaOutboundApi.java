...
public class FbaOutboundApi {
     ...
     */
    public com.squareup.okhttp.Call cancelFulfillmentOrderCall(String sellerFulfillmentOrderId,
        ...
        String localVarPath = "/fba/outbound/2020-07-01/fulfillmentOrders/{sellerFulfillmentOrderId}/cancel"
                .replaceAll("\\{" + "sellerFulfillmentOrderId" + "\\}",
    ...
    private com.squareup.okhttp.Call cancelFulfillmentOrderValidateBeforeCall(String sellerFulfillmentOrderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = cancelFulfillmentOrderCall(sellerFulfillmentOrderId, progressListener,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call cancelFulfillmentOrderAsync(String sellerFulfillmentOrderId,
            final ApiCallback<CancelFulfillmentOrderResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = cancelFulfillmentOrderValidateBeforeCall(sellerFulfillmentOrderId,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createFulfillmentOrderCall(CreateFulfillmentOrderRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createFulfillmentOrderValidateBeforeCall(CreateFulfillmentOrderRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
     ...
     * network to a destination address.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 2 |
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createFulfillmentOrderAsync(CreateFulfillmentOrderRequest body,
            final ApiCallback<CreateFulfillmentOrderResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = createFulfillmentOrderValidateBeforeCall(body, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<CreateFulfillmentOrderResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     *                                 created. The seller uses their own records to find the correct
     *                                 SellerFulfillmentOrderId value based on the buyer&#39;s request to return items.
     *                                 (required)
     * @param progressListener         Progress listener
     * @param progressRequestListener  Progress request listener
     * @return Call to execute
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createFulfillmentReturnCall(CreateFulfillmentReturnRequest body,
            String sellerFulfillmentOrderId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createFulfillmentReturnValidateBeforeCall(CreateFulfillmentReturnRequest body,
            String sellerFulfillmentOrderId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = createFulfillmentReturnCall(body, sellerFulfillmentOrderId, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public CreateFulfillmentReturnResponse createFulfillmentReturn(CreateFulfillmentReturnRequest body,
            String sellerFulfillmentOrderId) throws ApiException, LWAException {
        ApiResponse<CreateFulfillmentReturnResponse> resp = createFulfillmentReturnWithHttpInfo(body,
    ...
    public ApiResponse<CreateFulfillmentReturnResponse> createFulfillmentReturnWithHttpInfo(
        ...
        com.squareup.okhttp.Call call = createFulfillmentReturnValidateBeforeCall(body, sellerFulfillmentOrderId, null,
                null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createFulfillmentReturnAsync(CreateFulfillmentReturnRequest body,
            String sellerFulfillmentOrderId, final ApiCallback<CreateFulfillmentReturnResponse> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = createFulfillmentReturnValidateBeforeCall(body, sellerFulfillmentOrderId,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CreateFulfillmentReturnResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     *
     * @param marketplaceId           The marketplace for which to return a list of the inventory that is eligible for
     *                                the specified feature. (required)
     * @param featureName             The name of the feature for which to return a list of eligible inventory.
     *                                (required)
     * @param nextToken               A string token returned in the response to your previous request that is used to
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFeatureInventoryCall(String marketplaceId, String featureName, String nextToken,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getFeatureInventoryValidateBeforeCall(String marketplaceId, String featureName,
            String nextToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getFeatureInventoryCall(marketplaceId, featureName, nextToken, progressListener,
                progressRequestListener);
        return call;
     ...
     * @param nextToken     A string token returned in the response to your previous request that is used to return the
     *                      next response page. A value of null will return the first page. (optional)
     * @return GetFeatureInventoryResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GetFeatureInventoryResponse getFeatureInventory(String marketplaceId, String featureName, String nextToken)
            throws ApiException, LWAException {
        ApiResponse<GetFeatureInventoryResponse> resp = getFeatureInventoryWithHttpInfo(marketplaceId, featureName,
                nextToken);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GetFeatureInventoryResponse> getFeatureInventoryWithHttpInfo(String marketplaceId,
            String featureName, String nextToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = getFeatureInventoryValidateBeforeCall(marketplaceId, featureName, nextToken,
                null, null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFeatureInventoryAsync(String marketplaceId, String featureName, String nextToken,
            final ApiCallback<GetFeatureInventoryResponse> callback) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFeatureSKUCall(String marketplaceId, String featureName, String sellerSku,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getFeatureSKUValidateBeforeCall(String marketplaceId, String featureName,
        ...
        com.squareup.okhttp.Call call = getFeatureSKUCall(marketplaceId, featureName, sellerSku, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GetFeatureSkuResponse> getFeatureSKUWithHttpInfo(String marketplaceId, String featureName,
            String sellerSku) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = getFeatureSKUValidateBeforeCall(marketplaceId, featureName, sellerSku, null,
                null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFeatureSKUAsync(String marketplaceId, String featureName, String sellerSku,
            final ApiCallback<GetFeatureSkuResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getFeatureSKUValidateBeforeCall(marketplaceId, featureName, sellerSku,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetFeatureSkuResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFeaturesCall(String marketplaceId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getFeaturesValidateBeforeCall(String marketplaceId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
     ...
     * whether the seller for which you made the call is enrolled for each feature.  **Usage Plan:**  | Rate (requests
     ...
     * specify, and whether the seller for which you made the call is enrolled for each feature.  **Usage Plan:**  |
     * Rate (requests per second) | Burst | | ---- | ---- | | 2 | 30 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response
     * header returns the usage plan rate limits that were applied to the requested operation, when available. The table
     * above indicates the default rate and burst values for this operation. Selling partners whose business demands
     * require higher throughput may see higher rate and burst values than those shown here. For more information, see
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFeaturesAsync(String marketplaceId,
            final ApiCallback<GetFeaturesResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getFeaturesValidateBeforeCall(marketplaceId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<GetFeaturesResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFulfillmentOrderCall(String sellerFulfillmentOrderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getFulfillmentOrderValidateBeforeCall(String sellerFulfillmentOrderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getFulfillmentOrderCall(sellerFulfillmentOrderId, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFulfillmentOrderAsync(String sellerFulfillmentOrderId,
            final ApiCallback<GetFulfillmentOrderResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getFulfillmentOrderValidateBeforeCall(sellerFulfillmentOrderId,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetFulfillmentOrderResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFulfillmentPreviewCall(GetFulfillmentPreviewRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getFulfillmentPreviewValidateBeforeCall(GetFulfillmentPreviewRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    /**
     * Returns a list of fulfillment order previews based on shipping criteria that you specify.  **Usage Plan:**  |
     * Rate (requests per second) | Burst | | ---- | ---- | | 2 | 30 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response
     * header returns the usage plan rate limits that were applied to the requested operation, when available. The table
     * above indicates the default rate and burst values for this operation. Selling partners whose business demands
     * require higher throughput may see higher rate and burst values than those shown here. For more information, see
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFulfillmentPreviewAsync(GetFulfillmentPreviewRequest body,
            final ApiCallback<GetFulfillmentPreviewResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getFulfillmentPreviewValidateBeforeCall(body, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<GetFulfillmentPreviewResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getPackageTrackingDetailsCall(Integer packageNumber,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPackageTrackingDetailsValidateBeforeCall(Integer packageNumber,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getPackageTrackingDetailsCall(packageNumber, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getPackageTrackingDetailsAsync(Integer packageNumber,
            final ApiCallback<GetPackageTrackingDetailsResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getPackageTrackingDetailsValidateBeforeCall(packageNumber, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<GetPackageTrackingDetailsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     *
     * @param queryStartDate          A date used to select fulfillment orders that were last updated after (or at) a
     *                                specified time. An update is defined as any change in fulfillment order status,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listAllFulfillmentOrdersCall(OffsetDateTime queryStartDate, String nextToken,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listAllFulfillmentOrdersValidateBeforeCall(OffsetDateTime queryStartDate,
            String nextToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {

        com.squareup.okhttp.Call call = listAllFulfillmentOrdersCall(queryStartDate, nextToken, progressListener,
                progressRequestListener);
        return call;
     ...
     *                       time. An update is defined as any change in fulfillment order status, including the
     *                       creation of a new fulfillment order. (optional)
     * @param nextToken      A string token returned in the response to your previous request. (optional)
    ...
    public ListAllFulfillmentOrdersResponse listAllFulfillmentOrders(OffsetDateTime queryStartDate, String nextToken)
            throws ApiException, LWAException {
        ApiResponse<ListAllFulfillmentOrdersResponse> resp = listAllFulfillmentOrdersWithHttpInfo(queryStartDate,
                nextToken);
        return resp.getData();
    }
    ...
    public ApiResponse<ListAllFulfillmentOrdersResponse> listAllFulfillmentOrdersWithHttpInfo(
        ...
        com.squareup.okhttp.Call call = listAllFulfillmentOrdersValidateBeforeCall(queryStartDate, nextToken, null,
                null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listAllFulfillmentOrdersAsync(OffsetDateTime queryStartDate, String nextToken,
            final ApiCallback<ListAllFulfillmentOrdersResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listAllFulfillmentOrdersValidateBeforeCall(queryStartDate, nextToken,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListAllFulfillmentOrdersResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @param language                 The language that the TranslatedDescription property of the ReasonCodeDetails
     *                                 response object should be translated into. (required)
     * @param marketplaceId            The marketplace for which the seller wants return reason codes. (optional)
     * @param sellerFulfillmentOrderId The identifier assigned to the item by the seller when the fulfillment order was
     *                                 created. The service uses this value to determine the marketplace for which the
     *                                 seller wants return reason codes. (optional)
     * @param progressListener         Progress listener
     * @param progressRequestListener  Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listReturnReasonCodesCall(String sellerSku, String language, String marketplaceId,
            String sellerFulfillmentOrderId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listReturnReasonCodesValidateBeforeCall(String sellerSku, String language,
            String marketplaceId, String sellerFulfillmentOrderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        if (language == null) {
            throw new ApiException(
                    "Missing the required parameter 'language' when calling listReturnReasonCodes(Async)");
        }

        com.squareup.okhttp.Call call = listReturnReasonCodesCall(sellerSku, language, marketplaceId,
     ...
     * [URL Encoding](https://developer-docs.amazon.com/sp-api/docs/url-encoding).  **Usage Plan:**  | Rate (requests
     * per second) | Burst | | ---- | ---- | | 2 | 30 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns
     * the usage plan rate limits that were applied to the requested operation, when available. The table above
     * indicates the default rate and burst values for this operation. Selling partners whose business demands require
     * higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListReturnReasonCodesResponse listReturnReasonCodes(String sellerSku, String language, String marketplaceId,
            String sellerFulfillmentOrderId) throws ApiException, LWAException {
        ApiResponse<ListReturnReasonCodesResponse> resp = listReturnReasonCodesWithHttpInfo(sellerSku, language,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListReturnReasonCodesResponse> listReturnReasonCodesWithHttpInfo(String sellerSku,
            String language, String marketplaceId, String sellerFulfillmentOrderId) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = listReturnReasonCodesValidateBeforeCall(sellerSku, language, marketplaceId,
                sellerFulfillmentOrderId, null, null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listReturnReasonCodesAsync(String sellerSku, String language, String marketplaceId,
            String sellerFulfillmentOrderId, final ApiCallback<ListReturnReasonCodesResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call submitFulfillmentOrderStatusUpdateCall(String sellerFulfillmentOrderId,
    ...
    private com.squareup.okhttp.Call submitFulfillmentOrderStatusUpdateValidateBeforeCall(
            String sellerFulfillmentOrderId, SubmitFulfillmentOrderStatusUpdateRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = submitFulfillmentOrderStatusUpdateCall(sellerFulfillmentOrderId, body,
                progressListener, progressRequestListener);
        return call;
    ...
    public SubmitFulfillmentOrderStatusUpdateResponse submitFulfillmentOrderStatusUpdate(
            String sellerFulfillmentOrderId, SubmitFulfillmentOrderStatusUpdateRequest body)
            throws ApiException, LWAException {
        ApiResponse<SubmitFulfillmentOrderStatusUpdateResponse> resp = submitFulfillmentOrderStatusUpdateWithHttpInfo(
    ...
    public ApiResponse<SubmitFulfillmentOrderStatusUpdateResponse> submitFulfillmentOrderStatusUpdateWithHttpInfo(
            String sellerFulfillmentOrderId, SubmitFulfillmentOrderStatusUpdateRequest body)
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = submitFulfillmentOrderStatusUpdateValidateBeforeCall(sellerFulfillmentOrderId,
                body, null, null);
        Type localVarReturnType = new TypeToken<SubmitFulfillmentOrderStatusUpdateResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call submitFulfillmentOrderStatusUpdateAsync(String sellerFulfillmentOrderId,
            SubmitFulfillmentOrderStatusUpdateRequest body,
            final ApiCallback<SubmitFulfillmentOrderStatusUpdateResponse> callback) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateFulfillmentOrderCall(UpdateFulfillmentOrderRequest body,
            String sellerFulfillmentOrderId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateFulfillmentOrderValidateBeforeCall(UpdateFulfillmentOrderRequest body,
            String sellerFulfillmentOrderId, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateFulfillmentOrderCall(body, sellerFulfillmentOrderId, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public UpdateFulfillmentOrderResponse updateFulfillmentOrder(UpdateFulfillmentOrderRequest body,
            String sellerFulfillmentOrderId) throws ApiException, LWAException {
        ApiResponse<UpdateFulfillmentOrderResponse> resp = updateFulfillmentOrderWithHttpInfo(body,
                sellerFulfillmentOrderId);
        return resp.getData();
    }
    ...
    public ApiResponse<UpdateFulfillmentOrderResponse> updateFulfillmentOrderWithHttpInfo(
        ...
        com.squareup.okhttp.Call call = updateFulfillmentOrderValidateBeforeCall(body, sellerFulfillmentOrderId, null,
                null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateFulfillmentOrderAsync(UpdateFulfillmentOrderRequest body,
            String sellerFulfillmentOrderId, final ApiCallback<UpdateFulfillmentOrderResponse> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateFulfillmentOrderValidateBeforeCall(body, sellerFulfillmentOrderId,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UpdateFulfillmentOrderResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
