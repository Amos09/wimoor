...
public class CreateShipmentRequest {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(shipmentRequestDetails, shippingServiceId, shippingServiceOfferId, hazmatType,
                labelFormatOption, shipmentLevelSellerInputsList);
    }
    ...
    public String toString() {
        ...
        sb.append("    shipmentLevelSellerInputsList: ").append(toIndentedString(shipmentLevelSellerInputsList))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
