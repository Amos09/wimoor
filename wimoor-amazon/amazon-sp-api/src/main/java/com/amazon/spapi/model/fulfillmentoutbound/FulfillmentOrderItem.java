...
public class FulfillmentOrderItem {
     ...
     * estimatedShipDate is not returned.
     *
     ...
     * shipment that contains the item quantity has been cancelled, estimatedArrivalDate is not returned.
     *
    ...
    public int hashCode() {
        return Objects.hash(sellerSku, sellerFulfillmentOrderItemId, quantity, giftMessage, displayableComment,
                fulfillmentNetworkSku, orderItemDisposition, cancelledQuantity, unfulfillableQuantity,
                estimatedShipDate, estimatedArrivalDate, perUnitPrice, perUnitTax, perUnitDeclaredValue);
    }
