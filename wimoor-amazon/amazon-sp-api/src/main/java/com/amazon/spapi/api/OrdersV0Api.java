...
public class OrdersV0Api {
     ...
     */
    public com.squareup.okhttp.Call confirmShipmentCall(String orderId, ConfirmShipmentRequest payload,
    ...
    private com.squareup.okhttp.Call confirmShipmentValidateBeforeCall(String orderId, ConfirmShipmentRequest payload,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = confirmShipmentCall(orderId, payload, progressListener,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<Void> confirmShipmentWithHttpInfo(String orderId, ConfirmShipmentRequest payload)
            throws ApiException, LWAException {
    ...
    /**
     * (asynchronously) Updates the shipment confirmation status for a specified order.  **Usage Plan:**  | Rate
     * (requests per second) | Burst | | ---- | ---- | | 2 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call confirmShipmentAsync(String orderId, ConfirmShipmentRequest payload,
        ...
        com.squareup.okhttp.Call call = confirmShipmentValidateBeforeCall(orderId, payload, progressListener,
                progressRequestListener);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderCall(String orderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOrderValidateBeforeCall(String orderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderAsync(String orderId, final ApiCallback<GetOrderResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderAddressCall(String orderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOrderAddressValidateBeforeCall(String orderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
     ...
     * per second) | Burst | | ---- | ---- | | 0.0167 | 20 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderAddressAsync(String orderId,
            final ApiCallback<GetOrderAddressResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getOrderAddressValidateBeforeCall(orderId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<GetOrderAddressResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderBuyerInfoCall(String orderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOrderBuyerInfoValidateBeforeCall(String orderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
     ...
     * second) | Burst | | ---- | ---- | | 0.0167 | 20 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderBuyerInfoAsync(String orderId,
            final ApiCallback<GetOrderBuyerInfoResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getOrderBuyerInfoValidateBeforeCall(orderId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<GetOrderBuyerInfoResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderItemsCall(String orderId, String nextToken,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOrderItemsValidateBeforeCall(String orderId, String nextToken,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getOrderItemsCall(orderId, nextToken, progressListener,
                progressRequestListener);
        return call;
    ...
    /**
     * (asynchronously) Returns detailed order item information for the order that you specify. If NextToken is
     * provided, it&#39;s used to retrieve the next page of order items.  __Note__: When an order is in the Pending
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderItemsAsync(String orderId, String nextToken,
            final ApiCallback<GetOrderItemsResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getOrderItemsValidateBeforeCall(orderId, nextToken, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<GetOrderItemsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderItemsBuyerInfoCall(String orderId, String nextToken,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOrderItemsBuyerInfoValidateBeforeCall(String orderId, String nextToken,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getOrderItemsBuyerInfoCall(orderId, nextToken, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GetOrderItemsBuyerInfoResponse> getOrderItemsBuyerInfoWithHttpInfo(String orderId,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderItemsBuyerInfoAsync(String orderId, String nextToken,
            final ApiCallback<GetOrderItemsBuyerInfoResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getOrderItemsBuyerInfoValidateBeforeCall(orderId, nextToken, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<GetOrderItemsBuyerInfoResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderRegulatedInfoCall(String orderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOrderRegulatedInfoValidateBeforeCall(String orderId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrderRegulatedInfoAsync(String orderId,
            final ApiCallback<GetOrderRegulatedInfoResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getOrderRegulatedInfoValidateBeforeCall(orderId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<GetOrderRegulatedInfoResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     *
     * @param marketplaceIds                  A list of MarketplaceId values. Used to select orders that were placed in
     *                                        the specified marketplaces.  Refer to [Marketplace
     *                                        IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids) for a
     *                                        complete list of marketplaceId values. (required)
     * @param createdAfter                    A date used for selecting orders created after (or at) a specified time.
     ...
     *                                        cannot be empty. The date must be in &lt;a
     *                                        href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO
     *                                        8601&lt;/a&gt; format. (optional)
     * @param createdBefore                   A date used for selecting orders created before (or at) a specified time.
     *                                        Only orders placed before the specified time are returned. The date must
     *                                        be in &lt;a
     *                                        href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO
     *                                        8601&lt;/a&gt; format. (optional)
     * @param lastUpdatedAfter                A date used for selecting orders that were last updated after (or at) a
     ...
     *                                        by the seller. The date must be in &lt;a
     *                                        href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO
     *                                        8601&lt;/a&gt; format. (optional)
     * @param lastUpdatedBefore               A date used for selecting orders that were last updated before (or at) a
     *                                        specified time. An update is defined as any change in order status,
     *                                        including the creation of a new order. Includes updates made by Amazon and
     *                                        by the seller. The date must be in &lt;a
     *                                        href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO
     ...
     *                                        **Possible values:** - &#x60;PendingAvailability&#x60; (This status is
     *                                        available for pre-orders only. The order has been placed, payment has not
     *                                        been authorized, and the release date of the item is in the future.) -
     *                                        &#x60;Pending&#x60; (The order has been placed but payment has not been
     *                                        authorized.) - &#x60;Unshipped&#x60; (Payment has been authorized and the
     *                                        order is ready for shipment, but no items in the order have been shipped.)
     *                                        - &#x60;PartiallyShipped&#x60; (One or more, but not all, items in the
     *                                        order have been shipped.) - &#x60;Shipped&#x60; (All items in the order
     *                                        have been shipped.) - &#x60;InvoiceUnconfirmed&#x60; (All items in the
     *                                        order have been shipped. The seller has not yet given confirmation to
     *                                        Amazon that the invoice has been shipped to the buyer.) -
     *                                        &#x60;Canceled&#x60; (The order has been canceled.) -
     *                                        &#x60;Unfulfillable&#x60; (The order cannot be fulfilled. This state
     *                                        applies only to Multi-Channel Fulfillment orders.) (optional)
     * @param fulfillmentChannels             A list that indicates how an order was fulfilled. Filters the results by
     *                                        fulfillment channel. Possible values: AFN (Fulfillment by Amazon); MFN
     *                                        (Fulfilled by the seller). (optional)
     * @param paymentMethods                  A list of payment method values. Used to select orders paid using the
     ...
     * @param maxResultsPerPage               A number that indicates the maximum number of orders that can be returned
     *                                        per page. Value must be 1 - 100. Default 100. (optional)
     * @param easyShipShipmentStatuses        A list of &#x60;EasyShipShipmentStatus&#x60; values. Used to select Easy
     *                                        Ship orders with statuses that match the specified values. If
     *                                        &#x60;EasyShipShipmentStatus&#x60; is specified, only Amazon Easy Ship
     *                                        orders are returned.  **Possible values:** - &#x60;PendingSchedule&#x60;
     *                                        (The package is awaiting the schedule for pick-up.) -
     *                                        &#x60;PendingPickUp&#x60; (Amazon has not yet picked up the package from
     *                                        the seller.) - &#x60;PendingDropOff&#x60; (The seller will deliver the
     *                                        package to the carrier.) - &#x60;LabelCanceled&#x60; (The seller canceled
     *                                        the pickup.) - &#x60;PickedUp&#x60; (Amazon has picked up the package from
     *                                        the seller.) - &#x60;DroppedOff&#x60; (The package is delivered to the
     *                                        carrier by the seller.) - &#x60;AtOriginFC&#x60; (The packaged is at the
     *                                        origin fulfillment center.) - &#x60;AtDestinationFC&#x60; (The package is
     *                                        at the destination fulfillment center.) - &#x60;Delivered&#x60; (The
     *                                        package has been delivered.) - &#x60;RejectedByBuyer&#x60; (The package
     *                                        has been rejected by the buyer.) - &#x60;Undeliverable&#x60; (The package
     *                                        cannot be delivered.) - &#x60;ReturningToSeller&#x60; (The package was not
     *                                        delivered and is being returned to the seller.) -
     *                                        &#x60;ReturnedToSeller&#x60; (The package was not delivered and was
     *                                        returned to the seller.) - &#x60;Lost&#x60; (The package is lost.) -
     *                                        &#x60;OutForDelivery&#x60; (The package is out for delivery.) -
     *                                        &#x60;Damaged&#x60; (The package was damaged by the carrier.) (optional)
     * @param electronicInvoiceStatuses       A list of &#x60;ElectronicInvoiceStatus&#x60; values. Used to select
     *                                        orders with electronic invoice statuses that match the specified values.
     *                                        **Possible values:** - &#x60;NotRequired&#x60; (Electronic invoice
     *                                        submission is not required for this order.) - &#x60;NotFound&#x60; (The
     *                                        electronic invoice was not submitted for this order.) -
     *                                        &#x60;Processing&#x60; (The electronic invoice is being processed for this
     *                                        order.) - &#x60;Errored&#x60; (The last submitted electronic invoice was
     *                                        rejected for this order.) - &#x60;Accepted&#x60; (The last submitted
     *                                        electronic invoice was submitted and accepted.) (optional)
     * @param nextToken                       A string token returned in the response of your previous request.
     *                                        (optional)
     * @param amazonOrderIds                  A list of AmazonOrderId values. An AmazonOrderId is an Amazon-defined
     *                                        order identifier, in 3-7-7 format. (optional)
     * @param actualFulfillmentSupplySourceId Denotes the recommended sourceId where the order should be fulfilled from.
     *                                        (optional)
     * @param isISPU                          When true, this order is marked to be picked up from a store rather than
     *                                        delivered. (optional)
     * @param storeChainStoreId               The store chain store identifier. Linked to a specific store in a store
     *                                        chain. (optional)
     * @param earliestDeliveryDateBefore      A date used for selecting orders with a earliest delivery date before (or
     *                                        at) a specified time. The date must be in &lt;a
     *                                        href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO
     *                                        8601&lt;/a&gt; format. (optional)
     * @param earliestDeliveryDateAfter       A date used for selecting orders with a earliest delivery date after (or
     *                                        at) a specified time. The date must be in &lt;a
     *                                        href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO
     *                                        8601&lt;/a&gt; format. (optional)
     * @param latestDeliveryDateBefore        A date used for selecting orders with a latest delivery date before (or
     *                                        at) a specified time. The date must be in &lt;a
     *                                        href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO
     *                                        8601&lt;/a&gt; format. (optional)
     * @param latestDeliveryDateAfter         A date used for selecting orders with a latest delivery date after (or at)
     *                                        a specified time. The date must be in &lt;a
     *                                        href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO
     *                                        8601&lt;/a&gt; format. (optional)
     * @param progressListener                Progress listener
     * @param progressRequestListener         Progress request listener
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrdersCall(List<String> marketplaceIds, String createdAfter,
            String createdBefore, String lastUpdatedAfter, String lastUpdatedBefore, List<String> orderStatuses,
            List<String> fulfillmentChannels, List<String> paymentMethods, String buyerEmail, String sellerOrderId,
            Integer maxResultsPerPage, List<String> easyShipShipmentStatuses, List<String> electronicInvoiceStatuses,
            String nextToken, List<String> amazonOrderIds, String actualFulfillmentSupplySourceId, Boolean isISPU,
            String storeChainStoreId, String earliestDeliveryDateBefore, String earliestDeliveryDateAfter,
            String latestDeliveryDateBefore, String latestDeliveryDateAfter,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOrdersValidateBeforeCall(List<String> marketplaceIds, String createdAfter,
            String createdBefore, String lastUpdatedAfter, String lastUpdatedBefore, List<String> orderStatuses,
            List<String> fulfillmentChannels, List<String> paymentMethods, String buyerEmail, String sellerOrderId,
            Integer maxResultsPerPage, List<String> easyShipShipmentStatuses, List<String> electronicInvoiceStatuses,
            String nextToken, List<String> amazonOrderIds, String actualFulfillmentSupplySourceId, Boolean isISPU,
        ...
        com.squareup.okhttp.Call call = getOrdersCall(marketplaceIds, createdAfter, createdBefore, lastUpdatedAfter,
                ...
                earliestDeliveryDateAfter, latestDeliveryDateBefore, latestDeliveryDateAfter, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GetOrdersResponse getOrders(List<String> marketplaceIds, String createdAfter, String createdBefore,
            String lastUpdatedAfter, String lastUpdatedBefore, List<String> orderStatuses,
            List<String> fulfillmentChannels, List<String> paymentMethods, String buyerEmail, String sellerOrderId,
            Integer maxResultsPerPage, List<String> easyShipShipmentStatuses, List<String> electronicInvoiceStatuses,
            String nextToken, List<String> amazonOrderIds, String actualFulfillmentSupplySourceId, Boolean isISPU,
            String storeChainStoreId, String earliestDeliveryDateBefore, String earliestDeliveryDateAfter,
            String latestDeliveryDateBefore, String latestDeliveryDateAfter) throws ApiException, LWAException {
        ApiResponse<GetOrdersResponse> resp = getOrdersWithHttpInfo(marketplaceIds, createdAfter, createdBefore,
                ...
                sellerOrderId, maxResultsPerPage, easyShipShipmentStatuses, electronicInvoiceStatuses, nextToken,
                amazonOrderIds, actualFulfillmentSupplySourceId, isISPU, storeChainStoreId, earliestDeliveryDateBefore,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GetOrdersResponse> getOrdersWithHttpInfo(List<String> marketplaceIds, String createdAfter,
            String createdBefore, String lastUpdatedAfter, String lastUpdatedBefore, List<String> orderStatuses,
            List<String> fulfillmentChannels, List<String> paymentMethods, String buyerEmail, String sellerOrderId,
            Integer maxResultsPerPage, List<String> easyShipShipmentStatuses, List<String> electronicInvoiceStatuses,
            String nextToken, List<String> amazonOrderIds, String actualFulfillmentSupplySourceId, Boolean isISPU,
        ...
        com.squareup.okhttp.Call call = getOrdersValidateBeforeCall(marketplaceIds, createdAfter, createdBefore,
                ...
                sellerOrderId, maxResultsPerPage, easyShipShipmentStatuses, electronicInvoiceStatuses, nextToken,
                amazonOrderIds, actualFulfillmentSupplySourceId, isISPU, storeChainStoreId, earliestDeliveryDateBefore,
                earliestDeliveryDateAfter, latestDeliveryDateBefore, latestDeliveryDateAfter, null, null);
    ...
    /**
     * (asynchronously) Returns orders created or updated during the time frame indicated by the specified parameters.
     * You can also apply a range of filtering criteria to narrow the list of orders returned. If NextToken is present,
     * that will be used to retrieve the orders instead of other criteria.  **Usage Plan:**  | Rate (requests per
     * second) | Burst | | ---- | ---- | | 0.0167 | 20 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns
     * the usage plan rate limits that were applied to the requested operation, when available. The table above
     * indicates the default rate and burst values for this operation. Selling partners whose business demands require
     * higher throughput may see higher rate and burst values then those shown here. For more information, see [Usage
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getOrdersAsync(List<String> marketplaceIds, String createdAfter,
            String createdBefore, String lastUpdatedAfter, String lastUpdatedBefore, List<String> orderStatuses,
            List<String> fulfillmentChannels, List<String> paymentMethods, String buyerEmail, String sellerOrderId,
            Integer maxResultsPerPage, List<String> easyShipShipmentStatuses, List<String> electronicInvoiceStatuses,
            String nextToken, List<String> amazonOrderIds, String actualFulfillmentSupplySourceId, Boolean isISPU,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateVerificationStatusCall(String orderId,
            UpdateVerificationStatusRequest payload, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = payload;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateVerificationStatusValidateBeforeCall(String orderId,
            UpdateVerificationStatusRequest payload, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        if (payload == null) {
            throw new ApiException(
                    "Missing the required parameter 'payload' when calling updateVerificationStatus(Async)");
        }

        com.squareup.okhttp.Call call = updateVerificationStatusCall(orderId, payload, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<Void> updateVerificationStatusWithHttpInfo(String orderId,
            UpdateVerificationStatusRequest payload) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call updateVerificationStatusAsync(String orderId,
            UpdateVerificationStatusRequest payload, final ApiCallback<Void> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = updateVerificationStatusValidateBeforeCall(orderId, payload, progressListener,
                progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
