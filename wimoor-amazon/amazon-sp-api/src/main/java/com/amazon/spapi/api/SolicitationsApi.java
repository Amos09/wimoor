...
public class SolicitationsApi {
     ...
     *
     * @param amazonOrderId           An Amazon order identifier. This specifies the order for which a solicitation is
     *                                sent. (required)
     ...
     */
    public com.squareup.okhttp.Call createProductReviewAndSellerFeedbackSolicitationCall(String amazonOrderId,
    ...
    private com.squareup.okhttp.Call createProductReviewAndSellerFeedbackSolicitationValidateBeforeCall(
            String amazonOrderId, List<String> marketplaceIds,
        ...
        com.squareup.okhttp.Call call = createProductReviewAndSellerFeedbackSolicitationCall(amazonOrderId,
    ...
    public CreateProductReviewAndSellerFeedbackSolicitationResponse createProductReviewAndSellerFeedbackSolicitation(
        ...
        ApiResponse<CreateProductReviewAndSellerFeedbackSolicitationResponse> resp = createProductReviewAndSellerFeedbackSolicitationWithHttpInfo(
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<CreateProductReviewAndSellerFeedbackSolicitationResponse> createProductReviewAndSellerFeedbackSolicitationWithHttpInfo(
            String amazonOrderId, List<String> marketplaceIds) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = createProductReviewAndSellerFeedbackSolicitationValidateBeforeCall(
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createProductReviewAndSellerFeedbackSolicitationAsync(String amazonOrderId,
     ...
     *                                available solicitation types. (required)
     * @param marketplaceIds          A marketplace identifier. This specifies the marketplace in which the order was
     *                                placed. Only one marketplace can be specified. (required)
     * @param progressListener        Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getSolicitationActionsForOrderCall(String amazonOrderId,
            List<String> marketplaceIds, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSolicitationActionsForOrderValidateBeforeCall(String amazonOrderId,
            List<String> marketplaceIds, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getSolicitationActionsForOrderCall(amazonOrderId, marketplaceIds,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GetSolicitationActionsForOrderResponse getSolicitationActionsForOrder(String amazonOrderId,
            List<String> marketplaceIds) throws ApiException, LWAException {
        ApiResponse<GetSolicitationActionsForOrderResponse> resp = getSolicitationActionsForOrderWithHttpInfo(
                amazonOrderId, marketplaceIds);
        return resp.getData();
    }
    ...
    public ApiResponse<GetSolicitationActionsForOrderResponse> getSolicitationActionsForOrderWithHttpInfo(
            String amazonOrderId, List<String> marketplaceIds) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = getSolicitationActionsForOrderValidateBeforeCall(amazonOrderId, marketplaceIds,
                null, null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getSolicitationActionsForOrderAsync(String amazonOrderId,
            List<String> marketplaceIds, final ApiCallback<GetSolicitationActionsForOrderResponse> callback)
            throws ApiException, LWAException {
