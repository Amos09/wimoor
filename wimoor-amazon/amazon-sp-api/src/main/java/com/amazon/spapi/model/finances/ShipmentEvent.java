...
public class ShipmentEvent {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(amazonOrderId, sellerOrderId, marketplaceName, orderChargeList, orderChargeAdjustmentList,
                shipmentFeeList, shipmentFeeAdjustmentList, orderFeeList, orderFeeAdjustmentList, directPaymentList,
                postedDate, shipmentItemList, shipmentItemAdjustmentList);
    }
