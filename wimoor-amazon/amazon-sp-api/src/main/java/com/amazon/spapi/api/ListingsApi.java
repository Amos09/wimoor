...
public class ListingsApi {
     ...
     *                                (required)
     * @param issueLocale             A locale for localization of issues. When not provided, the default language code
     *                                of the first marketplace is used. Examples: &#x60;en_US&#x60;, &#x60;fr_CA&#x60;,
     *                                &#x60;fr_FR&#x60;. Localized messages default to &#x60;en_US&#x60; when a
     *                                localization is not available in the specified locale. (optional)
     ...
     */
    public com.squareup.okhttp.Call deleteListingsItemCall(String sellerId, String sku, List<String> marketplaceIds,
            String issueLocale, final ProgressResponseBody.ProgressListener progressListener,
    ...
    private com.squareup.okhttp.Call deleteListingsItemValidateBeforeCall(String sellerId, String sku,
            List<String> marketplaceIds, String issueLocale,
        ...
        com.squareup.okhttp.Call call = deleteListingsItemCall(sellerId, sku, marketplaceIds, issueLocale,
     ...
     * @param issueLocale    A locale for localization of issues. When not provided, the default language code of the
     *                       first marketplace is used. Examples: &#x60;en_US&#x60;, &#x60;fr_CA&#x60;,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListingsItemSubmissionResponse deleteListingsItem(String sellerId, String sku, List<String> marketplaceIds,
            String issueLocale) throws ApiException, LWAException {
        ApiResponse<ListingsItemSubmissionResponse> resp = deleteListingsItemWithHttpInfo(sellerId, sku, marketplaceIds,
                issueLocale);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListingsItemSubmissionResponse> deleteListingsItemWithHttpInfo(String sellerId, String sku,
            List<String> marketplaceIds, String issueLocale) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = deleteListingsItemValidateBeforeCall(sellerId, sku, marketplaceIds, issueLocale,
                null, null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call deleteListingsItemAsync(String sellerId, String sku, List<String> marketplaceIds,
            String issueLocale, final ApiCallback<ListingsItemSubmissionResponse> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getListingsItemCall(String sellerId, String sku, List<String> marketplaceIds,
            String issueLocale, List<String> includedData, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getListingsItemValidateBeforeCall(String sellerId, String sku,
            List<String> marketplaceIds, String issueLocale, List<String> includedData,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getListingsItemCall(sellerId, sku, marketplaceIds, issueLocale, includedData,
                progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public Item getListingsItem(String sellerId, String sku, List<String> marketplaceIds, String issueLocale,
            List<String> includedData) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<Item> getListingsItemWithHttpInfo(String sellerId, String sku, List<String> marketplaceIds,
            String issueLocale, List<String> includedData) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = getListingsItemValidateBeforeCall(sellerId, sku, marketplaceIds, issueLocale,
                includedData, null, null);
    ...
    /**
     * (asynchronously) Returns details about a listings item for a selling partner.  **Note:** The parameters
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getListingsItemAsync(String sellerId, String sku, List<String> marketplaceIds,
            String issueLocale, List<String> includedData, final ApiCallback<Item> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getListingsItemValidateBeforeCall(sellerId, sku, marketplaceIds, issueLocale,
                includedData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Item>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call patchListingsItemCall(String sellerId, String sku, List<String> marketplaceIds,
            ListingsItemPatchRequest body, String issueLocale,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call patchListingsItemValidateBeforeCall(String sellerId, String sku,
            List<String> marketplaceIds, ListingsItemPatchRequest body, String issueLocale,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = patchListingsItemCall(sellerId, sku, marketplaceIds, body, issueLocale,
                progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListingsItemSubmissionResponse patchListingsItem(String sellerId, String sku, List<String> marketplaceIds,
            ListingsItemPatchRequest body, String issueLocale) throws ApiException, LWAException {
        ApiResponse<ListingsItemSubmissionResponse> resp = patchListingsItemWithHttpInfo(sellerId, sku, marketplaceIds,
                body, issueLocale);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListingsItemSubmissionResponse> patchListingsItemWithHttpInfo(String sellerId, String sku,
            List<String> marketplaceIds, ListingsItemPatchRequest body, String issueLocale)
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = patchListingsItemValidateBeforeCall(sellerId, sku, marketplaceIds, body,
                issueLocale, null, null);
        Type localVarReturnType = new TypeToken<ListingsItemSubmissionResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * attributes can be patched. Patching nested attributes is not supported.  **Note:** The parameters associated with
     * this operation may contain special characters that must be encoded to successfully call the API. To avoid errors
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call patchListingsItemAsync(String sellerId, String sku, List<String> marketplaceIds,
            ListingsItemPatchRequest body, String issueLocale,
            final ApiCallback<ListingsItemSubmissionResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = patchListingsItemValidateBeforeCall(sellerId, sku, marketplaceIds, body,
                issueLocale, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListingsItemSubmissionResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call putListingsItemCall(String sellerId, String sku, List<String> marketplaceIds,
            ListingsItemPutRequest body, String issueLocale,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call putListingsItemValidateBeforeCall(String sellerId, String sku,
            List<String> marketplaceIds, ListingsItemPutRequest body, String issueLocale,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = putListingsItemCall(sellerId, sku, marketplaceIds, body, issueLocale,
                progressListener, progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ListingsItemSubmissionResponse putListingsItem(String sellerId, String sku, List<String> marketplaceIds,
            ListingsItemPutRequest body, String issueLocale) throws ApiException, LWAException {
        ApiResponse<ListingsItemSubmissionResponse> resp = putListingsItemWithHttpInfo(sellerId, sku, marketplaceIds,
                body, issueLocale);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<ListingsItemSubmissionResponse> putListingsItemWithHttpInfo(String sellerId, String sku,
            List<String> marketplaceIds, ListingsItemPutRequest body, String issueLocale)
            throws ApiException, LWAException {
        com.squareup.okhttp.Call call = putListingsItemValidateBeforeCall(sellerId, sku, marketplaceIds, body,
                issueLocale, null, null);
        Type localVarReturnType = new TypeToken<ListingsItemSubmissionResponse>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    ...
    /**
     * (asynchronously) Creates or fully updates an existing listings item for a selling partner.  **Note:** The
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call putListingsItemAsync(String sellerId, String sku, List<String> marketplaceIds,
            ListingsItemPutRequest body, String issueLocale, final ApiCallback<ListingsItemSubmissionResponse> callback)
            throws ApiException, LWAException {
