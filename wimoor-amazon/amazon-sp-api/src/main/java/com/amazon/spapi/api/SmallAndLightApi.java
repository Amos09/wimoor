...
public class SmallAndLightApi {
     ...
     * @param marketplaceIds          The marketplace in which to remove the item from the Small and Light program.
     *                                Note: Accepts a single marketplace only. (required)
     ...
     */
    public com.squareup.okhttp.Call deleteSmallAndLightEnrollmentBySellerSKUCall(String sellerSKU,
    ...
    private com.squareup.okhttp.Call deleteSmallAndLightEnrollmentBySellerSKUValidateBeforeCall(String sellerSKU,
            List<String> marketplaceIds, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        if (sellerSKU == null) {
            throw new ApiException(
                    "Missing the required parameter 'sellerSKU' when calling deleteSmallAndLightEnrollmentBySellerSKU(Async)");
        }

        // verify the required parameter 'marketplaceIds' is set
        if (marketplaceIds == null) {
            throw new ApiException(
                    "Missing the required parameter 'marketplaceIds' when calling deleteSmallAndLightEnrollmentBySellerSKU(Async)");
        }

        com.squareup.okhttp.Call call = deleteSmallAndLightEnrollmentBySellerSKUCall(sellerSKU, marketplaceIds,
     ...
     *
     * @param sellerSKU      The seller SKU that identifies the item. (required)
     * @param marketplaceIds The marketplace in which to remove the item from the Small and Light program. Note: Accepts
     *                       a single marketplace only. (required)
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<Void> deleteSmallAndLightEnrollmentBySellerSKUWithHttpInfo(String sellerSKU,
            List<String> marketplaceIds) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = deleteSmallAndLightEnrollmentBySellerSKUValidateBeforeCall(sellerSKU,
                marketplaceIds, null, null);
        return apiClient.execute(call);
    }

    /**
     * (asynchronously) Removes the item indicated by the specified seller SKU from the Small and Light program in the
     * specified marketplace. If the item is not eligible for disenrollment, the ineligibility reasons are returned.
     * **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 5 |  The
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call deleteSmallAndLightEnrollmentBySellerSKUAsync(String sellerSKU,
            List<String> marketplaceIds, final ApiCallback<Void> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = deleteSmallAndLightEnrollmentBySellerSKUValidateBeforeCall(sellerSKU,
                marketplaceIds, progressListener, progressRequestListener);
     ...
     *
     * @param sellerSKU               The seller SKU that identifies the item. (required)
     * @param marketplaceIds          The marketplace for which the eligibility status is retrieved. NOTE: Accepts a
     *                                single marketplace only. (required)
     * @param progressListener        Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getSmallAndLightEligibilityBySellerSKUCall(String sellerSKU,
            List<String> marketplaceIds, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSmallAndLightEligibilityBySellerSKUValidateBeforeCall(String sellerSKU,
            List<String> marketplaceIds, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        if (sellerSKU == null) {
            throw new ApiException(
                    "Missing the required parameter 'sellerSKU' when calling getSmallAndLightEligibilityBySellerSKU(Async)");
        }

        // verify the required parameter 'marketplaceIds' is set
        if (marketplaceIds == null) {
            throw new ApiException(
                    "Missing the required parameter 'marketplaceIds' when calling getSmallAndLightEligibilityBySellerSKU(Async)");
        }

        com.squareup.okhttp.Call call = getSmallAndLightEligibilityBySellerSKUCall(sellerSKU, marketplaceIds,
                progressListener, progressRequestListener);
        return call;
     ...
     *
     * @param sellerSKU      The seller SKU that identifies the item. (required)
     * @param marketplaceIds The marketplace for which the eligibility status is retrieved. NOTE: Accepts a single
     *                       marketplace only. (required)
    ...
    public SmallAndLightEligibility getSmallAndLightEligibilityBySellerSKU(String sellerSKU,
            List<String> marketplaceIds) throws ApiException, LWAException {
        ApiResponse<SmallAndLightEligibility> resp = getSmallAndLightEligibilityBySellerSKUWithHttpInfo(sellerSKU,
                marketplaceIds);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<SmallAndLightEligibility> getSmallAndLightEligibilityBySellerSKUWithHttpInfo(String sellerSKU,
            List<String> marketplaceIds) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = getSmallAndLightEligibilityBySellerSKUValidateBeforeCall(sellerSKU,
                marketplaceIds, null, null);
    ...
    /**
     * (asynchronously) Returns the Small and Light program eligibility status of the item indicated by the specified
     * seller SKU in the specified marketplace. If the item is not eligible, the ineligibility reasons are returned.
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getSmallAndLightEligibilityBySellerSKUAsync(String sellerSKU,
            List<String> marketplaceIds, final ApiCallback<SmallAndLightEligibility> callback)
            throws ApiException, LWAException {
     ...
     *
     * @param sellerSKU               The seller SKU that identifies the item. (required)
     * @param marketplaceIds          The marketplace for which the enrollment status is retrieved. Note: Accepts a
     *                                single marketplace only. (required)
     * @param progressListener        Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getSmallAndLightEnrollmentBySellerSKUCall(String sellerSKU,
            List<String> marketplaceIds, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSmallAndLightEnrollmentBySellerSKUValidateBeforeCall(String sellerSKU,
            List<String> marketplaceIds, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        if (sellerSKU == null) {
            throw new ApiException(
                    "Missing the required parameter 'sellerSKU' when calling getSmallAndLightEnrollmentBySellerSKU(Async)");
        }

        // verify the required parameter 'marketplaceIds' is set
        if (marketplaceIds == null) {
            throw new ApiException(
                    "Missing the required parameter 'marketplaceIds' when calling getSmallAndLightEnrollmentBySellerSKU(Async)");
        }

        com.squareup.okhttp.Call call = getSmallAndLightEnrollmentBySellerSKUCall(sellerSKU, marketplaceIds,
                progressListener, progressRequestListener);
        return call;
     ...
     *
     * @param sellerSKU      The seller SKU that identifies the item. (required)
     * @param marketplaceIds The marketplace for which the enrollment status is retrieved. Note: Accepts a single
     *                       marketplace only. (required)
    ...
    public SmallAndLightEnrollment getSmallAndLightEnrollmentBySellerSKU(String sellerSKU, List<String> marketplaceIds)
            throws ApiException, LWAException {
        ApiResponse<SmallAndLightEnrollment> resp = getSmallAndLightEnrollmentBySellerSKUWithHttpInfo(sellerSKU,
                marketplaceIds);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<SmallAndLightEnrollment> getSmallAndLightEnrollmentBySellerSKUWithHttpInfo(String sellerSKU,
            List<String> marketplaceIds) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = getSmallAndLightEnrollmentBySellerSKUValidateBeforeCall(sellerSKU,
                marketplaceIds, null, null);
    ...
    /**
     * (asynchronously) Returns the Small and Light enrollment status for the item indicated by the specified seller SKU
     * in the specified marketplace.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 10 |
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getSmallAndLightEnrollmentBySellerSKUAsync(String sellerSKU,
            List<String> marketplaceIds, final ApiCallback<SmallAndLightEnrollment> callback)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getSmallAndLightFeePreviewCall(SmallAndLightFeePreviewRequest body,
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSmallAndLightFeePreviewValidateBeforeCall(SmallAndLightFeePreviewRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        if (body == null) {
            throw new ApiException(
                    "Missing the required parameter 'body' when calling getSmallAndLightFeePreview(Async)");
        }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<SmallAndLightFeePreviews> getSmallAndLightFeePreviewWithHttpInfo(
            SmallAndLightFeePreviewRequest body) throws ApiException, LWAException {
    ...
    /**
     * (asynchronously) Returns the Small and Light fee estimates for the specified items. You must include a
     * marketplaceId parameter to retrieve the proper fee estimates for items to be sold in that marketplace. The
     * ordering of items in the response will mirror the order of the items in the request. Duplicate ASIN/price
     * combinations are removed.  **Usage Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 3 |  The
     * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the
     * requested operation, when available. The table above indicates the default rate and burst values for this
     * operation. Selling partners whose business demands require higher throughput may see higher rate and burst values
     * than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getSmallAndLightFeePreviewAsync(SmallAndLightFeePreviewRequest body,
            final ApiCallback<SmallAndLightFeePreviews> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getSmallAndLightFeePreviewValidateBeforeCall(body, progressListener,
     ...
     *
     * @param sellerSKU               The seller SKU that identifies the item. (required)
     * @param marketplaceIds          The marketplace in which to enroll the item. Note: Accepts a single marketplace
     *                                only. (required)
     * @param progressListener        Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call putSmallAndLightEnrollmentBySellerSKUCall(String sellerSKU,
            List<String> marketplaceIds, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call putSmallAndLightEnrollmentBySellerSKUValidateBeforeCall(String sellerSKU,
            List<String> marketplaceIds, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        if (sellerSKU == null) {
            throw new ApiException(
                    "Missing the required parameter 'sellerSKU' when calling putSmallAndLightEnrollmentBySellerSKU(Async)");
        }

        // verify the required parameter 'marketplaceIds' is set
        if (marketplaceIds == null) {
            throw new ApiException(
                    "Missing the required parameter 'marketplaceIds' when calling putSmallAndLightEnrollmentBySellerSKU(Async)");
        }

        com.squareup.okhttp.Call call = putSmallAndLightEnrollmentBySellerSKUCall(sellerSKU, marketplaceIds,
                progressListener, progressRequestListener);
        return call;
    ...
    public SmallAndLightEnrollment putSmallAndLightEnrollmentBySellerSKU(String sellerSKU, List<String> marketplaceIds)
            throws ApiException, LWAException {
        ApiResponse<SmallAndLightEnrollment> resp = putSmallAndLightEnrollmentBySellerSKUWithHttpInfo(sellerSKU,
                marketplaceIds);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<SmallAndLightEnrollment> putSmallAndLightEnrollmentBySellerSKUWithHttpInfo(String sellerSKU,
            List<String> marketplaceIds) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = putSmallAndLightEnrollmentBySellerSKUValidateBeforeCall(sellerSKU,
                marketplaceIds, null, null);
        Type localVarReturnType = new TypeToken<SmallAndLightEnrollment>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    ...
    /**
     * (asynchronously) Enrolls the item indicated by the specified seller SKU in the Small and Light program in the
     * specified marketplace. If the item is not eligible, the ineligibility reasons are returned.  **Usage Plan:**  |
     * Rate (requests per second) | Burst | | ---- | ---- | | 2 | 5 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call putSmallAndLightEnrollmentBySellerSKUAsync(String sellerSKU,
            List<String> marketplaceIds, final ApiCallback<SmallAndLightEnrollment> callback)
            throws ApiException, LWAException {
