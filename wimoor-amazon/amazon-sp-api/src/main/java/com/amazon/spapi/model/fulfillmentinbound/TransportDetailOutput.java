...
public class TransportDetailOutput {
    ...
    public TransportDetailOutput nonPartneredSmallParcelData(
    ...
    @Override
    public int hashCode() {
        return Objects.hash(partneredSmallParcelData, nonPartneredSmallParcelData, partneredLtlData,
                nonPartneredLtlData);
    }
    ...
    public String toString() {
        ...
        sb.append("    nonPartneredSmallParcelData: ").append(toIndentedString(nonPartneredSmallParcelData))
                .append("\n");
