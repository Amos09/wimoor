...
public class InboundShipmentHeader {
     ...
     * case packed.  false - All boxes in the shipment must be individually packed.  Note: If AreCasesRequired &#x3D;
     * true for an inbound shipment, then the value of QuantityInCase must be greater than zero for every item in the
     * shipment. Otherwise the service returns an error.
     *
    ...
    @Override
    public int hashCode() {
        return Objects.hash(shipmentName, shipFromAddress, destinationFulfillmentCenterId, areCasesRequired,
                shipmentStatus, labelPrepPreference, intendedBoxContentsSource);
    }
