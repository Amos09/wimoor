...
public class ShippingOfferingFilter {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(includePackingSlipWithLabel, includeComplexShippingOptions, carrierWillPickUp,
                deliveryExperience);
    }
    ...
    public String toString() {
        ...
        sb.append("    includePackingSlipWithLabel: ").append(toIndentedString(includePackingSlipWithLabel))
                .append("\n");
        sb.append("    includeComplexShippingOptions: ").append(toIndentedString(includeComplexShippingOptions))
                .append("\n");
