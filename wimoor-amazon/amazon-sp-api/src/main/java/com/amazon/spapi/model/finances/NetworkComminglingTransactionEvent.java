...
public class NetworkComminglingTransactionEvent {
     ...
     * transaction. Available only in the India marketplace.  * ComminglingVAT - A commingling VAT transaction.
     * Available only in the UK, Spain, France, Germany, and Italy marketplaces.
     *
    ...
    @Override
    public int hashCode() {
        return Objects.hash(transactionType, postedDate, netCoTransactionID, swapReason, ASIN, marketplaceId,
