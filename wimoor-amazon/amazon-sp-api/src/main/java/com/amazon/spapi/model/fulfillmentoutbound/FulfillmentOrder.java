...
public class FulfillmentOrder {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(sellerFulfillmentOrderId, marketplaceId, displayableOrderId, displayableOrderDate,
                displayableOrderComment, shippingSpeedCategory, deliveryWindow, destinationAddress, fulfillmentAction,
                fulfillmentPolicy, codSettings, receivedDate, fulfillmentOrderStatus, statusUpdatedDate,
                notificationEmails, featureConstraints);
    }
