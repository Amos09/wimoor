...
public class GetRatesRequest {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(shipTo, shipFrom, returnTo, shipDate, shipperInstruction, packages, valueAddedServices,
                taxDetails, channelDetails, clientReferenceDetails, shipmentType, destinationAccessPointDetails);
    }
    ...
    public String toString() {
        ...
        sb.append("    destinationAccessPointDetails: ").append(toIndentedString(destinationAccessPointDetails))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
