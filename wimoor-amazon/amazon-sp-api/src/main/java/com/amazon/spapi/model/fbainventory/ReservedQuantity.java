...
public class ReservedQuantity {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(totalReservedQuantity, pendingCustomerOrderQuantity, pendingTransshipmentQuantity,
    ...
    public String toString() {
        ...
        sb.append("    pendingCustomerOrderQuantity: ").append(toIndentedString(pendingCustomerOrderQuantity))
                .append("\n");
        sb.append("    pendingTransshipmentQuantity: ").append(toIndentedString(pendingTransshipmentQuantity))
                .append("\n");
