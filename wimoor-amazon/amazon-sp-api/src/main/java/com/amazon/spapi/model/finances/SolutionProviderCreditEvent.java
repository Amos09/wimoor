...
public class SolutionProviderCreditEvent {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(providerTransactionType, sellerOrderId, marketplaceId, marketplaceCountryCode, sellerId,
                sellerStoreName, providerId, providerStoreName, transactionAmount, transactionCreationDate);
    }
