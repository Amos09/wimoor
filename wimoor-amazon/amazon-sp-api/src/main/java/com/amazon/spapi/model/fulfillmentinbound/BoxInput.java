...
public class BoxInput {
    ...
    /**
     * The Contents of the box containing a list of MSKUs and their quantity. If &#x60;boxAttribute&#x60; is
     * &#x60;BARCODE_2D&#x60; or &#x60;MANUAL_PROCESS&#x60;, user should provide ALL of the items that could be in the
     * box, without specifying item quantities.
     *
     * @return contents
     **/
    ...
    /**
     * The seller-provided name for a &#39;type&#39; of box (or a group of boxes with the same contents), which will be
     * used to identify all created boxes of that type. When providing bulk box information, this value must be unique
     * from the other box types. When providing individual boxes with existing IDs, this value can be shared between
     * many boxes that have the same contents.
     *
     * @return templateName
     **/
