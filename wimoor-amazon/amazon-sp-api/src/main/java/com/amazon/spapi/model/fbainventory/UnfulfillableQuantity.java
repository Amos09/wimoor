...
public class UnfulfillableQuantity {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(totalUnfulfillableQuantity, customerDamagedQuantity, warehouseDamagedQuantity,
                distributorDamagedQuantity, carrierDamagedQuantity, defectiveQuantity, expiredQuantity);
    }
