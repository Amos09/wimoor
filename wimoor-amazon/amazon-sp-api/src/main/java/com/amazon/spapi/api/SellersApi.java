...
public class SellersApi {
     ...
     * | ---- | | 0.016 | 15 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate
    ...
    /**
     * (asynchronously) Returns a list of marketplaces that the seller submitting the request can sell in and
     * information about the seller&#39;s participation in those marketplaces.  **Usage Plan:**  | Rate (requests per
     * second) | Burst | | ---- | ---- | | 0.016 | 15 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns
