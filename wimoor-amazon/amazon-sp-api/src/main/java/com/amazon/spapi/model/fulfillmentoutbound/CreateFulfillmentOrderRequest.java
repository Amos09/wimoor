...
public class CreateFulfillmentOrderRequest {
     ...
     * recipient-facing materials such as the outbound shipment packing slip. The value of DisplayableOrderId should
     * match the order identifier that the seller provides to the recipient. The seller can use the
     * SellerFulfillmentOrderId for this value or they can specify an alternate value if they want the recipient to
    ...
    /**
     * The shipping method for the fulfillment order. When this value is ScheduledDelivery, choose Ship for the
     * fulfillmentAction. Hold is not a valid fulfillmentAction value when the shippingSpeedCategory value is
     * ScheduledDelivery.
     *
    ...
    @Override
    public int hashCode() {
        return Objects.hash(marketplaceId, sellerFulfillmentOrderId, displayableOrderId, displayableOrderDate,
                displayableOrderComment, shippingSpeedCategory, deliveryWindow, destinationAddress, fulfillmentAction,
                fulfillmentPolicy, codSettings, shipFromCountryCode, notificationEmails, featureConstraints, items);
    }
