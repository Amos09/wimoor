 ...
 * image size. If the image is cropped and no offset values are provided, then the coordinates of the top left corner of
 * the cropped image, relative to the original image, are defaulted to (0,0).
 */
