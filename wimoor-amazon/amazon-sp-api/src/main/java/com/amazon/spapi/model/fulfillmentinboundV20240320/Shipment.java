...
public class Shipment {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(amazonReferenceId, contactInformation, dates, destination, freightInformation, name,
                placementOptionId, selectedDeliveryWindow, selectedTransportationOptionId, selfShipAppointmentDetails,
