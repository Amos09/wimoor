...
public class Shipment {
     ...
     * amount that the carrier will use to insure the shipment. If DeclaredValue was not specified with a previous call
     * to the createShipment operation, then the shipment will be insured for the carrier&#39;s minimum insurance
     * amount, or the combined sale prices that the items are listed for in the shipment, whichever is less.
     *
     * @return insurance
     **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(shipmentId, amazonOrderId, sellerOrderId, itemList, shipFromAddress, shipToAddress,
                packageDimensions, weight, insurance, shippingService, label, status, trackingId, createdDate,
                lastUpdatedDate);
    }
