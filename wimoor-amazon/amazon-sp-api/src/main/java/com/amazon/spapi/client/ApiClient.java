...
public class ApiClient {
    ...
    /**
     * Sets the RateLimiter A rate limiter is used to manage a high volume of traffic allowing N requests per second
     *
     * @return Api client
     */
    ...
    public Call buildCall(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams,
            ...
            ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
    ...
    /**
     * Apply SSL related settings to httpClient according to the current values of sslCaCert.
     */
