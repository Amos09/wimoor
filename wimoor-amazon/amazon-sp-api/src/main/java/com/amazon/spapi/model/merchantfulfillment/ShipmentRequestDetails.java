...
public class ShipmentRequestDetails {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(amazonOrderId, sellerOrderId, itemList, shipFromAddress, packageDimensions, weight,
                mustArriveByDate, shipDate, shippingServiceOptions, labelCustomization);
    }
