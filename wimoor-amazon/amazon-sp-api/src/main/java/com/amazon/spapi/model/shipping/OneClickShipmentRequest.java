...
public class OneClickShipmentRequest {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(shipTo, shipFrom, returnTo, shipDate, packages, valueAddedServicesDetails, taxDetails,
                channelDetails, labelSpecifications, serviceSelection, shipperInstruction,
