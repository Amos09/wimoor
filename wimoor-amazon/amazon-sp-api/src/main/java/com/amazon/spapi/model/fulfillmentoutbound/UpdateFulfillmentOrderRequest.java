...
public class UpdateFulfillmentOrderRequest {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(marketplaceId, displayableOrderId, displayableOrderDate, displayableOrderComment,
                shippingSpeedCategory, destinationAddress, fulfillmentAction, fulfillmentPolicy, shipFromCountryCode,
                notificationEmails, featureConstraints, items);
    }
