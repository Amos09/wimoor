...
public class Report {
     ...
     * will need to retrieve the report document&#39;s contents.
     *
    ...
    @Override
    public int hashCode() {
        return Objects.hash(marketplaceIds, reportId, reportType, dataStartTime, dataEndTime, reportScheduleId,
                createdTime, processingStatus, processingStartTime, processingEndTime, reportDocumentId);
    }
