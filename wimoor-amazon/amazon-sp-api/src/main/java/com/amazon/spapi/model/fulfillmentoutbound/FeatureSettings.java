...
/**
 * FeatureSettings allows users to apply fulfillment features to an order. To block an order from being shipped using
 ...
 * an order request will take precedence over your Seller Central account setting. To ship in non-Amazon branded
 * packaging (blank boxes), use featureName BLANK_BOX.
 */
