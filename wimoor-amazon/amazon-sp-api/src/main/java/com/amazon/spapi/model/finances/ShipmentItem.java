...
public class ShipmentItem {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(sellerSKU, orderItemId, orderAdjustmentItemId, quantityShipped, itemChargeList,
                itemChargeAdjustmentList, itemFeeList, itemFeeAdjustmentList, itemTaxWithheldList, promotionList,
                promotionAdjustmentList, costOfPointsGranted, costOfPointsReturned);
    }
