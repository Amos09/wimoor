...
public class Address {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, addressLine1, addressLine2, addressLine3, city, county, district, stateOrRegion,
                municipality, postalCode, countryCode, phone, addressType);
    }
