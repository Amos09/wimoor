...
public class InboundPlan {
     ...
     * corresponding operation. If there is a chosen placement option, only shipments for that option will be returned.
    ...
    /**
     * Current status of the inbound plan. Can be: &#x60;ACTIVE&#x60;, &#x60;VOIDED&#x60;, &#x60;SHIPPED&#x60;,
     * &#39;ERRORED&#39;.
     *
     * @return status
     **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(createdAt, inboundPlanId, lastUpdatedAt, marketplaceIds, name, packingOptions,
                placementOptions, shipments, sourceAddress, status);
    }
