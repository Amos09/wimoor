...
public class PackingOption {
    ...
    /**
     * The timestamp at which this packing option becomes no longer valid. This is in ISO 8601 datetime format with
    ...
    @Override
    public int hashCode() {
        return Objects.hash(discounts, expiration, fees, inboundPlanId, packingGroups, packingOptionId, status,
    ...
    public String toString() {
        ...
        sb.append("    supportedShippingConfigurations: ").append(toIndentedString(supportedShippingConfigurations))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
