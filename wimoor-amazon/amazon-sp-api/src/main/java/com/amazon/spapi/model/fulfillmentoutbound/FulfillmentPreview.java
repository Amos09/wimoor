...
public class FulfillmentPreview {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(shippingSpeedCategory, scheduledDeliveryInfo, isFulfillable, isCODCapable,
                estimatedShippingWeight, estimatedFees, fulfillmentPreviewShipments, unfulfillablePreviewItems,
                orderUnfulfillableReasons, marketplaceId, featureConstraints);
    }
    ...
    public String toString() {
        ...
        sb.append("    fulfillmentPreviewShipments: ").append(toIndentedString(fulfillmentPreviewShipments))
                .append("\n");
