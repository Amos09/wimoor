...
public class FinancialEventGroup {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(financialEventGroupId, processingStatus, fundTransferStatus, originalTotal, convertedTotal,
                fundTransferDate, traceId, accountTail, beginningBalance, financialEventGroupStart,
