...
public class RemovalShipmentItemAdjustment {
     ...
     * remitted to the taxing authority by Amazon on behalf of the seller.  * Standard - Tax is paid to the seller and
     * not remitted to the taxing authority by Amazon.
     *
    ...
    /**
     * Adjustment the tax withheld and remitted to the taxing authority by Amazon on behalf of the seller. If
     * TaxCollectionModel&#x3D;MarketplaceFacilitator, then TaxWithheld&#x3D;TaxAmount (except the TaxWithheld amount is
     * a negative number). Otherwise TaxWithheld&#x3D;0.
     *
    ...
    @Override
    public int hashCode() {
        return Objects.hash(removalShipmentItemId, taxCollectionModel, fulfillmentNetworkSKU, adjustedQuantity,
                revenueAdjustment, taxAmountAdjustment, taxWithheldAdjustment);
    }
