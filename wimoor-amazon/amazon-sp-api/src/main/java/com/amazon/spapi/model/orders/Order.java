...
public class Order {
    ...
    /**
     * The shipment service level category of the order.  Possible values: Expedited, FreeEconomy, NextDay, Priority,
     * SameDay, SecondDay, Scheduled, Standard.
     *
    ...
    /**
     * The start of the time period within which you have committed to ship the order. In &lt;a
     * href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; date time
     * format. Returned only for seller-fulfilled orders.  __Note__: EarliestShipDate might not be returned for orders
     * placed before February 1, 2013.
     *
    ...
    /**
     * The end of the time period within which you have committed to ship the order. In &lt;a
     * href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; date time
     * format. Returned only for seller-fulfilled orders.  __Note__: LatestShipDate might not be returned for orders
     * placed before February 1, 2013.
     *
    ...
    /**
     * The start of the time period within which you have committed to fulfill the order. In &lt;a
     * href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; date time
    ...
    /**
     * The end of the time period within which you have committed to fulfill the order. In &lt;a
     * href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; date time
     * format. Returned only for seller-fulfilled orders that do not have a PendingAvailability, Pending, or Canceled
     * status.
     *
    ...
    @Override
    public int hashCode() {
        return Objects.hash(amazonOrderId, sellerOrderId, purchaseDate, lastUpdateDate, orderStatus, fulfillmentChannel,
                salesChannel, orderChannel, shipServiceLevel, orderTotal, numberOfItemsShipped, numberOfItemsUnshipped,
                paymentExecutionDetail, paymentMethod, paymentMethodDetails, marketplaceId,
                shipmentServiceLevelCategory, easyShipShipmentStatus, cbaDisplayableShippingLabel, orderType,
                earliestShipDate, latestShipDate, earliestDeliveryDate, latestDeliveryDate, isBusinessOrder, isPrime,
                isPremiumOrder, isGlobalExpressEnabled, replacedOrderId, isReplacementOrder, promiseResponseDueDate,
                isEstimatedShipDateSet, isSoldByAB, isIBA, defaultShipFromLocationAddress, buyerInvoicePreference,
                buyerTaxInformation, fulfillmentInstruction, isISPU, isAccessPointOrder, marketplaceTaxInfo,
                sellerDisplayName, shippingAddress, buyerInfo, automatedShippingSettings, hasRegulatedItems,
    ...
    public String toString() {
        ...
        sb.append("    shipmentServiceLevelCategory: ").append(toIndentedString(shipmentServiceLevelCategory))
                .append("\n");
        sb.append("    easyShipShipmentStatus: ").append(toIndentedString(easyShipShipmentStatus)).append("\n");
        sb.append("    cbaDisplayableShippingLabel: ").append(toIndentedString(cbaDisplayableShippingLabel))
                .append("\n");
        ...
        sb.append("    defaultShipFromLocationAddress: ").append(toIndentedString(defaultShipFromLocationAddress))
                .append("\n");
