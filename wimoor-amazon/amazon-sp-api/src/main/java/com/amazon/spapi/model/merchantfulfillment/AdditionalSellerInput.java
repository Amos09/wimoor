...
public class AdditionalSellerInput {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(dataType, valueAsString, valueAsBoolean, valueAsInteger, valueAsTimestamp, valueAsAddress,
                valueAsWeight, valueAsDimension, valueAsCurrency);
    }
