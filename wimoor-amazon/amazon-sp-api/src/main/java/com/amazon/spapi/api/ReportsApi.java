...
public class ReportsApi {
     ...
     *
     * @param reportId                The identifier for the report. This identifier is unique only in combination with
     *                                a seller ID. (required)
     ...
     */
    public com.squareup.okhttp.Call cancelReportCall(String reportId,
    ...
    private com.squareup.okhttp.Call cancelReportValidateBeforeCall(String reportId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
     ...
     * reports are returned in subsequent calls to the getReport and getReports operations.  **Usage Plan:**  | Rate
    ...
    /**
     * (asynchronously) Cancels the report that you specify. Only reports with processingStatus&#x3D;IN_QUEUE can be
     * cancelled. Cancelled reports are returned in subsequent calls to the getReport and getReports operations.
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call cancelReportAsync(String reportId, final ApiCallback<Void> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = cancelReportValidateBeforeCall(reportId, progressListener,
     ...
     *
     * @param reportScheduleId        The identifier for the report schedule. This identifier is unique only in
     *                                combination with a seller ID. (required)
     * @param progressListener        Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call cancelReportScheduleCall(String reportScheduleId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call cancelReportScheduleValidateBeforeCall(String reportScheduleId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = cancelReportScheduleCall(reportScheduleId, progressListener,
                progressRequestListener);
        return call;
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call cancelReportScheduleAsync(String reportScheduleId, final ApiCallback<Void> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = cancelReportScheduleValidateBeforeCall(reportScheduleId, progressListener,
                progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createReportCall(CreateReportSpecification body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createReportValidateBeforeCall(CreateReportSpecification body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
     ...
     * 0.0167 | 15 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createReportAsync(CreateReportSpecification body,
            final ApiCallback<CreateReportResponse> callback) throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createReportScheduleCall(CreateReportScheduleSpecification body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createReportScheduleValidateBeforeCall(CreateReportScheduleSpecification body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createReportScheduleAsync(CreateReportScheduleSpecification body,
            final ApiCallback<CreateReportScheduleResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = createReportScheduleValidateBeforeCall(body, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<CreateReportScheduleResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getReportCall(String reportId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getReportValidateBeforeCall(String reportId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    /**
     * Returns report details (including the reportDocumentId, if available) for the report that you specify.  **Usage
     * Plan:**  | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 15 |  The
     * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the
     * requested operation, when available. The table above indicates the default rate and burst values for this
     * operation. Selling partners whose business demands require higher throughput may see higher rate and burst values
     * than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner
    ...
    /**
     * (asynchronously) Returns report details (including the reportDocumentId, if available) for the report that you
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getReportAsync(String reportId, final ApiCallback<Report> callback)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getReportValidateBeforeCall(reportId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<Report>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getReportDocumentCall(String reportDocumentId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getReportDocumentValidateBeforeCall(String reportDocumentId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getReportDocumentCall(reportDocumentId, progressListener,
                progressRequestListener);
        return call;
    ...
    public ApiResponse<ReportDocument> getReportDocumentWithHttpInfo(String reportDocumentId)
        ...
        Type localVarReturnType = new TypeToken<ReportDocument>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getReportDocumentAsync(String reportDocumentId,
            final ApiCallback<ReportDocument> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getReportDocumentValidateBeforeCall(reportDocumentId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<ReportDocument>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getReportScheduleCall(String reportScheduleId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getReportScheduleValidateBeforeCall(String reportScheduleId,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getReportScheduleCall(reportScheduleId, progressListener,
                progressRequestListener);
        return call;
    ...
    public ApiResponse<ReportSchedule> getReportScheduleWithHttpInfo(String reportScheduleId)
        ...
        Type localVarReturnType = new TypeToken<ReportSchedule>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Returns report schedule details for the report schedule that you specify.  **Usage Plan:**  |
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getReportScheduleAsync(String reportScheduleId,
            final ApiCallback<ReportSchedule> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getReportScheduleValidateBeforeCall(reportScheduleId, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<ReportSchedule>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getReportSchedulesCall(List<String> reportTypes,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getReportSchedulesValidateBeforeCall(List<String> reportTypes,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
    ...
    public ApiResponse<ReportScheduleList> getReportSchedulesWithHttpInfo(List<String> reportTypes)
        ...
        Type localVarReturnType = new TypeToken<ReportScheduleList>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * (asynchronously) Returns report schedule details that match the filters that you specify.  **Usage Plan:**  |
     * Rate (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60;
     * response header returns the usage plan rate limits that were applied to the requested operation, when available.
     * The table above indicates the default rate and burst values for this operation. Selling partners whose business
     * demands require higher throughput may see higher rate and burst values than those shown here. For more
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getReportSchedulesAsync(List<String> reportTypes,
            final ApiCallback<ReportScheduleList> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getReportSchedulesValidateBeforeCall(reportTypes, progressListener,
                progressRequestListener);
        Type localVarReturnType = new TypeToken<ReportScheduleList>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
     ...
     *                                Values](https://developer-docs.amazon.com/sp-api/docs/report-type-values) for more
     *                                information. When reportTypes is provided, the other filter parameters
     *                                (processingStatuses, marketplaceIds, createdSince, createdUntil) and pageSize may
     *                                also be provided. Either reportTypes or nextToken is required. (optional)
     * @param processingStatuses      A list of processing statuses used to filter reports. (optional)
     * @param marketplaceIds          A list of marketplace identifiers used to filter reports. The reports returned
     *                                will match at least one of the marketplaces that you specify. (optional)
     * @param pageSize                The maximum number of reports to return in a single call. (optional, default to
     *                                10)
     * @param createdSince            The earliest report creation date and time for reports to include in the response,
     *                                in ISO 8601 date time format. The default is 90 days ago. Reports are retained for
     *                                a maximum of 90 days. (optional)
     * @param createdUntil            The latest report creation date and time for reports to include in the response,
     *                                in ISO 8601 date time format. The default is now. (optional)
     * @param nextToken               A string token returned in the response to your previous request. nextToken is
     *                                returned when the number of results exceeds the specified pageSize value. To get
     *                                the next page of results, call the getReports operation and include this token as
     *                                the only parameter. Specifying nextToken with any other parameters will cause the
     *                                request to fail. (optional)
     * @param progressListener        Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getReportsCall(List<String> reportTypes, List<String> processingStatuses,
            List<String> marketplaceIds, Integer pageSize, OffsetDateTime createdSince, OffsetDateTime createdUntil,
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getReportsValidateBeforeCall(List<String> reportTypes,
            List<String> processingStatuses, List<String> marketplaceIds, Integer pageSize, OffsetDateTime createdSince,
            OffsetDateTime createdUntil, String nextToken, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {

        com.squareup.okhttp.Call call = getReportsCall(reportTypes, processingStatuses, marketplaceIds, pageSize,
                createdSince, createdUntil, nextToken, progressListener, progressRequestListener);
        return call;

    }

    /**
     * Returns report details for the reports that match the filters that you specify.  **Usage Plan:**  | Rate
     * (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response
     * header returns the usage plan rate limits that were applied to the requested operation, when available. The table
     * above indicates the default rate and burst values for this operation. Selling partners whose business demands
     * require higher throughput may see higher rate and burst values than those shown here. For more information, see
     ...
     *                           Values](https://developer-docs.amazon.com/sp-api/docs/report-type-values) for more
     *                           information. When reportTypes is provided, the other filter parameters
     *                           (processingStatuses, marketplaceIds, createdSince, createdUntil) and pageSize may also
     *                           be provided. Either reportTypes or nextToken is required. (optional)
     * @param processingStatuses A list of processing statuses used to filter reports. (optional)
     * @param marketplaceIds     A list of marketplace identifiers used to filter reports. The reports returned will
     *                           match at least one of the marketplaces that you specify. (optional)
     * @param pageSize           The maximum number of reports to return in a single call. (optional, default to 10)
     * @param createdSince       The earliest report creation date and time for reports to include in the response, in
     *                           ISO 8601 date time format. The default is 90 days ago. Reports are retained for a
     *                           maximum of 90 days. (optional)
     * @param createdUntil       The latest report creation date and time for reports to include in the response, in ISO
     *                           8601 date time format. The default is now. (optional)
     * @param nextToken          A string token returned in the response to your previous request. nextToken is returned
     *                           when the number of results exceeds the specified pageSize value. To get the next page
     *                           of results, call the getReports operation and include this token as the only parameter.
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GetReportsResponse getReports(List<String> reportTypes, List<String> processingStatuses,
            List<String> marketplaceIds, Integer pageSize, OffsetDateTime createdSince, OffsetDateTime createdUntil,
            String nextToken) throws ApiException, LWAException {
        ApiResponse<GetReportsResponse> resp = getReportsWithHttpInfo(reportTypes, processingStatuses, marketplaceIds,
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GetReportsResponse> getReportsWithHttpInfo(List<String> reportTypes,
            List<String> processingStatuses, List<String> marketplaceIds, Integer pageSize, OffsetDateTime createdSince,
            OffsetDateTime createdUntil, String nextToken) throws ApiException, LWAException {
        com.squareup.okhttp.Call call = getReportsValidateBeforeCall(reportTypes, processingStatuses, marketplaceIds,
                pageSize, createdSince, createdUntil, nextToken, null, null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getReportsAsync(List<String> reportTypes, List<String> processingStatuses,
            List<String> marketplaceIds, Integer pageSize, OffsetDateTime createdSince, OffsetDateTime createdUntil,
            String nextToken, final ApiCallback<GetReportsResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getReportsValidateBeforeCall(reportTypes, processingStatuses, marketplaceIds,
                pageSize, createdSince, createdUntil, nextToken, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetReportsResponse>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
