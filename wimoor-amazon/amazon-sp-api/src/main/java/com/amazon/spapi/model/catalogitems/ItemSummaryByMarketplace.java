...
public class ItemSummaryByMarketplace {
    ...
    /**
     * Identifies an Amazon catalog item is memorabilia valued for its connection with historical events, culture, or
     * entertainment.
     *
     * @return memorabilia
     **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(marketplaceId, adultProduct, autographed, brand, browseClassification, color, contributors,
                itemClassification, itemName, manufacturer, memorabilia, modelNumber, packageQuantity, partNumber,
                releaseDate, size, style, tradeInEligible, websiteDisplayGroup, websiteDisplayGroupName);
    }
