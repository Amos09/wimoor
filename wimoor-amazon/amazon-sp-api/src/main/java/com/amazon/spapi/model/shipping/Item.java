...
public class Item {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(itemValue, description, itemIdentifier, quantity, weight, liquidVolume, isHazmat,
                dangerousGoodsDetails, productType, invoiceDetails, serialNumbers, directFulfillmentItemIdentifiers);
    }
    ...
    public String toString() {
        ...
        sb.append("    directFulfillmentItemIdentifiers: ").append(toIndentedString(directFulfillmentItemIdentifiers))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
