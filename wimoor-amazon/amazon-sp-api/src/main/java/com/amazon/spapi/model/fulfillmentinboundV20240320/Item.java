...
public class Item {
    ...
    /**
     * The expiration date of the MSKU in ISO 8601 format. The same MSKU with different expiration dates cannot go into
     * the same box.
     *
     * @return expiration
     **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(asin, expiration, fnsku, labelOwner, manufacturingLotCode, msku, prepInstructions,
                quantity);
    }
