...
public class RentalTransactionEvent {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(amazonOrderId, rentalEventType, extensionLength, postedDate, rentalChargeList,
                rentalFeeList, marketplaceName, rentalInitialValue, rentalReimbursement, rentalTaxWithheldList);
    }
