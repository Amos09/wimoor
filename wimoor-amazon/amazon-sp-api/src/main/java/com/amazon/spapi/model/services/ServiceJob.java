...
public class ServiceJob {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(createTime, serviceJobId, serviceJobStatus, scopeOfWork, seller, serviceJobProvider,
                preferredAppointmentTimes, appointments, serviceOrderId, marketplaceId, storeId, buyer, associatedItems,
                serviceLocation);
    }
