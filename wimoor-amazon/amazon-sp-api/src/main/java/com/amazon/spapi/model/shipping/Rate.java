...
public class Rate {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(rateId, carrierId, carrierName, serviceId, serviceName, billedWeight, totalCharge, promise,
                supportedDocumentSpecifications, availableValueAddedServiceGroups, requiresAdditionalInputs,
                rateItemList, paymentType, benefits);
    }
    ...
    public String toString() {
        ...
        sb.append("    supportedDocumentSpecifications: ").append(toIndentedString(supportedDocumentSpecifications))
                .append("\n");
        sb.append("    availableValueAddedServiceGroups: ").append(toIndentedString(availableValueAddedServiceGroups))
                .append("\n");
