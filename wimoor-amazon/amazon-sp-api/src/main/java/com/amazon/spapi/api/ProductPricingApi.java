...
public class ProductPricingApi {
     ...
     *                                (required)
     * @param itemType                Indicates whether ASIN values or seller SKU values are used to identify items. If
     *                                you specify Asin, the information in the response will be dependent on the list of
     *                                Asins you provide in the Asins parameter. If you specify Sku, the information in
     *                                the response will be dependent on the list of Skus you provide in the Skus
     ...
     * @param marketplaceId A marketplace identifier. Specifies the marketplace for which prices are returned.
     *                      (required)
     * @param itemType      Indicates whether ASIN values or seller SKU values are used to identify items. If you
     *                      specify Asin, the information in the response will be dependent on the list of Asins you
     *                      provide in the Asins parameter. If you specify Sku, the information in the response will be
     *                      dependent on the list of Skus you provide in the Skus parameter. Possible values: Asin, Sku.
     *                      (required)
     * @param asins         A list of up to twenty Amazon Standard Identification Number (ASIN) values used to identify
     *                      items in the given marketplace. (optional)
    ...
    public GetPricingResponse getCompetitivePricing(String marketplaceId, String itemType, List<String> asins,
            List<String> skus, String customerType) throws ApiException, LWAException {
    ...
    public ApiResponse<GetPricingResponse> getCompetitivePricingWithHttpInfo(String marketplaceId, String itemType,
            List<String> asins, List<String> skus, String customerType) throws ApiException, LWAException {
    ...
    /**
     * (asynchronously) Returns competitive pricing information for a seller&#39;s offer listings based on seller SKU or
     * ASIN.  **Note:** The parameters associated with this operation may contain special characters that require URL
     ...
     * @param marketplaceId           A marketplace identifier. Specifies the marketplace for which prices are returned.
     *                                (required)
     * @param itemCondition           Filters the offer listings to be considered based on item condition. Possible
     *                                values: New, Used, Collectible, Refurbished, Club. (required)
     * @param asin                    The Amazon Standard Identification Number (ASIN) of the item. (required)
     * @param customerType            Indicates whether to request Consumer or Business offers. Default is Consumer.
     *                                (optional)
     * @param progressListener        Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
    ...
    public ApiResponse<GetOffersResponse> getItemOffersWithHttpInfo(String marketplaceId, String itemCondition,
            String asin, String customerType) throws ApiException, LWAException {
    ...
    public com.squareup.okhttp.Call getItemOffersAsync(String marketplaceId, String itemCondition, String asin,
            String customerType, final ApiCallback<GetOffersResponse> callback) throws ApiException, LWAException {
    ...
    /**
     * Returns the lowest priced offers for a batch of items based on ASIN.  **Usage Plan:**  | Rate (requests per
     * second) | Burst | | ---- | ---- | | 0.1 | 1 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the
     * usage plan rate limits that were applied to the requested operation, when available. The table above indicates
     * the default rate and burst values for this operation. Selling partners whose business demands require higher
     * throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and
    ...
    public ApiResponse<GetItemOffersBatchResponse> getItemOffersBatchWithHttpInfo(
            GetItemOffersBatchRequest getItemOffersBatchRequestBody) throws ApiException, LWAException {
    ...
    public com.squareup.okhttp.Call getItemOffersBatchAsync(GetItemOffersBatchRequest getItemOffersBatchRequestBody,
            final ApiCallback<GetItemOffersBatchResponse> callback) throws ApiException, LWAException {
     ...
     * @param marketplaceId           A marketplace identifier. Specifies the marketplace for which prices are returned.
     *                                (required)
     * @param itemCondition           Filters the offer listings based on item condition. Possible values: New, Used,
    ...
    public GetOffersResponse getListingOffers(String marketplaceId, String itemCondition, String sellerSKU,
            String customerType) throws ApiException, LWAException {
    ...
    public ApiResponse<GetOffersResponse> getListingOffersWithHttpInfo(String marketplaceId, String itemCondition,
            String sellerSKU, String customerType) throws ApiException, LWAException {
    ...
    public GetListingOffersBatchResponse getListingOffersBatch(
            GetListingOffersBatchRequest getListingOffersBatchRequestBody) throws ApiException, LWAException {
    ...
    public com.squareup.okhttp.Call getListingOffersBatchAsync(
            GetListingOffersBatchRequest getListingOffersBatchRequestBody,
            final ApiCallback<GetListingOffersBatchResponse> callback) throws ApiException, LWAException {
     ...
     * @param offerType               Indicates whether to request pricing information for the seller&#39;s B2C or B2B
     ...
     *                      specify Asin, the information in the response will be dependent on the list of Asins you
     *                      provide in the Asins parameter. If you specify Sku, the information in the response will be
     *                      dependent on the list of Skus you provide in the Skus parameter. (required)
     * @param asins         A list of up to twenty Amazon Standard Identification Number (ASIN) values used to identify
     *                      items in the given marketplace. (optional)
     * @param skus          A list of up to twenty seller SKU values used to identify items in the given marketplace.
     *                      (optional)
    ...
    public GetPricingResponse getPricing(String marketplaceId, String itemType, List<String> asins, List<String> skus,
            String itemCondition, String offerType) throws ApiException, LWAException {
