...
public class InboundShipmentItem {
     ...
     * in the inbound shipment equals QuantityShipped. Also note that all of the boxes of an inbound shipment must
     * either be case packed or individually packed. For that reason, when you submit the createInboundShipment or the
     * updateInboundShipment operation, the value of QuantityInCase must be provided for every item in the shipment or
    ...
    @Override
    public int hashCode() {
        return Objects.hash(shipmentId, sellerSKU, fulfillmentNetworkSKU, quantityShipped, quantityReceived,
                quantityInCase, releaseDate, prepDetailsList);
    }
