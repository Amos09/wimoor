...
public class PackingOption {
    ...
    /**
     * The timestamp at which this packing option becomes no longer valid. This is based in ISO 8601 datetime with
    ...
    @Override
    public int hashCode() {
        return Objects.hash(discounts, expiration, fees, packingGroups, packingOptionId, status,
