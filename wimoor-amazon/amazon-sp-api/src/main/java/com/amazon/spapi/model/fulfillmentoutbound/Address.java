...
public class Address {
    ...
    /**
     * The city where the person, business, or institution is located. This property is required in all countries except
     * Japan. It should not be used in Japan.
     *
     * @return city
     **/
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, addressLine1, addressLine2, addressLine3, city, districtOrCounty, stateOrRegion,
