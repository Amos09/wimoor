...
public class AccessPoint {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(accessPointId, name, timezone, type, accessibilityAttributes, address,
                exceptionOperatingHours, assistanceType, score, standardOperatingHours);
    }
