...
public class TokensApi {
     ...
     */
    public com.squareup.okhttp.Call createRestrictedDataTokenCall(CreateRestrictedDataTokenRequest body,
    ...
    private com.squareup.okhttp.Call createRestrictedDataTokenValidateBeforeCall(CreateRestrictedDataTokenRequest body,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener)
            throws ApiException, LWAException {
     ...
     * ---- | | 1 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call createRestrictedDataTokenAsync(CreateRestrictedDataTokenRequest body,
            final ApiCallback<CreateRestrictedDataTokenResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = createRestrictedDataTokenValidateBeforeCall(body, progressListener,
