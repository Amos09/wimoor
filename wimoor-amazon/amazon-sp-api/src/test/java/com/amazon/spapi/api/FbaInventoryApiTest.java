...
public class FbaInventoryApiTest {
    ...
    public void getInventorySummariesTest() throws ApiException, LWAException {
        ...
        GetInventorySummariesResponse response = api.getInventorySummaries(granularityType, granularityId,
                marketplaceIds, details, startDateTime, sellerSkus, sellerSku, nextToken);
