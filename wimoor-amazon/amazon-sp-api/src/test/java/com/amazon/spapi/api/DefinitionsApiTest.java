...
public class DefinitionsApiTest {
     ...
     * x-amzn-RateLimit-Limit response header returns the usage plan rate limits that wer ApiException if the A
     * <p>
     * Selling Partner API](doc and Rate Limits in the
     * <p>
     * import com.amazon.spapi.SellingPartnerAPIAA.LWAException; import com.amazon.spapi.client.ApiException; import
     * com.amazon.spapi.model.definitions.ProductTypeDefinition; import
     * com.amazon.spapi.model.definitions.ProductTypeList;ils
     */
    @Test
    public void getDefinitionsProductTypeTest() throws ApiException, LWAException {
        ...
        String locale = null;
        ProductTypeDefinition response = api.getDefinitionsProductType(productType, marketplaceIds, sellerId,
...
// TODO: test validations
    ...
    public void searchDefinitionsProductTypesTest() throws ApiException, LWAException {
        ...
        ProductTypeList response = api.searchDefinitionsProductTypes(marketplaceIds, keywords, itemName, locale,
                searchLocale);
