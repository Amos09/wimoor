...
public interface ErpClientOneFeign {
    ...
    public Result<Map<String, Object>> fullfillableToOutboundAction(@RequestParam String userid,
            @RequestParam String formid, @RequestParam String warehouseid, @RequestParam String number,
    ...
    public Result<List<Map<String, Object>>> findPlanSubDetailAction(@RequestParam String groupid,
            @RequestParam String planid, @RequestParam String warehouseid, @RequestParam String marketplaceid,
            @RequestParam String issplit);
    ...
    public Result<List<Map<String, Object>>> getShipArrivalTimeRecord(@RequestParam String shopid,
            @RequestParam String country, @RequestParam String groupid, @RequestParam String sku);
