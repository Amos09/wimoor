...
public class WarehouseShelfServiceImpl extends ServiceImpl<WarehouseShelfMapper, WarehouseShelf> implements
        IWarehouseShelfService {
    ...
    public List<WarehouseShelfTreeVo> recursionTreeSelectList(UserInfo user, String parentId,
            List<ErpWarehouseAddress> wareList) {
        ...
        Optional.ofNullable(wareList).orElse(new ArrayList<>())
                ...
                .forEach(warehouse -> {
                    ...
                    List<WarehouseShelfTreeVo> childrenShelf = recursionShelfTreeSelectList(user, treeSelectVO.getId(),
                            list);
    ...
    public List<WarehouseShelfTreeVo> recursionShelfTreeSelectList(UserInfo user, String parentId,
            List<WarehouseShelf> shelfList) {
        ...
        Optional.ofNullable(shelfList).orElse(new ArrayList<>())
                .stream()
                .filter(shelf -> (parentId == null && shelf.getParentid() == null) || (parentId != null
                        && shelf.getParentid().toString().equals(parentId)))
                .forEach(shelf -> {
                    WarehouseShelfTreeVo treeSelectVO = new WarehouseShelfTreeVo();
