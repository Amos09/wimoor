...
public class PurchaseAlibabaSettlementController {
    ...
    public Result<String> uploadPayDateAction(@RequestParam("file") MultipartFile file, @RequestParam String acct,
        ...
        if (file != null) {
            try {
                ...
                Boolean ordererror = purchaseAlibabaSettlementOrderService.paySettlementSheetOrder(workbook,
                        settlement);
                Boolean payerror = purchaseAlibabaSettlementPayService.uploadSettlementSheet(workbook, settlement);
                Boolean orderReturnError = purchaseAlibabaSettlementOrderReturnService.paySettlementSheetOrder(workbook,
                        settlement);
                Boolean payReturnError = purchaseAlibabaSettlementPayReturnService.uploadSettlementSheet(workbook,
                        settlement);
    ...
    public Result<?> orderListAction(@RequestBody PurchaseSettlementDTO dto) {
        ...
        List<PurchaseAlibabaSettlementOrder> list = query.eq(PurchaseAlibabaSettlementOrder::getSettlementid,
                        dto.getSettlementid())
                .list();
        ...
        if (dto.getIscheck() != null && dto.getIscheck() == true) {
            for (PurchaseAlibabaSettlementOrder item : list) {
                try {
                    ...
                    purchaseFormEntryAlibabaInfoService.checkPay(new BigInteger(item.getOrderid().toString()), price,
                            settlment.getAcct());
