...
public class ErpDispatchOverseaTransController {
    ...
    public Result<ErpDispatchOverseaTrans> getInfoAction(String id) {
        return Result.success(
                iErpDispatchOverseaTransService.lambdaQuery().eq(ErpDispatchOverseaTrans::getFormid, id).one());
    }
    ...
    public Result<Boolean> saveInfoAction(@RequestBody ErpDispatchOverseaTrans trans) {
        ...
        ErpDispatchOverseaTrans one = iErpDispatchOverseaTransService.lambdaQuery()
                .eq(ErpDispatchOverseaTrans::getFormid, trans.getFormid()).one();
        if (one == null) {
