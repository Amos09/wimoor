...
public class ShipTransCompanyZhihuiServiceImpl extends
        ServiceImpl<ShipTransCompayServicesZhihuiMapper, ShipTransCompayServicesZhihui> implements
        IShipTransCompanyZhihuiService {
    ...
    public JSONObject getZhApiJson(UserInfo user, ShipTransCompayAPI companyapi, ShipTransCompany stcompany,
            String shipmentid) {
    ...
    public JSONObject getZmApiJson(UserInfo user, ShipTransCompayAPI companyapi, ShipTransCompany stcompany,
            String ordernum) {
        ...
        String version = "1.0";
        String body =
                "{\"companyNo\":\"YHECN\",\"queryType\":\"5\",\"custNo\":\"Test01\",\"noList\":\"" + ordernum + "\"}";
    ...
    @SuppressWarnings("unchecked")
    public JSONObject getYdApiJson(UserInfo user, ShipTransCompayAPI companyapi, ShipTransCompany stcompany,
            String ordernum) {
        String url = "http://ois.intelink.net:8003/ois-web";
        String appKey = "TKWDZ8907_YHECN";
        String appSecret = "9538227e1d644b33a42cd01bd4389b81";
    ...
    public String getShipTransService(UserInfo user, ShipTransCompayAPI api, ShipTransCompany accessToken,
            String service) {
        // TODO Auto-generated method stub
