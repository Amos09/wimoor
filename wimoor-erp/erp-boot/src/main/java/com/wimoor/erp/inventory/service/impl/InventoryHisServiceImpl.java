...
public class InventoryHisServiceImpl extends ServiceImpl<InventoryHisMapper, InventoryHis> implements
        IInventoryHisService {
    ...
    public List<Map<String, Object>> findInvDayList(Map<String, Object> maps) {
        ...
        if (toDate.equals(GeneralUtil.formatDate(new Date()))) {
            List<Map<String, Object>> endlist = inventoryRecordMapper.findSkuNowInventory(shopid, materialid,
                    warehouseid);
