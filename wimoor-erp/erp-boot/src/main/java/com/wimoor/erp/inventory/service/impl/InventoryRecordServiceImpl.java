...
public class InventoryRecordServiceImpl extends ServiceImpl<InventoryRecordMapper, InventoryRecord> implements
        IInventoryRecordService {
    ...
    @Override
    public Map<String, Object> findSkuInvHistory(String materialid, String fromDate, String toDate, String warehouseid,
            String shopid) {
        //sku期间入库和出库的数量
