 ...
 */
@Service
public class ErpDispatchOverseaTransServiceImpl extends
        ServiceImpl<ErpDispatchOverseaTransMapper, ErpDispatchOverseaTrans> implements IErpDispatchOverseaTransService {
