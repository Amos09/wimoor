...
public class AssemblyEntryInstockServiceImpl extends
        ServiceImpl<AssemblyEntryInstockMapper, AssemblyEntryInstock> implements IAssemblyEntryInstockService {
        ...
        if (result > 0) {
            ...
            if (entity.getAmount() > 0) {
                ...
                if (result2 > 0) {
                    ...
                    assemblyForm.setAmountHandle(
                            assemblyForm.getAmountHandle() + Integer.parseInt(entity.getAmount().toString()));
    ...
    public Map<String, Object> saveSplitInStock(AssemblyEntryInstock entity, AssemblyForm assemblyForm, UserInfo user)
            throws BizException {
        Map<String, Object> msgMap = new HashMap<String, Object>();
        List<Map<String, Object>> instocklist = selectByFormId(entity.getFormid());
        Integer amount = 0;
