...
public interface FinJournalAccountMapper extends BaseMapper<FinJournalAccount> {
    ...
    List<Map<String, Object>> findAllAcountByType(@Param("shopid") String shopid, @Param("acc") String acc,
            @Param("year") String year, @Param("month") String month);

    List<Map<String, Object>> findMonthCharts(@Param("shopid") String shopid, @Param("acc") String acc,
            @Param("year") String year);

    List<Map<String, Object>> findMonthDetailCharts(@Param("shopid") String shopid, @Param("acc") String acc,
            @Param("year") String year, @Param("month") String month);
}