...
public class ErpPurchaseFormEntryAlibabainfoController {
    ...
    public Result<Object> catchLogisticsInfoAction(String purchaseEntryid) throws BizException {
        ...
        PurchaseFormEntryAlibabaInfo resultObj = purchaseFormEntryAlibabaInfoService.getEntryAlibabainfo(
                purchaseEntryid);
        if (resultObj == null) {
        ...
        return Result.success(
                purchaseFormEntryAlibabaInfoService.captureLogisticsInfo(userinfo, alibabaAuthid, alibabaOrderid,
                        purchaseEntryid));
    }
    ...
    public Result<JSONObject> bindProductInfoAction(@RequestBody Map<String, Object> param) throws BizException {
        ...
        Map<String, Object> productInfo =
                param.get("productInfo") != null ? BeanUtil.beanToMap(param.get("productInfo")) : null;
        Map<String, Object> orderInfo =
                param.get("orderInfo") != null ? BeanUtil.beanToMap(param.get("orderInfo")) : null;
...
//			 }
        ...
        if (sellerContact != null) {
            imInPlatform =
                    sellerContact.get("imInPlatform") != null ? sellerContact.get("imInPlatform").toString() : null;
    ...
    public Result<PurchaseFormEntryLogistics> bindLogisticsIdAction(String purchaseEntryid, String logisticsId)
            throws BizException {
