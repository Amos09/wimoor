...
public class OutWarehouseFormServiceImpl extends ServiceImpl<OutWarehouseFormMapper, OutWarehouseForm> implements
        IOutWarehouseFormService {
    ...
    public Map<String, Object> saveForm(OutWarehouseForm outWarehouseForm, Map<String, Object> skuMap, UserInfo user)
            throws BizException {
    ...
    public Map<String, Object> saveAction(OutWarehouseForm outWarehouseForm, String skumapstr, UserInfo user)
            throws BizException {
