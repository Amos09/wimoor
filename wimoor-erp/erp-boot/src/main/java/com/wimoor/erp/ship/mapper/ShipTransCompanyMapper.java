...
public interface ShipTransCompanyMapper extends BaseMapper<ShipTransCompany> {
    ...
    IPage<ShipTransCompany> findByCondition(Page<?> page, @Param("shopid") String shopid,
            @Param("search") String search, @Param("isdelete") String isdelete);
    ...
    List<Map<String, Object>> findAllByCondition(@Param("shopid") String shopid, @Param("mydate") String date,
