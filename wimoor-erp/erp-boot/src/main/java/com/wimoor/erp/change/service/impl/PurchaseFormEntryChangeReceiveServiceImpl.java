...
public class PurchaseFormEntryChangeReceiveServiceImpl extends
        ServiceImpl<PurchaseFormEntryChangeReceiveMapper, PurchaseFormEntryChangeReceive> implements
        IPurchaseFormEntryChangeReceiveService {
    ...
    public Map<String, Object> saveMineAndinStock(PurchaseFormEntryChangeReceive purchaseChangeReceive, UserInfo user) {
        ...
        //每次入库操作 增加可用库存 减少待入库
        PurchaseFormEntryChange entry = purchaseFormEntryChangeMapper.selectById(
                purchaseChangeReceive.getEntrychangeid());
