...
public interface ShipPlanItemMapper extends BaseMapper<ShipPlanItem> {
    ...
    ShipPlanItem findItemByCondition(@Param("planid") String planid, @Param("marketplaceid") String marketplaceid,
    ...
    List<Map<String, Object>> findPlanSubDetail(@Param("planid") String planid,
            @Param("marketplaceid") String marketplaceid, @Param("warehouseid") String warehouseid);

    List<Map<String, Object>> findPlanEuSubDetail(@Param("planid") String planid,
            @Param("marketplaceid") String marketplaceid, @Param("warehouseid") String warehouseid);
