...
public class PurchaseFormEntryAlibabaInfoServiceImpl extends
        ServiceImpl<PurchaseFormEntryAlibabaInfoMapper, PurchaseFormEntryAlibabaInfo>
    ...
    public JSONObject captureAlibabaOrderInfo(UserInfo user, String alibabaAuthid, String alibabaOrderid,
    ...
    public JSONObject captureAlibabaOrder(UserInfo user, String alibabaAuthid, String alibabaOrderid,
            String purchaseEntryid) {
        PurchaseFormEntryAlibabaInfo oldone = this.getById(purchaseEntryid);
        PurchaseFormEntryAlibabaInfoExt oldext = purchaseFormEntryAlibabaInfoExtMapper.selectById(purchaseEntryid);
        if (oldone != null && oldext != null && oldext.getOrderStatus() != null && oldext.getOrderStatus()
                .equals("success")) {
        ...
        if (result != null) {
            ...
            if (info != null && user != null && oldext == null) {
                ...
                MaterialSupplier supplier = iMaterialSupplierService.selectSupplier(entry.getMaterialid(),
                        entry.getSupplier());
                for (int i = 0; i < productItems.size(); i++) {
                    JSONObject product = productItems.getJSONObject(i);
                    String specId = product.getString("specId");
                    String productID = product.getString("productID");
                    if (supplier != null && supplier.getSpecid() != null && supplier.getProductcode() != null
                            && specId.equals(supplier.getSpecid()) && productID.equals(supplier.getProductcode())) {
                        ...
                        for (MaterialSupplier supplierother : supplierothers) {
                            ...
                            PurchaseFormEntry entryother = iPurchaseFormEntryService.lambdaQuery()
                                    .eq(PurchaseFormEntry::getFormid, entry.getFormid())
                            ...
                            PurchaseFormEntryAlibabaInfoExt oldotherext = this.purchaseFormEntryAlibabaInfoExtMapper.selectById(
                                    entryother.getId());
                            if (oldotherext != null && oldotherext.getOrderStatus() != null
                                    && oldotherext.getOrderStatus().equals("success")) {
                                PurchaseFormEntryAlibabaInfo oldotherone = this.baseMapper.selectById(
                                        entryother.getId());
                                ...
                                PurchaseFormEntryAlibabaInfoExt oext = this.purchaseFormEntryAlibabaInfoExtMapper.selectById(
                                        entryother.getId());
                                if (old != null) {
            ...
            public void run() {
                ...
                try {
                    for (PurchaseFormEntryAlibabaInfo item : list) {
                        try {
                            captureAlibabaOrder(null, item.getAlibabaAuth().toString(),
                                    item.getAlibabaOrderid().toString(), item.getEntryid());
                        } catch (Exception e) {
                ...
                for (PurchaseFormEntryAlibabaInfo item : list) {
                    try {
                        captureLogisticsTraceInfo(null, item.getAlibabaAuth().toString(),
                                item.getAlibabaOrderid().toString(), item.getEntryid());
                    } catch (Exception e) {
                        // TODO Auto-generated catch block
                        e.printStackTrace();
    ...
    public JSONObject bindAlibabaOrder(UserInfo user, String alibabaAuthid, String alibabaOrderid,
            String purchaseEntryid) {
        // TODO Auto-generated method stub
        return captureAlibabaOrder(user, alibabaAuthid, alibabaOrderid, purchaseEntryid);
    }

    public Object captureLogisticsInfo(UserInfo user, String alibabaAuthid, String alibabaOrderid,
            String purchaseEntryid) {
        // TODO Auto-generated method stub
        ...
        if (oldext != null && oldone != null && oldext.getOrderStatus() != null && oldext.getOrderStatus()
                .equals("success")) {
            map.put("orderResult", GeneralUtil.getJsonObject(oldone.getOrderInfo()));
            if (oldone.getLogisticsInfo() == null) {
                map.put("orderResult",
                        this.captureAlibabaOrderInfo(user, alibabaAuthid, alibabaOrderid, purchaseEntryid));
                map.put("TraceResult",
                        this.captureLogisticsTraceInfo(user, alibabaAuthid, alibabaOrderid, purchaseEntryid));
            } else {
    ...
    public JSONObject preview(Map<String, Object> params) {
        ...
        String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.createOrder.preview", 1, "param2",
                alibabaAuth.getAppkey());
    ...
    public JSONObject createCrossOrder(Map<String, Object> params) {
        ...
        String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.trade.createCrossOrder", 1,
                "param2", alibabaAuth.getAppkey());
        JSONObject json = purchaseAlibabaAuthService.callApi(urlPath, alibabaAuth.getAppsecret(), param);
        return json;
    }
    ...
    public JSONObject getRefundReasonList(Map<String, Object> params) {
        ...
        String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.trade.getRefundReasonList", 1,
                "param2", alibabaAuth.getAppkey());
        JSONObject json = purchaseAlibabaAuthService.callApi(urlPath, alibabaAuth.getAppsecret(), param);
        return json;
    }
    ...
    public JSONObject createRefund(Map<String, Object> params) {
        ...
        String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.trade.createRefund", 1, "param2",
                alibabaAuth.getAppkey());
        JSONObject json = purchaseAlibabaAuthService.callApi(urlPath, alibabaAuth.getAppsecret(), param);
        return json;
    }
    ...
    public JSONObject payWay(String alibabaAuthid, String orderid) {
        ...
        String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.trade.payWay.query", 1, "param2",
                alibabaAuth.getAppkey());
        JSONObject json = purchaseAlibabaAuthService.callApi(urlPath, alibabaAuth.getAppsecret(), param);
        return json;
    }
    ...
    public JSONObject payUrl(Map<String, Object> params) {
        ...
        if (channel.equals("1")) {
            String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.alipay.url.get", 1, "param2",
                    alibabaAuth.getAppkey());
            JSONObject json = purchaseAlibabaAuthService.callApi(urlPath, alibabaAuth.getAppsecret(), param);
            return json;
        } else if (channel.equals("3")) {
            String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.creditPay.url.get", 1,
                    "param2", alibabaAuth.getAppkey());
            JSONObject json = purchaseAlibabaAuthService.callApi(urlPath, alibabaAuth.getAppsecret(), param);
            return json;
        } else if (channel.equals("16") || channel.equals("20")) {
            String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.crossBorderPay.url.get", 1,
                    "param2", alibabaAuth.getAppkey());
            JSONObject json = purchaseAlibabaAuthService.callApi(urlPath, alibabaAuth.getAppsecret(), param);
            return json;
        } else {
    ...
    public void checkPay(BigInteger number, BigDecimal price, String acct) {
        ...
        if (number != null && price != null) {
            BigDecimal totalprice = purchaseFormEntryAlibabaInfoExtMapper.getPriceByAlibabaOrder(number.toString(),
                    acct);
