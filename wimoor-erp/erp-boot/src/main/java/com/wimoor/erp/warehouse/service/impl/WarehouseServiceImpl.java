...
public class WarehouseServiceImpl extends ServiceImpl<WarehouseMapper, Warehouse> implements IWarehouseService {
    ...
    public List<Warehouse> recursionWarehouseSelectList(UserInfo user, String parentId, List<Warehouse> wareList,
        ...
        Optional.ofNullable(wareList).orElse(new ArrayList<>())
                .stream()
                .filter(warehouse -> (parentId == null && warehouse.getParentid() == null) || (parentId != null
                        && warehouse.getParentid() != null && warehouse.getParentid().equals(parentId)))
                .forEach(warehouse -> {
    ...
    public LinkedList<Map<String, Object>> selectShipFbaSale(String shopid, String sku, String materialid,
            String planid, String groupid) {
    ...
    @Override
    public void saveWareTypeList(String warehouselistStr, String shopid, UserInfo user, Warehouse house)
            throws Exception {
