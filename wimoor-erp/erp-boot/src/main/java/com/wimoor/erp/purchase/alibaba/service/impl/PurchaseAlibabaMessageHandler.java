                        ...
                        if ("LOGISTICS_MAIL_NO_CHANGE".equals(ftype)) {
                            ...
                            if (auth != null) {
                                ...
                                if (order != null) {
                                    ...
                                    PurchaseFormEntryAlibabaInfo info = purchaseFormEntryAlibabaInfoService.selectByOrderAndAuth(
                                            authid, orderid);
                                    if (info != null) {
                                        ...
                                        List<PurchaseFormEntryLogistics> loglist = purchaseFormEntryLogisticsMapper.selectList(
                                                queryWrapper);
