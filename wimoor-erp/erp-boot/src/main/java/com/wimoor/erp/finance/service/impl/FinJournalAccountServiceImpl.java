...
public class FinJournalAccountServiceImpl extends ServiceImpl<FinJournalAccountMapper, FinJournalAccount> implements
        IFinJournalAccountService {
    ...
    public void cancelData(String id, UserInfo userinfo) {
        ...
        faccountService.updateFinCancelChange(account, faccount.getProjectid(), faccount.getCreatetime(),
                faccount.getAmount(), faccount.getFtype());
    ...
    public Map<Integer, Map<String, Object>> findLineDataByYear(UserInfo user, String acc, String year, String month) {
        ...
        if (month == null) {
            ...
            month = intmonth + "";
            List<Map<String, Object>> list = this.baseMapper.findMonthDetailCharts(user.getCompanyid(), acc, year,
                    month);
            Integer index = 0;
