 ...
 */
@Service
public class StockTakingItemShelfServiceImpl extends
        ServiceImpl<StockTakingItemShelfMapper, StockTakingItemShelf> implements IStockTakingItemShelfService {
    ...
    public void stockTakingInvOperate(StockTaking stocktaking, UserInfo user) {
        ...
        List<StockTakingItemShelf> list = this.lambdaQuery()
                .eq(StockTakingItemShelf::getStocktakingid, stocktaking.getId()).list();
