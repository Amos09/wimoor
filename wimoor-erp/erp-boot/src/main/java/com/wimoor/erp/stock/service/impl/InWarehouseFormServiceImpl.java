...
public class InWarehouseFormServiceImpl extends ServiceImpl<InWarehouseFormMapper, InWarehouseForm> implements
        IInWarehouseFormService {
    ...
    public Map<String, Object> saveForm(InWarehouseForm inWarehouseForm, Map<String, Object> skuMap, UserInfo user)
            throws BizException {
        int result = 0;
        String msg = "";
        Map<String, Object> map = new HashMap<String, Object>();
        if (skuMap != null && skuMap.size() > 0) {
            List<Map<String, Object>> oldentrylist = inWarehouseFormEntryService.selectByFormid(
                    inWarehouseForm.getId());
    ...
    public Map<String, Object> saveAction(InWarehouseForm inWarehouseForm, String sku, UserInfo user)
            throws BizException {
