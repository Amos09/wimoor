...
public class ErpDispatchOverseaFormController {
    ...
    public Result<Boolean> updateRemarkAction(String formid, String remark) {
        boolean result = iErpDispatchOverseaFormService.lambdaUpdate().set(ErpDispatchOverseaForm::getRemark, remark)
                .eq(ErpDispatchOverseaForm::getId, formid).update();
        return Result.success(result);
    }
    ...
    public void downPDFShipFormAction(@ApiParam("货件ID") @RequestParam String id, HttpServletResponse response) {
        ...
        try {
            ...
            List<Map<String, Object>> dispatchFormEntryList = iErpDispatchOverseaFormEntryService.findFormDetailByFormid(
                    id, data.get("to_warehouseid").toString(), data.get("from_warehouseid").toString(), shopid);
    ...
    public Result<List<Map<String, Object>>> getShipArrivalTimeRecord(String shopid, String country, String groupid,
            String sku) {
