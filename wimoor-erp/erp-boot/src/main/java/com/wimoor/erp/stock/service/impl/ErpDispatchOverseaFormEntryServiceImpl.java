...
public class ErpDispatchOverseaFormEntryServiceImpl extends
        ServiceImpl<ErpDispatchOverseaFormEntryMapper, ErpDispatchOverseaFormEntry> implements
        IErpDispatchOverseaFormEntryService {

    final FileUpload fileUpload;

    @Override
    public List<Map<String, Object>> findFormDetailByFormid(String formid, String warehouseid, String warehouseid2,
            String shopid) {
        // TODO Auto-generated method stub
        List<Map<String, Object>> list = this.baseMapper.findFormDetailByFormid(formid, warehouseid, warehouseid2,
                shopid);
        if (list.size() > 0) {
