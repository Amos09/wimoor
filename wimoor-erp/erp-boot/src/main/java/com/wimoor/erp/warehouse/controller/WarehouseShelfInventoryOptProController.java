...
public class WarehouseShelfInventoryOptProController {
    ...
    @GetMapping("/list")
    public Result<List<WarehouseShelfInventoryOptRecordVo>> getShelfInvAction(String formid, String materialid,
            String formtype) {
        UserInfo user = UserInfoContext.get();
        String shopid = user.getCompanyid();
        return Result.success(
                iWarehouseShelfInventoryOptRecordService.getRecordVo(shopid, formid, formtype, materialid));
    }
