...
public class MaterialController {
    ...
    public Result<IPage<Map<String, Object>>> list(@RequestBody MaterialDTO dto) {
        ...
        map.put("midlist",
                dto.getMaterialList() != null && dto.getMaterialList().size() > 0 ? dto.getMaterialList() : null);
    ...
    public Result<MaterialInfoVO> getMaterialInfoAction(@ApiParam("产品ID") @RequestParam String id) {
        ...
        List<MaterialConsumableVO> consumableList = iMaterialConsumableService.selectConsumableByMainmid(data.getId(),
                shopid);
        List<MaterialConsumableVO> consumablePList = iMaterialConsumableService.selectConsumableBySubmid(data.getId(),
                null, shopid);
    ...
    public Result<List<Map<String, Object>>> getMaterialBySKUAction(@PathVariable String shopid,
    ...
    public Result<MaterialInfoVO> getMaterialInfoAction(@ApiParam("本地SKU") @RequestParam String sku,
        ...
        if (StrUtil.isNotBlank(warehouseid)) {
            ...
            Inventory inv = inventoryService.selectNowInv(warehouseid, m.getId(), userinfo.getCompanyid(),
                    Status.fulfillable);
...
//		} 
    ...
    public Result<Integer> getAssemblyCanAction(@RequestParam String materialid, @RequestParam String warehouseid,
    ...
    public Result<Map<String, String>> getTagsIdsListByMsku(@PathVariable String shopid,
            @RequestBody List<String> mskulist) {
    ...
    @Transactional
    public Result<Map<String, Object>> saveAction(String infostr,
                ...
                if ("2".equals(issfg)) {
                    ...
                    if (asslist != null && asslist.size() > 0) {
                        for (Assembly assemblymain : asslist) {
                            ...
                            String mainSku =
                                    material.getSku() + "已存在于主SKU：" + mainMaterial.getSku() + ",无法归档!";
                ...
                if (material.getMtype() == 1) {
                    ...
                    if (conlist != null && conlist.size() > 0) {
                        throw new BizException(
                                "辅料:" + material.getSku() + " 正在被其它主SKU使用，无法删除！系统终止删除操作");
                    }
                }
        ...
        if (dto.getIscheck() != null && dto.getIscheck().equals("all")) {
            ...
            for (Map<String, Object> item : list) {
                ...
                List<Map<String, Object>> mainlist =
                        sub.get("mainlist") != null ? (List<Map<String, Object>>) sub.get("mainlist")
            ...
            for (Entry<String, Map<String, Object>> subentry : submap.entrySet()) {
                ...
                if (sub.get("mainlist") != null) {
                    ...
                    for (Map<String, Object> mainitem : mainlist) {
                        ...
                        Integer mquantity = mainitem.get("mquantity") != null ? Integer.parseInt(
                                mainitem.get("mquantity").toString()) : 0;
                        Integer subnumber = mainitem.get("subnumber") != null ? Integer.parseInt(
                                mainitem.get("subnumber").toString()) : 0;
                        Map<String, Object> plan = planmap.get(msku);
                        if (plan != null) {
                            Integer amount =
                                    plan.get("amount") != null ? Integer.parseInt(plan.get("amount").toString()) : 0;
    ...
    public void downExcelTempAction(@RequestBody MaterialDTO dto, HttpServletResponse response) {
        ...
        try {
            ...
            response.addHeader("Content-Disposition",
                    "attachment;fileName=" + dto.getDowntype() + "Records.xlsx");// 设置文件名
            fOut = response.getOutputStream();
