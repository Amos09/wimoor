...
public class PurchaseFormEntryChangeServiceImpl extends
        ServiceImpl<PurchaseFormEntryChangeMapper, PurchaseFormEntryChange> implements IPurchaseFormEntryChangeService {
    ...
    public Map<String, Object> saveAction(PurchaseFormEntryChangeVo inWarehouseForm, String sku, UserInfo user)
            throws BizException {
    ...
    public Map<String, Object> saveForm(PurchaseFormEntryChangeVo inWarehouseForm, Map<String, Object> skuMap,
