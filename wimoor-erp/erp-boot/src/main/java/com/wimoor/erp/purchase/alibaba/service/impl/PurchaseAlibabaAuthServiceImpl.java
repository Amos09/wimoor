...
public class PurchaseAlibabaAuthServiceImpl extends
        ServiceImpl<PurchaseAlibabaAuthMapper, PurchaseAlibabaAuth> implements IPurchaseAlibabaAuthService {
    ...
    public PurchaseAlibabaAuth saveAction(PurchaseAlibabaAuth purchaseAlibabaAuth) {
        ...
        if (purchaseAlibabaAuth.idIsNULL()) {
            ...
            if (StrUtil.isBlank(purchaseAlibabaAuth.getAppsecret()) || purchaseAlibabaAuth.getAppsecret()
                    .equals("**********")) {
            ...
            if (purchaseAlibabaAuth_old != null && !purchaseAlibabaAuth_old.getId()
                    .equals(purchaseAlibabaAuth.getId())) {
                throw new ERPBizException("店铺名称重复!");
            } else {
    ...
    public PurchaseAlibabaAuth refreshAuthToken(PurchaseAlibabaAuth purchaseAlibabaAuth) {
        ...
        String url =
                "https://gw.open.1688.com/openapi/param2/1/system.oauth2/getToken/" + purchaseAlibabaAuth.getAppkey();
    ...
    public PurchaseAlibabaAuth refreshAuthRefreshToken(PurchaseAlibabaAuth purchaseAlibabaAuth) {
        String url = "https://gw.open.1688.com/openapi/param2/1/system.oauth2/postponeToken/"
                + purchaseAlibabaAuth.getAppkey();
    ...
    public boolean checkAuthorityToken(PurchaseAlibabaAuth alibabaAuth) {
        if (alibabaAuth != null && alibabaAuth.getAccessTokenTimeout() != null && new Date().after(
                alibabaAuth.getAccessTokenTimeout())) {
            if (this.refreshAuthToken(alibabaAuth) == null) {
                return true;
            }
        }
        return false;
    ...
    public JSONObject captureOrderFromAlibaba(UserInfo user, String alibabaAuthid, String alibabaOrderid) {
        ...
        if (alibabaAuth.isDelete() == false) {
            ...
            param.put("orderId", alibabaOrderid);
            param.put("access_token", alibabaAuth.getAccessToken());
            String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.trade.get.buyerView", 1,
    ...
    public Object getAddress(String id) {
        ...
        Map<String, String> param = new HashMap<String, String>();
        param.put("access_token", alibabaAuth.getAccessToken());
        String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.trade.receiveAddress.get", 1,
                "param2", alibabaAuth.getAppkey());
        JSONObject json = this.callApi(urlPath, alibabaAuth.getAppsecret(), param);
        return json;
    }
    ...
    public JSONObject addFeedback(String alibabaAuthid, String alibabaOrderid, String remark) {
        ...
        String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.trade.addFeedback", 1, "param2",
    ...
    public JSONObject cancelOrder(String alibabaAuthid, String alibabaOrderid, String cancelReason, String remark) {
        ...
        String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.trade", "alibaba.trade.cancel", 1, "param2",
                alibabaAuth.getAppkey());
        JSONObject json = this.callApi(urlPath, alibabaAuth.getAppsecret(), param);
        return json;
    }
    ...
    public JSONObject productInfo(String alibabaAuthid, String productId) {
        ...
        String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.product", "alibaba.cross.productInfo", 1, "param2",
                alibabaAuth.getAppkey());
        JSONObject json = this.callApi(urlPath, alibabaAuth.getAppsecret(), param);
        return json;
    }
    ...
    public JSONObject syncProductListPushed(String alibabaAuthid, String productId) {
        ...
        String urlPath = CommonUtil.buildInvokeUrlPath("com.alibaba.product.push",
                "alibaba.cross.syncProductListPushed", 1, "param2", alibabaAuth.getAppkey());
        JSONObject json = this.callApi(urlPath, alibabaAuth.getAppsecret(), param);
        return json;
    }
