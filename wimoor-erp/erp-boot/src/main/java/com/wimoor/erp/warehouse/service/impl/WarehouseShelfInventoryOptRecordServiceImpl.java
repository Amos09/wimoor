 ...
 */
@Service
public class WarehouseShelfInventoryOptRecordServiceImpl extends
        ServiceImpl<WarehouseShelfInventoryOptRecordMapper, WarehouseShelfInventoryOptRecord> implements
        IWarehouseShelfInventoryOptRecordService {
    ...
    @Override
    public List<WarehouseShelfInventoryOptRecordVo> getRecordVo(String shopid, String formid, String formtype,
            String materialid) {
    ...
    public List<WarehouseShelfInventoryOptRecord> getRecord(String shopid, String formid, String formtype,
            String shelfid) {
        // TODO Auto-generated method stub
        LambdaQueryWrapper<WarehouseShelfInventoryOptRecord> query = new LambdaQueryWrapper<WarehouseShelfInventoryOptRecord>();
        query.eq(WarehouseShelfInventoryOptRecord::getShopid, shopid);
    ...
    public IPage<Map<String, Object>> getOptList(ShelfInvListDto condition, String shopid) {
        IPage<Map<String, Object>> list = this.baseMapper.getOptList(condition.getPage(), shopid,
                condition.getWarehouseid(), condition.getSearch(),
