...
public class PurchasePlanWareHouseServiceImpl extends
        ServiceImpl<PurchasePlanWareHouseMapper, PurchasePlanWareHouse> implements IPurchasePlanWareHouseService {
    ...
    public int updatePlanWareHouse(List<PurchasePlanWareHouse> purchasePlanWareHouseList, String planid,
            String shopid) {
        int result = 0;
