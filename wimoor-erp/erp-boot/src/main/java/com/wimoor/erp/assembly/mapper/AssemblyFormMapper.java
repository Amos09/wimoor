...
public interface AssemblyFormMapper extends BaseMapper<AssemblyForm> {
    ...
    List<Map<String, Object>> findLastByMaterial(@Param("materialid") String materialid,
    ...
    Integer refreshInbound(@Param("shopid") String shopid, @Param("warehouseid") String warehouseid,
            @Param("materialid") String materialid);

    List<AssemblyForm> getCanAssemblyFormByMaterial(@Param("shopid") String shopid,
