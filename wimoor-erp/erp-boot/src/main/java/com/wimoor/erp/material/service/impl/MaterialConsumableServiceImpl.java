...
public class MaterialConsumableServiceImpl extends ServiceImpl<MaterialConsumableMapper, MaterialConsumable> implements
        IMaterialConsumableService {
    ...
    public List<Map<String, Object>> selectConsumableByMainSKU(String shopid, String warehouseid,
    ...
    public List<Map<String, Object>> findConsumableDetailBySkuList(UserInfo user, MaterialConsumableDTO dto) {
        ...
        for (Map<String, Object> item : result) {
            ...
            if (shipqty != null) {
                ...
                Double residue =
                        item.get("residue") != null ? Double.parseDouble(item.get("residue").toString()) : 0.00;
