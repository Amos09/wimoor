...
public class WarehouseShelfInventoryController {
    ...
    public Result<String> add(@RequestBody List<WarehouseShelfInventoryOptRecord> invoptList) {
        ...
        for (int i = 0; i < invoptList.size(); i++) {
            ...
            if (invopt.getFormtype() != null && StrUtil.isBlankOrUndefined(invopt.getFormid()) && invopt.getFormtype()
                    .equals("direct")) {
    ...
    public Result<IPage<WarehouseShelfInventoryVo>> getShelfListAction(
            @ApiParam("查询DTO") @RequestBody ShelfInvListDto condition) {
        UserInfo user = UserInfoContext.get();
    ...
    public Result<IPage<WarehouseShelfInventoryVo>> getShelfInventoryListAction(
            @ApiParam("查询DTO") @RequestBody ShelfInvListDto condition) {
        UserInfo user = UserInfoContext.get();
        Map<String, Object> param = new HashMap<String, Object>();
        String shopid = user.getCompanyid();
        ...
        IPage<WarehouseShelfInventoryVo> list = iWarehouseShelfInventoryService.getShelfInventoryList(
                condition.getPage(), param);
        return Result.success(list);
    }
    ...
    public Result<?> getShelfInventoryStockingListAction(@ApiParam("查询DTO") @RequestBody ShelfInvListDto condition) {
        ...
        if (StrUtil.isNotBlank(condition.getSelected())) {
            ...
            IPage<WarehouseShelfInventoryVo> list = iWarehouseShelfInventoryService.getShelfInventoryStockList(
                    condition.getPage(), param);
            return Result.success(list);
        }
    ...
    public void downloadShelfInventoryStockingListAction(@ApiParam("查询DTO") @RequestBody ShelfInvListDto condition,
    ...
    public Result<ShipInboundShipmenSummarytVo> getShelfInvAction(
            @ApiParam("查询DTO") @RequestBody ShipInboundShipmenSummarytVo itemsum) {
