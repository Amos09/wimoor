 ...
 */
@Service
public class MaterialConsumableInventoryServiceImpl extends
        ServiceImpl<MaterialConsumableInventoryMapper, MaterialConsumableInventory> implements
        IMaterialConsumableInventoryService {
