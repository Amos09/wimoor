...
public interface AssemblyMapper extends BaseMapper<Assembly> {
    ...
    List<Map<String, Object>> selectByMainDetailmid(@Param("mainmid") String mainmid,
    ...
    Integer findCanAssembly(@Param("materialid") String materialid, @Param("warehouseid") String warehouseid,
            @Param("shopid") String shopid);

    Integer findCanAssemblyByInventory(@Param("materialid") String materialid, @Param("warehouseid") String warehouseid,
            @Param("shopid") String shopid);
}