...
public class ShipAmazonFormController {
    ...
    public Result<ShipInboundShipmenSummarytVo> getUnSyncShipmentDetialAction(
        ...
        try {
            shipmentResult = amazonClientOneFeign.getUnSyncShipmentAction(groupid, marketplaceid, shipmentid,
                    warehouseid);
    ...
    public void downPDFShipFormAction(
        ...
        response.addHeader("Content-Disposition",
                "attachment;fileName=shipForm" + System.currentTimeMillis() + ".pdf");// 设置文件名
    ...
    @Transactional
    Result<String> disableShipmentAction(String shipmentid, String shipmentStatus, String disableShipment)
            throws BizException {
    ...
    public Result<List<Map<String, Object>>> getConsumableListAction(
            @ApiParam("货件ID") @RequestParam String shipmentid) {
        UserInfo user = UserInfoContext.get();
        List<Map<String, Object>> list = iMaterialConsumableService.findConsumableDetailByShipment(user.getCompanyid(),
                shipmentid);
    ...
    public Result<Map<String, Object>> uploadCustomsFileAction(
        ...
        try {
            maps = importRecordService.uploadShipmentcustomsFile(user, file.getInputStream(),
    ...
    public Result<Map<String, Object>> deleteCustomsFileAction(
            @ApiParam("上传海关记录ID") @RequestParam String uploadid) {
    ...
    public Result<List<Map<String, Object>>> findPlanSubDetailAction(@ApiParam("groupid") @RequestParam String groupid,
            @ApiParam("planid") @RequestParam String planid,
            @ApiParam("warehouseid") @RequestParam String warehouseid,
            @ApiParam("marketplaceid") @RequestParam String marketplaceid, String issplit) {
