...
public class DispatchFormServiceImpl extends ServiceImpl<DispatchFormMapper, DispatchForm> implements
        IDispatchFormService {
    ...
    public Map<String, Object> saveAction(UserInfo user, DispatchForm dispatchForm, String skumapstr)
            throws BizException {
