 ...
 */
@Service
public class PurchaseAlibabaSettlementPayReturnServiceImpl extends
        ServiceImpl<PurchaseAlibabaSettlementPayReturnMapper, PurchaseAlibabaSettlementPayReturn> implements
        IPurchaseAlibabaSettlementPayReturnService {
    ...
    public String getValueStr(Cell cell) {
        ...
        Object value =
                cell.getCellTypeEnum().equals(CellType.STRING) ? cell.getStringCellValue() : cell.getNumericCellValue();
    ...
    public Boolean uploadSettlementSheet(Workbook workbook, PurchaseAlibabaSettlement settlement) {
        ...
        for (int i = 9; i <= sheet.getLastRowNum(); i++) {
            ...
            if (detail.getAmount() != null && (detail.getAmount().floatValue() > 0.00001
                    || detail.getAmount().floatValue() < -0.00001)) {
