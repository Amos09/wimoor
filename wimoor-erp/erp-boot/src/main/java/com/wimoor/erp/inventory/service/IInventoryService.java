...
public interface IInventoryService extends IService<Inventory> {
    ...
    //库存货值
    IPage<Map<String, Object>> selectInventoryCost(Page<?> page, String warehouseid, String sku, String shopid,
            String byday);
    ...
    void setExcelBookInventoryReport(SXSSFWorkbook workbook, List<Map<String, Object>> warehouseList,
