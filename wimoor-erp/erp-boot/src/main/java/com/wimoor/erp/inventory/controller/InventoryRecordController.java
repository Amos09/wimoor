...
public class InventoryRecordController {
    ...
    public void downloadRecordsExcelAction(@RequestBody InventoryRecordDTO dto, HttpServletResponse response) {
        ...
        try {
            ...
            response.addHeader("Content-Disposition",
                    "attachment;fileName=inventoryRecords" + System.currentTimeMillis() + ".xlsx");// 设置文件名
    ...
    public Result<Map<String, Object>> findInvDayListAction(@RequestBody InventoryRecordDTO dto) {
        ...
        if (material != null) {
            ...
            Map<String, Object> recordMaps = inventoryRecordService.findSkuInvHistory(material.getId(), fromDate,
                    toDate, warehouseid, userinfo.getCompanyid());
