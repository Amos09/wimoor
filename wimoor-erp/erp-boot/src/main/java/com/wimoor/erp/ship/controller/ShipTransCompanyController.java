...
public class ShipTransCompanyController {
    ...
    public void downloadShipTransListAction(String search, String mydate, HttpServletResponse response, Model model) {
        ...
        try {
            ...
            response.addHeader("Content-Disposition",
                    "attachment;fileName=shipTransCompany" + System.currentTimeMillis() + ".xlsx");// 设置文件名
    ...
    public Result<ShipTransCompany> uploadPriceAction(@ApiParam("物流公司ID") @RequestParam String comid,
    ...
    public Result<List<Map<String, Object>>> channelChangeAction(
        ...
        List<Map<String, Object>> list = shipTransCompanyService.selectBycom(company, user.getCompanyid(),
                marketplaceid, transtype);
        return Result.success(list);
    }
    ...
    public Result<List<Map<String, Object>>> getcomDetailAction(
        ...
        List<Map<String, Object>> list = shipTransCompanyService.selectBychannel(company, channel, marketplaceid,
                transtype);
